...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLBIRIMYETKILILERITableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLBIRIMYETKILILERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet1.TBLBIRIMYETKILILERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLBIRIMYETKILILERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLBIRIMYETKILILERIDataTable data = new bellDataSet1.TBLBIRIMYETKILILERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBIRIMYETKILILERI");
