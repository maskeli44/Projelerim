...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLDEPOFISTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLDEPOFISTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLDEPOFISDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLDEPOFISDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLDEPOFISDataTable data = new bellDataSet1.TBLDEPOFISDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLDEPOFISDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLDEPOFIS");
