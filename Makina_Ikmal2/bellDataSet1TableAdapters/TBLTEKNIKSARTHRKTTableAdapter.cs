...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLTEKNIKSARTHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLTEKNIKSARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLTEKNIKSARTHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLTEKNIKSARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLTEKNIKSARTHRKTDataTable data = new bellDataSet1.TBLTEKNIKSARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLTEKNIKSARTHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTEKNIKSARTHRKT");
