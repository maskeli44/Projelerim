...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLMALZGRUPTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLMALZGRUPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLMALZGRUPDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLMALZGRUPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLMALZGRUPDataTable data = new bellDataSet1.TBLMALZGRUPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLMALZGRUPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZGRUP");
