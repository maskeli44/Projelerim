...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLPERSUNVANTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLPERSUNVANTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLPERSUNVANDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLPERSUNVANDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLPERSUNVANDataTable data = new bellDataSet1.TBLPERSUNVANDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLPERSUNVANDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSUNVAN");
