...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLIDARISARTHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLIDARISARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLIDARISARTHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLIDARISARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLIDARISARTHRKTDataTable data = new bellDataSet1.TBLIDARISARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLIDARISARTHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIDARISARTHRKT");
