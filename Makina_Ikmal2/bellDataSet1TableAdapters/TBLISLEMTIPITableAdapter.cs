...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLISLEMTIPITableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLISLEMTIPITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLISLEMTIPIDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLISLEMTIPIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLISLEMTIPIDataTable data = new bellDataSet1.TBLISLEMTIPIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLISLEMTIPIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISLEMTIPI");
