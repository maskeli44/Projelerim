...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLPERSMESAITableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLPERSMESAITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLPERSMESAIDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLPERSMESAIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLPERSMESAIDataTable data = new bellDataSet1.TBLPERSMESAIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLPERSMESAIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSMESAI");
