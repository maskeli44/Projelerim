...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLIDARISARTNAMETableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLIDARISARTNAMETableAdapter : Component
  {
    ...
    public TBLIDARISARTNAMETableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_IDARISARTADI", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_IDARISARTADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLIDARISARTNAME] ([IDARISARTADI], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@IDARISARTADI, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, IDARISARTADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLIDARISARTNAME WHERE (ID = SCOPE_IDENTITY())";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IDARISARTADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLIDARISARTNAME] SET [IDARISARTADI] = @IDARISARTADI, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_IDARISARTADI = 1 AND [IDARISARTADI] IS NULL) OR ([IDARISARTADI] = @Original_IDARISARTADI)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, IDARISARTADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLIDARISARTNAME WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IDARISARTADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_IDARISARTADI", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_IDARISARTADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IDARISARTADI", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, IDARISARTADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLIDARISARTNAME";
    ...
    public virtual int Fill(bellDataSet1.TBLIDARISARTNAMEDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLIDARISARTNAMEDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLIDARISARTNAMEDataTable data = new bellDataSet1.TBLIDARISARTNAMEDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLIDARISARTNAMEDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIDARISARTNAME");
      ...
      string Original_EDITIP)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_IDARISARTADI;
      }
      ...
      if (Original_EDITDATE.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_EDITDATE.Value;
      }
      else
      {
    ...
    public virtual int Insert(
      ...
      string EDITIP)
    {
      if (IDARISARTADI == null)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) IDARISARTADI;
      if (SAVEUSER == null)
      ...
      if (EDITDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) EDITDATE.Value;
      else
      ...
      int ID)
    {
      if (IDARISARTADI == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) IDARISARTADI;
      if (SAVEUSER == null)
      ...
      if (EDITDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) EDITDATE.Value;
      else
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_IDARISARTADI;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      if (Original_EDITDATE.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[19].Value = (object) Original_EDITDATE.Value;
      }
      else
      {
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(IDARISARTADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_IDARISARTADI, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
