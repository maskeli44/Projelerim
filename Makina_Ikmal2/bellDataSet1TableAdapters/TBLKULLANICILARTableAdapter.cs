...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLKULLANICILARTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLKULLANICILARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLKULLANICILARDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLKULLANICILARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLKULLANICILARDataTable data = new bellDataSet1.TBLKULLANICILARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLKULLANICILARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLKULLANICILAR");
