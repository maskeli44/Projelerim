...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLARACMESTKPTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLARACMESTKPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLARACMESTKPDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLARACMESTKPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLARACMESTKPDataTable data = new bellDataSet1.TBLARACMESTKPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLARACMESTKPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACMESTKP");
