...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLMALZKDVTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLMALZKDVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLMALZKDVDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLMALZKDVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLMALZKDVDataTable data = new bellDataSet1.TBLMALZKDVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLMALZKDVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZKDV");
