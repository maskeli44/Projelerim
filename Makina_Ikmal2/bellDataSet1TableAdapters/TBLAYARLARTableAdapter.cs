...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLAYARLARTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLAYARLARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLAYARLARDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLAYARLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLAYARLARDataTable data = new bellDataSet1.TBLAYARLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLAYARLARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLAYARLAR");
