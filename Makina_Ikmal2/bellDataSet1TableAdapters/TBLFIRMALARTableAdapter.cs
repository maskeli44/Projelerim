...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLFIRMALARTableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLFIRMALARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLFIRMALARDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLFIRMALARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLFIRMALARDataTable data = new bellDataSet1.TBLFIRMALARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLFIRMALARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFIRMALAR");
