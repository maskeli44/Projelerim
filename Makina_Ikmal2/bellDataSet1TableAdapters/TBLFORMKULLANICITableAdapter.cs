...
// Type: Makina_Ikmal.bellDataSet1TableAdapters.TBLFORMKULLANICITableAdapter
...
namespace Makina_Ikmal.bellDataSet1TableAdapters
{
  ...
  public class TBLFORMKULLANICITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet1.TBLFORMKULLANICIDataTable dataTable)
    {
    ...
    public virtual bellDataSet1.TBLFORMKULLANICIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet1.TBLFORMKULLANICIDataTable data = new bellDataSet1.TBLFORMKULLANICIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1.TBLFORMKULLANICIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFORMKULLANICI");
