...
// Type: Makina_Ikmal.BAKIMDERECETableAdapters.TAHBAKIMDERECETableAdapter
...
namespace Makina_Ikmal.BAKIMDERECETableAdapters
{
  ...
  public class TAHBAKIMDERECETableAdapter : Component
  {
    ...
    public virtual int Fill(BAKIMDERECE.TAHBAKIMDERECEDataTable dataTable)
    {
    ...
    public virtual BAKIMDERECE.TAHBAKIMDERECEDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BAKIMDERECE.TAHBAKIMDERECEDataTable data = new BAKIMDERECE.TAHBAKIMDERECEDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BAKIMDERECE.TAHBAKIMDERECEDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BAKIMDERECE dataSet) => this.Adapter.Update((DataSet) dataSet, "TAHBAKIMDERECE");
