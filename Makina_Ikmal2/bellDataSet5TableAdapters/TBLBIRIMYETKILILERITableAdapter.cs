...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLBIRIMYETKILILERITableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLBIRIMYETKILILERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet5.TBLBIRIMYETKILILERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLBIRIMYETKILILERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLBIRIMYETKILILERIDataTable data = new bellDataSet5.TBLBIRIMYETKILILERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBIRIMYETKILILERI");
