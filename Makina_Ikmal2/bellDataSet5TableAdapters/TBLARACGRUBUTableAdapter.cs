...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLARACGRUBUTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLARACGRUBUTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLARACGRUBUDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLARACGRUBUDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLARACGRUBUDataTable data = new bellDataSet5.TBLARACGRUBUDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLARACGRUBUDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACGRUBU");
