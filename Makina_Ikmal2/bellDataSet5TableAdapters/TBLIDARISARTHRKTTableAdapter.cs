...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLIDARISARTHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLIDARISARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLIDARISARTHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLIDARISARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLIDARISARTHRKTDataTable data = new bellDataSet5.TBLIDARISARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLIDARISARTHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIDARISARTHRKT");
