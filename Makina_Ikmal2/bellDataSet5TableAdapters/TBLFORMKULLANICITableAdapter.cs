...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLFORMKULLANICITableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLFORMKULLANICITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLFORMKULLANICIDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLFORMKULLANICIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLFORMKULLANICIDataTable data = new bellDataSet5.TBLFORMKULLANICIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLFORMKULLANICIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFORMKULLANICI");
