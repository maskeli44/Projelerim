...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLARACMARKATableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLARACMARKATableAdapter : Component
  {
    ...
    public TBLARACMARKATableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_ARACMARKA", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_ARACMARKA", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLARACMARKA] ([ARACMARKA], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@ARACMARKA, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, ARACMARKA, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLARACMARKA WHERE (ID = SCOPE_IDENTITY())";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ARACMARKA", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLARACMARKA] SET [ARACMARKA] = @ARACMARKA, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_ARACMARKA = 1 AND [ARACMARKA] IS NULL) OR ([ARACMARKA] = @Original_ARACMARKA)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, ARACMARKA, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLARACMARKA WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ARACMARKA", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_ARACMARKA", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_ARACMARKA", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACMARKA", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ARACMARKA, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLARACMARKA";
    ...
    public virtual int Fill(bellDataSet5.TBLARACMARKADataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLARACMARKADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLARACMARKADataTable data = new bellDataSet5.TBLARACMARKADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLARACMARKADataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACMARKA");
      ...
      string Original_EDITIP)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_ARACMARKA;
      }
      ...
      string EDITIP)
    {
      if (ARACMARKA == null)
        ...
        this.Adapter.InsertCommand.Parameters[0].Value = (object) ARACMARKA;
      if (SAVEUSER == null)
      ...
      int ID)
    {
      if (ARACMARKA == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) ARACMARKA;
      if (SAVEUSER == null)
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_ARACMARKA;
      }
      if (Original_SAVEUSER == null)
      {
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(ARACMARKA, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_ARACMARKA, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
