...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLARACTRFCEZATableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLARACTRFCEZATableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLARACTRFCEZADataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLARACTRFCEZADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLARACTRFCEZADataTable data = new bellDataSet5.TBLARACTRFCEZADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLARACTRFCEZADataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACTRFCEZA");
