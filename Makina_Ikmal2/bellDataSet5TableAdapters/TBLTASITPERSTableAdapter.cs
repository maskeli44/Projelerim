...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLTASITPERSTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLTASITPERSTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLTASITPERSDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLTASITPERSDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLTASITPERSDataTable data = new bellDataSet5.TBLTASITPERSDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLTASITPERSDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITPERS");
