...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLAYARLARTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLAYARLARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLAYARLARDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLAYARLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLAYARLARDataTable data = new bellDataSet5.TBLAYARLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLAYARLARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLAYARLAR");
