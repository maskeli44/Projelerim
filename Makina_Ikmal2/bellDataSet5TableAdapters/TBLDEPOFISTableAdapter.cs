...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLDEPOFISTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLDEPOFISTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLDEPOFISDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLDEPOFISDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLDEPOFISDataTable data = new bellDataSet5.TBLDEPOFISDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLDEPOFISDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLDEPOFIS");
