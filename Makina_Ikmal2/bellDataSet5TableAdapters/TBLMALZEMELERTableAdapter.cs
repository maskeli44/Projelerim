...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLMALZEMELERTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLMALZEMELERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLMALZEMELERDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLMALZEMELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLMALZEMELERDataTable data = new bellDataSet5.TBLMALZEMELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLMALZEMELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZEMELER");
