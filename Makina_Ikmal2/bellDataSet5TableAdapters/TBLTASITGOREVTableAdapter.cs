...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLTASITGOREVTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLTASITGOREVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLTASITGOREVDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLTASITGOREVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLTASITGOREVDataTable data = new bellDataSet5.TBLTASITGOREVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLTASITGOREVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITGOREV");
