...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLTALEPTEKNIKSARTTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLTALEPTEKNIKSARTTableAdapter : Component
  {
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[1].CommandText = "SELECT ID, TALEPID, SIRANO, ACIKLAMA\r\nFROM     TBLTALEPTEKNIKSART\r\nWHERE  (ID = @Param1)";
    ...
    public virtual int Fill(bellDataSet5.TBLTALEPTEKNIKSARTDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLTALEPTEKNIKSARTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLTALEPTEKNIKSARTDataTable data = new bellDataSet5.TBLTALEPTEKNIKSARTDataTable();
    ...
    public virtual int FillBy(bellDataSet5.TBLTALEPTEKNIKSARTDataTable dataTable, int Param1)
    {
    ...
    public virtual bellDataSet5.TBLTALEPTEKNIKSARTDataTable GetDataBy(int Param1)
    {
      this.Adapter.SelectCommand = this.CommandCollection[1];
      this.Adapter.SelectCommand.Parameters[0].Value = (object) Param1;
      bellDataSet5.TBLTALEPTEKNIKSARTDataTable dataBy = new bellDataSet5.TBLTALEPTEKNIKSARTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLTALEPTEKNIKSARTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPTEKNIKSART");
