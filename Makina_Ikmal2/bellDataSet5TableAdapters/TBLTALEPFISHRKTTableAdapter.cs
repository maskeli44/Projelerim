...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLTALEPFISHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLTALEPFISHRKTTableAdapter : Component
  {
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLTALEPFISHRKT] ([TALEPFISID], [MALZEMEID], [MALZACIKLAMA], [BIRIMID], [ISTENENMIKTAR], [MIKTAR], [FIYAT], [TUTAR]) VALUES (@TALEPFISID, @MALZEMEID, @MALZACIKLAMA, @BIRIMID, @ISTENENMIKTAR, @MIKTAR, @FIYAT, @TUTAR);\r\nSELECT ID, TALEPFISID, MALZEMEID, MALZACIKLAMA, BIRIMID, ISTENENMIKTAR, MIKTAR, FIYAT, TUTAR FROM TBLTALEPFISHRKT WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLTALEPFISHRKT] SET [TALEPFISID] = @TALEPFISID, [MALZEMEID] = @MALZEMEID, [MALZACIKLAMA] = @MALZACIKLAMA, [BIRIMID] = @BIRIMID, [ISTENENMIKTAR] = @ISTENENMIKTAR, [MIKTAR] = @MIKTAR, [FIYAT] = @FIYAT, [TUTAR] = @TUTAR WHERE (([ID] = @Original_ID) AND ((@IsNull_TALEPFISID = 1 AND [TALEPFISID] IS NULL) OR ([TALEPFISID] = @Original_TALEPFISID)) AND ((@IsNull_MALZEMEID = 1 AND [MALZEMEID] IS NULL) OR ([MALZEMEID] = @Original_MALZEMEID)) AND ((@IsNull_MALZACIKLAMA = 1 AND [MALZACIKLAMA] IS NULL) OR ([MALZACIKLAMA] = @Original_MALZACIKLAMA)) AND ((@IsNull_BIRIMID = 1 AND [BIRIMID] IS NULL) OR ([BIRIMID] = @Original_BIRIMID)) AND ((@IsNull_ISTENENMIKTAR = 1 AND [ISTENENMIKTAR] IS NULL) OR ([ISTENENMIKTAR] = @Original_ISTENENMIKTAR)) AND ((@IsNull_MIKTAR = 1 AND [MIKTAR] IS NULL) OR ([MIKTAR] = @Original_MIKTAR)) AND ((@IsNull_FIYAT = 1 AND [FIYAT] IS NULL) OR ([FIYAT] = @Original_FIYAT)) AND ((@IsNull_TUTAR = 1 AND [TUTAR] IS NULL) OR ([TUTAR] = @Original_TUTAR)));\r\nSELECT ID, TALEPFISID, MALZEMEID, MALZACIKLAMA, BIRIMID, ISTENENMIKTAR, MIKTAR, FIYAT, TUTAR FROM TBLTALEPFISHRKT WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, TALEPFISID, MALZEMEID, MALZACIKLAMA, BIRIMID, ISTENENMIKTAR, MIKTAR, FIYAT, TUTAR FROM dbo.TBLTALEPFISHRKT";
    ...
    public virtual int Fill(bellDataSet5.TBLTALEPFISHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLTALEPFISHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLTALEPFISHRKTDataTable data = new bellDataSet5.TBLTALEPFISHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLTALEPFISHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPFISHRKT");
