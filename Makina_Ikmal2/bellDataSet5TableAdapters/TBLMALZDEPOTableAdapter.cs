...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLMALZDEPOTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLMALZDEPOTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLMALZDEPODataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLMALZDEPODataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLMALZDEPODataTable data = new bellDataSet5.TBLMALZDEPODataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLMALZDEPODataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZDEPO");
