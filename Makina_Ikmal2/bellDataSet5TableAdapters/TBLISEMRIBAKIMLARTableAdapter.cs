...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLISEMRIBAKIMLARTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLISEMRIBAKIMLARTableAdapter : Component
  {
    ...
    public TBLISEMRIBAKIMLARTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "TBLISEMRIBAKIMLAR",
        ColumnMappings = {
          {
            "ID",
            "ID"
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLISEMRIBAKIMLAR] WHERE (([ID] = @Original_ID) AND ((@IsNull_ISEMRIID = 1 AND [ISEMRIID] IS NULL) OR ([ISEMRIID] = @Original_ISEMRIID)) AND ((@IsNull_ATOLYEID = 1 AND [ATOLYEID] IS NULL) OR ([ATOLYEID] = @Original_ATOLYEID)) AND ((@IsNull_BAKIMYAPUSTAID = 1 AND [BAKIMYAPUSTAID] IS NULL) OR ([BAKIMYAPUSTAID] = @Original_BAKIMYAPUSTAID)) AND ((@IsNull_BAKIMGRUBUID = 1 AND [BAKIMGRUBUID] IS NULL) OR ([BAKIMGRUBUID] = @Original_BAKIMGRUBUID)) AND ((@IsNull_YAPILANBAKIM = 1 AND [YAPILANBAKIM] IS NULL) OR ([YAPILANBAKIM] = @Original_YAPILANBAKIM)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)))";
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_YAPILANBAKIM", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_YAPILANBAKIM", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLISEMRIBAKIMLAR] ([ISEMRIID], [ATOLYEID], [BAKIMYAPUSTAID], [BAKIMGRUBUID], [YAPILANBAKIM], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@ISEMRIID, @ATOLYEID, @BAKIMYAPUSTAID, @BAKIMGRUBUID, @YAPILANBAKIM, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, ISEMRIID, ATOLYEID, BAKIMYAPUSTAID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLISEMRIBAKIMLAR WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@YAPILANBAKIM", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLISEMRIBAKIMLAR] SET [ISEMRIID] = @ISEMRIID, [ATOLYEID] = @ATOLYEID, [BAKIMYAPUSTAID] = @BAKIMYAPUSTAID, [BAKIMGRUBUID] = @BAKIMGRUBUID, [YAPILANBAKIM] = @YAPILANBAKIM, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_ISEMRIID = 1 AND [ISEMRIID] IS NULL) OR ([ISEMRIID] = @Original_ISEMRIID)) AND ((@IsNull_ATOLYEID = 1 AND [ATOLYEID] IS NULL) OR ([ATOLYEID] = @Original_ATOLYEID)) AND ((@IsNull_BAKIMYAPUSTAID = 1 AND [BAKIMYAPUSTAID] IS NULL) OR ([BAKIMYAPUSTAID] = @Original_BAKIMYAPUSTAID)) AND ((@IsNull_BAKIMGRUBUID = 1 AND [BAKIMGRUBUID] IS NULL) OR ([BAKIMGRUBUID] = @Original_BAKIMGRUBUID)) AND ((@IsNull_YAPILANBAKIM = 1 AND [YAPILANBAKIM] IS NULL) OR ([YAPILANBAKIM] = @Original_YAPILANBAKIM)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, ISEMRIID, ATOLYEID, BAKIMYAPUSTAID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLISEMRIBAKIMLAR WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@YAPILANBAKIM", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_BAKIMYAPUSTAID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMYAPUSTAID", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_BAKIMGRUBUID", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BAKIMGRUBUID", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_YAPILANBAKIM", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_YAPILANBAKIM", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "YAPILANBAKIM", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ISEMRIID, ATOLYEID, BAKIMYAPUSTAID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLISEMRIBAKIMLAR";
    ...
    public virtual int Fill(bellDataSet5.TBLISEMRIBAKIMLARDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLISEMRIBAKIMLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLISEMRIBAKIMLARDataTable data = new bellDataSet5.TBLISEMRIBAKIMLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLISEMRIBAKIMLARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISEMRIBAKIMLAR");
    ...
    public virtual int Delete(
      ...
      int? Original_BAKIMYAPUSTAID,
      int? Original_BAKIMGRUBUID,
      string Original_YAPILANBAKIM,
      ...
      string Original_EDITIP)
    {
      ...
      if (Original_BAKIMYAPUSTAID.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[5].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[6].Value = (object) Original_BAKIMYAPUSTAID.Value;
      }
      else
      {
      ...
      if (Original_BAKIMGRUBUID.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[7].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_BAKIMGRUBUID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_YAPILANBAKIM;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[12].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[13].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[14].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[16].Value = (object) Original_EDITUSER;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[18].Value = (object) Original_EDITDATE;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[20].Value = (object) Original_SAVEMAC;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[22].Value = (object) Original_EDITMAC;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[24].Value = (object) Original_SAVEIP;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[26].Value = (object) Original_EDITIP;
      }
      ...
      string EDITIP)
    {
      ...
      if (BAKIMYAPUSTAID.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) BAKIMYAPUSTAID.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      if (BAKIMGRUBUID.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) BAKIMGRUBUID.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (YAPILANBAKIM == null)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) YAPILANBAKIM;
      if (SAVEUSER == null)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) EDITDATE;
      if (SAVEMAC == null)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) SAVEMAC;
      if (EDITMAC == null)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.InsertCommand.Parameters[11].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[11].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.InsertCommand.Parameters[12].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[12].Value = (object) EDITIP;
      ...
      int ID)
    {
      ...
      if (BAKIMYAPUSTAID.HasValue)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) BAKIMYAPUSTAID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      if (BAKIMGRUBUID.HasValue)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) BAKIMGRUBUID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      if (YAPILANBAKIM == null)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) YAPILANBAKIM;
      if (SAVEUSER == null)
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) EDITDATE;
      if (SAVEMAC == null)
        this.Adapter.UpdateCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[9].Value = (object) SAVEMAC;
      if (EDITMAC == null)
        this.Adapter.UpdateCommand.Parameters[10].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[10].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) EDITIP;
      this.Adapter.UpdateCommand.Parameters[13].Value = (object) Original_ID;
      if (Original_ISEMRIID.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[14].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_ISEMRIID.Value;
      }
      else
      {
      ...
      if (Original_ATOLYEID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[17].Value = (object) Original_ATOLYEID.Value;
      }
      else
      {
      ...
      if (Original_BAKIMYAPUSTAID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[19].Value = (object) Original_BAKIMYAPUSTAID.Value;
      }
      else
      {
      ...
      if (Original_BAKIMGRUBUID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[21].Value = (object) Original_BAKIMGRUBUID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[23].Value = (object) Original_YAPILANBAKIM;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[25].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[26].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[27].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[29].Value = (object) Original_EDITUSER;
      }
      if (Original_EDITDATE == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[31].Value = (object) Original_EDITDATE;
      }
      if (Original_SAVEMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[33].Value = (object) Original_SAVEMAC;
      }
      if (Original_EDITMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[35].Value = (object) Original_EDITMAC;
      }
      if (Original_SAVEIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[37].Value = (object) Original_SAVEIP;
      }
      if (Original_EDITIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[39].Value = (object) Original_EDITIP;
      }
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(ISEMRIID, ATOLYEID, BAKIMYAPUSTAID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_ISEMRIID, Original_ATOLYEID, Original_BAKIMYAPUSTAID, Original_BAKIMGRUBUID, Original_YAPILANBAKIM, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
