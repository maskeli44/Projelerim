...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLTEKLIFIDARISARTTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLTEKLIFIDARISARTTableAdapter : Component
  {
    ...
    public TBLTEKLIFIDARISARTTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "TBLTEKLIFIDARISART",
        ColumnMappings = {
          {
            "ID",
            "ID"
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLTEKLIFIDARISART] WHERE (([ID] = @Original_ID) AND ((@IsNull_TEKLIFID = 1 AND [TEKLIFID] IS NULL) OR ([TEKLIFID] = @Original_TEKLIFID)) AND ((@IsNull_SIRANO = 1 AND [SIRANO] IS NULL) OR ([SIRANO] = @Original_SIRANO)) AND ((@IsNull_ACIKLAMA = 1 AND [ACIKLAMA] IS NULL) OR ([ACIKLAMA] = @Original_ACIKLAMA)))";
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_TEKLIFID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TEKLIFID", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLTEKLIFIDARISART] ([TEKLIFID], [SIRANO], [ACIKLAMA]) VALUES (@TEKLIFID, @SIRANO, @ACIKLAMA);\r\nSELECT ID, TEKLIFID, SIRANO, ACIKLAMA FROM TBLTEKLIFIDARISART WHERE (ID = SCOPE_IDENTITY())";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TEKLIFID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TEKLIFID", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLTEKLIFIDARISART] SET [TEKLIFID] = @TEKLIFID, [SIRANO] = @SIRANO, [ACIKLAMA] = @ACIKLAMA WHERE (([ID] = @Original_ID) AND ((@IsNull_TEKLIFID = 1 AND [TEKLIFID] IS NULL) OR ([TEKLIFID] = @Original_TEKLIFID)) AND ((@IsNull_SIRANO = 1 AND [SIRANO] IS NULL) OR ([SIRANO] = @Original_SIRANO)) AND ((@IsNull_ACIKLAMA = 1 AND [ACIKLAMA] IS NULL) OR ([ACIKLAMA] = @Original_ACIKLAMA)));\r\nSELECT ID, TEKLIFID, SIRANO, ACIKLAMA FROM TBLTEKLIFIDARISART WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TEKLIFID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TEKLIFID", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_TEKLIFID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TEKLIFID", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, TEKLIFID, SIRANO, ACIKLAMA FROM dbo.TBLTEKLIFIDARISART";
      this._commandCollection[0].CommandType = CommandType.Text;
      this._commandCollection[1] = new SqlCommand();
      this._commandCollection[1].Connection = this.Connection;
      this._commandCollection[1].CommandText = "SELECT ID, TEKLIFID, SIRANO, ACIKLAMA\r\nFROM     TBLTEKLIFIDARISART\r\nWHERE  (TEKLIFID = @Param1)";
      this._commandCollection[1].CommandType = CommandType.Text;
      this._commandCollection[1].Parameters.Add(new SqlParameter("@Param1", SqlDbType.NVarChar, 50, ParameterDirection.Input, (byte) 0, (byte) 0, "TEKLIFID", DataRowVersion.Current, false, (object) null, "", "", ""));
    }
    ...
    public virtual int Fill(bellDataSet5.TBLTEKLIFIDARISARTDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLTEKLIFIDARISARTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLTEKLIFIDARISARTDataTable data = new bellDataSet5.TBLTEKLIFIDARISARTDataTable();
    ...
    public virtual int FillBy(bellDataSet5.TBLTEKLIFIDARISARTDataTable dataTable, string Param1)
    {
    ...
    public virtual bellDataSet5.TBLTEKLIFIDARISARTDataTable GetDataBy(string Param1)
    {
      this.Adapter.SelectCommand = this.CommandCollection[1];
      if (Param1 == null)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) Param1;
      bellDataSet5.TBLTEKLIFIDARISARTDataTable dataBy = new bellDataSet5.TBLTEKLIFIDARISARTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLTEKLIFIDARISARTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTEKLIFIDARISART");
      ...
      string Original_ACIKLAMA)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_TEKLIFID;
      }
    ...
    public virtual int Insert(string TEKLIFID, string SIRANO, string ACIKLAMA)
    {
      if (TEKLIFID == null)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) TEKLIFID;
      if (SIRANO == null)
      ...
      int ID)
    {
      if (TEKLIFID == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) TEKLIFID;
      if (SIRANO == null)
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) Original_TEKLIFID;
      }
      if (Original_SIRANO == null)
      {
    ...
    public virtual int Update(
      ...
      string Original_ACIKLAMA)
    {
      return this.Update(TEKLIFID, SIRANO, ACIKLAMA, Original_ID, Original_TEKLIFID, Original_SIRANO, Original_ACIKLAMA, Original_ID);
    }
  }
}
