...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLPERSONELDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLPERSONELDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLPERSONELDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLPERSONELDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLPERSONELDURUMDataTable data = new bellDataSet5.TBLPERSONELDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLPERSONELDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELDURUM");
