...
// Type: Makina_Ikmal.bellDataSet5TableAdapters.TBLISEMIRDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet5TableAdapters
{
  ...
  public class TBLISEMIRDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet5.TBLISEMIRDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet5.TBLISEMIRDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet5.TBLISEMIRDURUMDataTable data = new bellDataSet5.TBLISEMIRDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5.TBLISEMIRDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet5 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISEMIRDURUM");
