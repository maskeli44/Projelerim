...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLARACTRFCEZATableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLARACTRFCEZATableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLARACTRFCEZADataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLARACTRFCEZADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLARACTRFCEZADataTable data = new bellDataSet7.TBLARACTRFCEZADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLARACTRFCEZADataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACTRFCEZA");
