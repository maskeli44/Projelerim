...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLPERSONELISTIHDAMDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLPERSONELISTIHDAMDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet7.TBLPERSONELISTIHDAMDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLPERSONELISTIHDAMDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLPERSONELISTIHDAMDURUMDataTable data = new bellDataSet7.TBLPERSONELISTIHDAMDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELISTIHDAMDURUM");
