...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLBAKIMTANIMTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLBAKIMTANIMTableAdapter : Component
  {
    ...
    public TBLBAKIMTANIMTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLBAKIMTANIM] ([ATOLYEID], [BAKIMGRUBUID], [YAPILANBAKIM], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@ATOLYEID, @BAKIMGRUBUID, @YAPILANBAKIM, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, ATOLYEID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLBAKIMTANIM WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLBAKIMTANIM] SET [ATOLYEID] = @ATOLYEID, [BAKIMGRUBUID] = @BAKIMGRUBUID, [YAPILANBAKIM] = @YAPILANBAKIM, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_ATOLYEID = 1 AND [ATOLYEID] IS NULL) OR ([ATOLYEID] = @Original_ATOLYEID)) AND ((@IsNull_BAKIMGRUBUID = 1 AND [BAKIMGRUBUID] IS NULL) OR ([BAKIMGRUBUID] = @Original_BAKIMGRUBUID)) AND ((@IsNull_YAPILANBAKIM = 1 AND [YAPILANBAKIM] IS NULL) OR ([YAPILANBAKIM] = @Original_YAPILANBAKIM)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, ATOLYEID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLBAKIMTANIM WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ATOLYEID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLBAKIMTANIM";
    ...
    public virtual int Fill(bellDataSet7.TBLBAKIMTANIMDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLBAKIMTANIMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLBAKIMTANIMDataTable data = new bellDataSet7.TBLBAKIMTANIMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLBAKIMTANIMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBAKIMTANIM");
      ...
      string Original_EDITIP)
    {
      ...
      if (Original_ATOLYEID.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_ATOLYEID.Value;
      }
      else
      {
      ...
      if (Original_BAKIMGRUBUID.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[4].Value = (object) Original_BAKIMGRUBUID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[6].Value = (object) Original_YAPILANBAKIM;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[9].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[12].Value = (object) Original_EDITUSER;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[14].Value = (object) Original_EDITDATE;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[16].Value = (object) Original_SAVEMAC;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[18].Value = (object) Original_EDITMAC;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[20].Value = (object) Original_SAVEIP;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[22].Value = (object) Original_EDITIP;
      }
      ...
      string EDITIP)
    {
      if (ATOLYEID.HasValue)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) ATOLYEID.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      if (BAKIMGRUBUID.HasValue)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) BAKIMGRUBUID.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      if (YAPILANBAKIM == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) YAPILANBAKIM;
      if (SAVEUSER == null)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) EDITDATE;
      if (SAVEMAC == null)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) SAVEMAC;
      if (EDITMAC == null)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) EDITIP;
    ...
    {
      if (ATOLYEID.HasValue)
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) ATOLYEID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) DBNull.Value;
      if (BAKIMGRUBUID.HasValue)
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) BAKIMGRUBUID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) DBNull.Value;
      if (YAPILANBAKIM == null)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) YAPILANBAKIM;
      if (SAVEUSER == null)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) EDITDATE;
      if (SAVEMAC == null)
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) SAVEMAC;
      if (EDITMAC == null)
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.UpdateCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[9].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.UpdateCommand.Parameters[10].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[10].Value = (object) EDITIP;
      this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_ID;
      if (Original_ATOLYEID.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[13].Value = (object) Original_ATOLYEID.Value;
      }
      else
      {
      ...
      if (Original_BAKIMGRUBUID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_BAKIMGRUBUID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[17].Value = (object) Original_YAPILANBAKIM;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[19].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[20].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[21].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[23].Value = (object) Original_EDITUSER;
      }
      if (Original_EDITDATE == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[25].Value = (object) Original_EDITDATE;
      }
      if (Original_SAVEMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[27].Value = (object) Original_SAVEMAC;
      }
      if (Original_EDITMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[29].Value = (object) Original_EDITMAC;
      }
      if (Original_SAVEIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[31].Value = (object) Original_SAVEIP;
      }
      if (Original_EDITIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[33].Value = (object) Original_EDITIP;
      }
      this.Adapter.UpdateCommand.Parameters[34].Value = (object) ID;
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(ATOLYEID, BAKIMGRUBUID, YAPILANBAKIM, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_ATOLYEID, Original_BAKIMGRUBUID, Original_YAPILANBAKIM, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
