...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLFORMKULLANICITableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLFORMKULLANICITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLFORMKULLANICIDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLFORMKULLANICIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLFORMKULLANICIDataTable data = new bellDataSet7.TBLFORMKULLANICIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLFORMKULLANICIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFORMKULLANICI");
