...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLARACLARTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLARACLARTableAdapter : Component
  {
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT        ID, KOD, VERILDIGIILILCE, PLAKA, ARACACIKLAMA, TAHSPLAKA, TAHSPLKTARIH, ESKIPLAKA, TESCILSIRANO, ILKTESCILTARIHI, TESCILTARIHI, MARKAID, MODEL, CINSI, TICARIADI, TIPI, RENGI, MOTORNO, SASENO, \r\n                         SILINDIRHACMI, MOTORGUCU, BEYGIRGUCU, TEKERLEKADEDI, YURUYENAKSAMI, LASTIKEBADI, DIGEROZELLIKLER, MUAYENEGECSUR, TRAFIKSGORTA, KASKO, BELGESERINO, ARACFIRMAID, BELDBIRIMID, \r\n                         BELDMUDURLUKID, TAHSISEDILENID, ARACKULPERSID, ARACGRUBUID, ARACGRUBU2ID, YAKITID, YKTYAKMATURU, STDYKYAKIT, ARACDURUMID, ARACTIPIID, TKPVARYOK, YEDEKANAHTAR, YEDEKANHTRACKLM, \r\n                         GOREVBITIMTARIH, GOREVDURUM, ILGILINOT, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, ARACRESIM1, ARACRESIM2, TAKIPVARYOKID, SIRANO, GUNCELDEGERI, YENIDEGERI, \r\n                         PARABIRIMI, GENELBAKIMKM, MOTORYAGKM, SANZIMANYAGKM, DIFERANSIYELYAGKM, HIDROLIKYAGKM, YENIDEGERTARIH, HGSVARYOK, EGZOZKONTROL, TRAFIKSGORTA2\r\nFROM            TBLARACLAR";
    ...
    public virtual int Fill(bellDataSet7.TBLARACLARDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLARACLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLARACLARDataTable data = new bellDataSet7.TBLARACLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLARACLARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACLAR");
      ...
      DateTime? Original_TRAFIKSGORTA2)
    {
      ...
      if (Original_TRAFIKSGORTA2.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[142].Value = (object) Original_TRAFIKSGORTA2.Value;
      }
      else
      {
        this.Adapter.DeleteCommand.Parameters[141].Value = (object) 1;
        this.Adapter.DeleteCommand.Parameters[142].Value = (object) DBNull.Value;
      }
      ...
      DateTime? TRAFIKSGORTA2)
    {
      ...
      if (EGZOZKONTROL.HasValue)
        this.Adapter.InsertCommand.Parameters[69].Value = (object) EGZOZKONTROL.Value;
      else
        this.Adapter.InsertCommand.Parameters[69].Value = (object) DBNull.Value;
      if (TRAFIKSGORTA2.HasValue)
        this.Adapter.InsertCommand.Parameters[70].Value = (object) TRAFIKSGORTA2.Value;
      else
      ...
      int ID)
    {
      ...
      if (EGZOZKONTROL.HasValue)
        this.Adapter.UpdateCommand.Parameters[69].Value = (object) EGZOZKONTROL.Value;
      else
        this.Adapter.UpdateCommand.Parameters[69].Value = (object) DBNull.Value;
      if (TRAFIKSGORTA2.HasValue)
        this.Adapter.UpdateCommand.Parameters[70].Value = (object) TRAFIKSGORTA2.Value;
      else
      ...
      if (Original_EGZOZKONTROL.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[211].Value = (object) Original_EGZOZKONTROL.Value;
      }
      else
      {
        this.Adapter.UpdateCommand.Parameters[210].Value = (object) 1;
        this.Adapter.UpdateCommand.Parameters[211].Value = (object) DBNull.Value;
      }
      if (Original_TRAFIKSGORTA2.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[212].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[213].Value = (object) Original_TRAFIKSGORTA2.Value;
      }
      else
      {
        this.Adapter.UpdateCommand.Parameters[212].Value = (object) 1;
        this.Adapter.UpdateCommand.Parameters[213].Value = (object) DBNull.Value;
      }
      this.Adapter.UpdateCommand.Parameters[214].Value = (object) ID;
