...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLKULLANICILARTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLKULLANICILARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLKULLANICILARDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLKULLANICILARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLKULLANICILARDataTable data = new bellDataSet7.TBLKULLANICILARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLKULLANICILARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLKULLANICILAR");
