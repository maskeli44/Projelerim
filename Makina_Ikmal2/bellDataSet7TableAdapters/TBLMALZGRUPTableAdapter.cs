...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLMALZGRUPTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLMALZGRUPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLMALZGRUPDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLMALZGRUPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLMALZGRUPDataTable data = new bellDataSet7.TBLMALZGRUPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLMALZGRUPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZGRUP");
