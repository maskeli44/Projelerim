...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLBIRIMYETKILILERITableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLBIRIMYETKILILERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet7.TBLBIRIMYETKILILERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLBIRIMYETKILILERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLBIRIMYETKILILERIDataTable data = new bellDataSet7.TBLBIRIMYETKILILERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBIRIMYETKILILERI");
