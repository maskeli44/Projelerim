...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLARACRESIMTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLARACRESIMTableAdapter : Component
  {
    ...
    public TBLARACRESIMTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [TBLARACRESIM] ([ARACID], [ARACRESIMARKA], [ARACRESIMON], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@ARACID, @ARACRESIMARKA, @ARACRESIMON, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, ARACID, ARACRESIMARKA, ARACRESIMON, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLARACRESIM WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ARACRESIMARKA", SqlDbType.Image, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACRESIMARKA", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ARACRESIMON", SqlDbType.Image, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACRESIMON", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [TBLARACRESIM] SET [ARACID] = @ARACID, [ARACRESIMARKA] = @ARACRESIMARKA, [ARACRESIMON] = @ARACRESIMON, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_ARACID = 1 AND [ARACID] IS NULL) OR ([ARACID] = @Original_ARACID)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, ARACID, ARACRESIMARKA, ARACRESIMON, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLARACRESIM WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ARACRESIMARKA", SqlDbType.Image, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACRESIMARKA", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ARACRESIMON", SqlDbType.Image, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ARACRESIMON", DataRowVersion.Current, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT        ID, ARACID, ARACRESIMARKA, ARACRESIMON, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP\r\nFROM            TBLARACRESIM";
    ...
    public virtual int Fill(bellDataSet7.TBLARACRESIMDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLARACRESIMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLARACRESIMDataTable data = new bellDataSet7.TBLARACRESIMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLARACRESIMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACRESIM");
      ...
      string EDITIP)
    {
      ...
      if (ARACRESIMARKA == null)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) ARACRESIMARKA;
      if (ARACRESIMON == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) ARACRESIMON;
      if (SAVEUSER == null)
      ...
      int ID)
    {
      ...
      if (ARACRESIMARKA == null)
        ...
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) ARACRESIMARKA;
      if (ARACRESIMON == null)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) ARACRESIMON;
      if (SAVEUSER == null)
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[16].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[17].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[19].Value = (object) Original_EDITUSER;
      }
      if (Original_EDITDATE == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[21].Value = (object) Original_EDITDATE;
      }
      if (Original_SAVEMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[23].Value = (object) Original_SAVEMAC;
      }
      if (Original_EDITMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[25].Value = (object) Original_EDITMAC;
      }
      if (Original_SAVEIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[27].Value = (object) Original_SAVEIP;
      }
      if (Original_EDITIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[29].Value = (object) Original_EDITIP;
      }
      this.Adapter.UpdateCommand.Parameters[30].Value = (object) ID;
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(ARACID, ARACRESIMARKA, ARACRESIMON, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_ARACID, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
