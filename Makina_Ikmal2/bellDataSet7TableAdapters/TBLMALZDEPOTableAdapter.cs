...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLMALZDEPOTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLMALZDEPOTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLMALZDEPODataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLMALZDEPODataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLMALZDEPODataTable data = new bellDataSet7.TBLMALZDEPODataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLMALZDEPODataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZDEPO");
