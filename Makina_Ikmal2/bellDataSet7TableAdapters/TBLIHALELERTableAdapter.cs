...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLIHALELERTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLIHALELERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLIHALELERDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLIHALELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLIHALELERDataTable data = new bellDataSet7.TBLIHALELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLIHALELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIHALELER");
