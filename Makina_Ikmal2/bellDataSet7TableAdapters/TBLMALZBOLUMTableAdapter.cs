...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLMALZBOLUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLMALZBOLUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLMALZBOLUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLMALZBOLUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLMALZBOLUMDataTable data = new bellDataSet7.TBLMALZBOLUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLMALZBOLUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZBOLUM");
