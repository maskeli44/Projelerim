...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLPERSONELDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLPERSONELDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLPERSONELDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLPERSONELDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLPERSONELDURUMDataTable data = new bellDataSet7.TBLPERSONELDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLPERSONELDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELDURUM");
