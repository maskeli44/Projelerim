...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLARACMESTKPTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLARACMESTKPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLARACMESTKPDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLARACMESTKPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLARACMESTKPDataTable data = new bellDataSet7.TBLARACMESTKPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLARACMESTKPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACMESTKP");
