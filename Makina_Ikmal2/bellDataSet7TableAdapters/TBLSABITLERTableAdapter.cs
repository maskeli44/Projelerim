...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLSABITLERTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLSABITLERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLSABITLERDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLSABITLERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLSABITLERDataTable data = new bellDataSet7.TBLSABITLERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLSABITLERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLSABITLER");
