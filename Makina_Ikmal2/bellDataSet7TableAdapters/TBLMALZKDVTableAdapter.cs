...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLMALZKDVTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLMALZKDVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLMALZKDVDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLMALZKDVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLMALZKDVDataTable data = new bellDataSet7.TBLMALZKDVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLMALZKDVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZKDV");
