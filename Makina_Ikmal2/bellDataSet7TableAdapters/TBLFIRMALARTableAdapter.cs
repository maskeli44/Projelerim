...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLFIRMALARTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLFIRMALARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLFIRMALARDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLFIRMALARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLFIRMALARDataTable data = new bellDataSet7.TBLFIRMALARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLFIRMALARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFIRMALAR");
