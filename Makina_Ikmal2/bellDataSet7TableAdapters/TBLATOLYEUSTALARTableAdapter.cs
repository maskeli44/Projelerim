...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLATOLYEUSTALARTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLATOLYEUSTALARTableAdapter : Component
  {
    ...
    public TBLATOLYEUSTALARTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_USTAADISOYADI", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_USTAADISOYADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLATOLYEUSTALAR] ([ATOLYEID], [USTAADISOYADI], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@ATOLYEID, @USTAADISOYADI, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, ATOLYEID, USTAADISOYADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLATOLYEUSTALAR WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@USTAADISOYADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLATOLYEUSTALAR] SET [ATOLYEID] = @ATOLYEID, [USTAADISOYADI] = @USTAADISOYADI, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_ATOLYEID = 1 AND [ATOLYEID] IS NULL) OR ([ATOLYEID] = @Original_ATOLYEID)) AND ((@IsNull_USTAADISOYADI = 1 AND [USTAADISOYADI] IS NULL) OR ([USTAADISOYADI] = @Original_USTAADISOYADI)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, ATOLYEID, USTAADISOYADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLATOLYEUSTALAR WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@USTAADISOYADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_USTAADISOYADI", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_USTAADISOYADI", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "USTAADISOYADI", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ATOLYEID, USTAADISOYADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLATOLYEUSTALAR";
    ...
    public virtual int Fill(bellDataSet7.TBLATOLYEUSTALARDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLATOLYEUSTALARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLATOLYEUSTALARDataTable data = new bellDataSet7.TBLATOLYEUSTALARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLATOLYEUSTALARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLATOLYEUSTALAR");
      ...
      string Original_EDITIP)
    {
      ...
      if (Original_USTAADISOYADI == null)
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[4].Value = (object) Original_USTAADISOYADI;
      }
      ...
      if (Original_SAVEDATE.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      if (Original_EDITDATE.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[12].Value = (object) Original_EDITDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[14].Value = (object) Original_SAVEMAC;
      }
      ...
      string EDITIP)
    {
      ...
      if (USTAADISOYADI == null)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) USTAADISOYADI;
      if (SAVEUSER == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) SAVEDATE.Value;
      else
      ...
      if (EDITDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) EDITDATE.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      if (SAVEMAC == null)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) SAVEMAC;
      if (EDITMAC == null)
      ...
      int ID)
    {
      ...
      if (USTAADISOYADI == null)
        ...
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) USTAADISOYADI;
      if (SAVEUSER == null)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) SAVEDATE.Value;
      else
      ...
      if (EDITDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) EDITDATE.Value;
      else
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) DBNull.Value;
      if (SAVEMAC == null)
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) SAVEMAC;
      if (EDITMAC == null)
      ...
      if (Original_ATOLYEID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) Original_ATOLYEID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[14].Value = (object) Original_USTAADISOYADI;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      if (Original_SAVEDATE.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[18].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      if (Original_EDITDATE.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[22].Value = (object) Original_EDITDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[24].Value = (object) Original_SAVEMAC;
      }
      if (Original_EDITMAC == null)
      {
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(ATOLYEID, USTAADISOYADI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_ATOLYEID, Original_USTAADISOYADI, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
