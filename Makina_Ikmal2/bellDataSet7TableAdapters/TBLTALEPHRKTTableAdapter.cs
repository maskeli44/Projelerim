...
// Type: Makina_Ikmal.bellDataSet7TableAdapters.TBLTALEPHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet7TableAdapters
{
  ...
  public class TBLTALEPHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet7.TBLTALEPHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet7.TBLTALEPHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet7.TBLTALEPHRKTDataTable data = new bellDataSet7.TBLTALEPHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7.TBLTALEPHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet7 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPHRKT");
