...
// Type: Makina_Ikmal.Model.AracKarnesiListeTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiListeTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracKarnesiListe dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(AracKarnesiListe dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiListe dataSet)
    {
      if (dataSet == null)
