...
// Type: Makina_Ikmal.Model.BakanlikIsEmriAnaliz
...
namespace Makina_Ikmal.Model
{
  ...
  [XmlRoot("BakanlikIsEmriAnaliz")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class BakanlikIsEmriAnaliz : DataSet
  {
    private BakanlikIsEmriAnaliz.DataTable1DataTable tableDataTable1;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public BakanlikIsEmriAnaliz()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected BakanlikIsEmriAnaliz(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new BakanlikIsEmriAnaliz.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public BakanlikIsEmriAnaliz.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      BakanlikIsEmriAnaliz bakanlikIsEmriAnaliz = (BakanlikIsEmriAnaliz) base.Clone();
      bakanlikIsEmriAnaliz.InitVars();
      bakanlikIsEmriAnaliz.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) bakanlikIsEmriAnaliz;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new BakanlikIsEmriAnaliz.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (BakanlikIsEmriAnaliz.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (BakanlikIsEmriAnaliz);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/BakanlikIsEmriAnaliz.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new BakanlikIsEmriAnaliz.DataTable1DataTable();
    ...
    {
      BakanlikIsEmriAnaliz bakanlikIsEmriAnaliz = new BakanlikIsEmriAnaliz();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = bakanlikIsEmriAnaliz.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = bakanlikIsEmriAnaliz.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      BakanlikIsEmriAnaliz.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<BakanlikIsEmriAnaliz.DataTable1Row>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public BakanlikIsEmriAnaliz.DataTable1Row this[int index] => (BakanlikIsEmriAnaliz.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event BakanlikIsEmriAnaliz.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event BakanlikIsEmriAnaliz.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event BakanlikIsEmriAnaliz.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event BakanlikIsEmriAnaliz.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(BakanlikIsEmriAnaliz.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public BakanlikIsEmriAnaliz.DataTable1Row AddDataTable1Row(
        int Birim_Adı,
        string PLAKA,
        string ARACACIKLAMA,
        string ISLEMTIPIID,
        ...
        string GUNCELDEGERI)
      {
        BakanlikIsEmriAnaliz.DataTable1Row row = (BakanlikIsEmriAnaliz.DataTable1Row) this.NewRow();
      ...
      {
        BakanlikIsEmriAnaliz.DataTable1DataTable dataTable1DataTable = (BakanlikIsEmriAnaliz.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new BakanlikIsEmriAnaliz.DataTable1DataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public BakanlikIsEmriAnaliz.DataTable1Row NewDataTable1Row() => (BakanlikIsEmriAnaliz.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new BakanlikIsEmriAnaliz.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (BakanlikIsEmriAnaliz.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new BakanlikIsEmriAnaliz.DataTable1RowChangeEvent((BakanlikIsEmriAnaliz.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new BakanlikIsEmriAnaliz.DataTable1RowChangeEvent((BakanlikIsEmriAnaliz.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new BakanlikIsEmriAnaliz.DataTable1RowChangeEvent((BakanlikIsEmriAnaliz.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new BakanlikIsEmriAnaliz.DataTable1RowChangeEvent((BakanlikIsEmriAnaliz.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(BakanlikIsEmriAnaliz.DataTable1Row row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = bakanlikIsEmriAnaliz.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (BakanlikIsEmriAnaliz.DataTable1DataTable) this.Table;
      }
      ...
      public int Birim_Adı
      {
        get
        {
          try
          {
            return (int) this[this.tableDataTable1.Birim_AdıColumn];
          }
          catch (InvalidCastException ex)
          {
            throw new StrongTypingException("'DataTable1' tablosundaki 'Birim Adı' sütunun değeri DBNull.", (Exception) ex);
          }
        }
        set => this[this.tableDataTable1.Birim_AdıColumn] = (object) value;
      }
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public bool IsBirim_AdıNull() => this.IsNull(this.tableDataTable1.Birim_AdıColumn);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void SetBirim_AdıNull() => this[this.tableDataTable1.Birim_AdıColumn] = Convert.DBNull;
    ...
    {
      private BakanlikIsEmriAnaliz.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(BakanlikIsEmriAnaliz.DataTable1Row row, DataRowAction action)
      {
        this.eventRow = row;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public BakanlikIsEmriAnaliz.DataTable1Row Row => this.eventRow;
