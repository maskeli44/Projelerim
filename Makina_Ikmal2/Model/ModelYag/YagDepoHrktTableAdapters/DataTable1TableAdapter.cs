...
// Type: Makina_Ikmal.Model.ModelYag.YagDepoHrktTableAdapters.DataTable1TableAdapter
...
namespace Makina_Ikmal.Model.ModelYag.YagDepoHrktTableAdapters
{
  ...
  public class DataTable1TableAdapter : Component
  {
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT TBLDEPOFISHRKT.ID, TBLDEPOFISHRKT.MIKTAR, TBLDEPOFISHRKT.FIYAT, TBLDEPOFISHRKT.TUTAR, TBLDEPOFIS.ISEMRIID, TBLMALZEMELER.MALZEMEADI, TBLMALZBIRIM.BIRIMADI, TBLDEPOFIS.ISLEMTIPIID, \r\n                  TBLDEPOFIS.KOD\r\nFROM     TBLDEPOFISHRKT INNER JOIN\r\n                  TBLDEPOFIS ON TBLDEPOFISHRKT.DEPOFISID = TBLDEPOFIS.ID INNER JOIN\r\n                  TBLMALZEMELER ON TBLDEPOFISHRKT.MALZEMEID = TBLMALZEMELER.ID INNER JOIN\r\n                  TBLMALZBIRIM ON TBLMALZEMELER.BIRIMID = TBLMALZBIRIM.ID\r\nWHERE  (TBLDEPOFIS.ISEMRIID = @id) AND (TBLDEPOFIS.ISLEMTIPIID = N'3')";
    ...
    public virtual int Fill(YagDepoHrkt.DataTable1DataTable dataTable, int? id)
    {
    ...
    public virtual YagDepoHrkt.DataTable1DataTable GetData(int? id)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (id.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) id.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
      YagDepoHrkt.DataTable1DataTable data = new YagDepoHrkt.DataTable1DataTable();
