...
// Type: Makina_Ikmal.Model.AracMuayeneTakipTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracMuayeneTakipTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracMuayeneTakip dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(AracMuayeneTakip dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracMuayeneTakip dataSet)
    {
      if (dataSet == null)
