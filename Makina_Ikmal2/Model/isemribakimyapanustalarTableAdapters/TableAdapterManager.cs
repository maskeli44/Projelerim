...
// Type: Makina_Ikmal.Model.isemribakimyapanustalarTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.isemribakimyapanustalarTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      isemribakimyapanustalar dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(isemribakimyapanustalar dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(isemribakimyapanustalar dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(isemribakimyapanustalar dataSet)
    {
      if (dataSet == null)
