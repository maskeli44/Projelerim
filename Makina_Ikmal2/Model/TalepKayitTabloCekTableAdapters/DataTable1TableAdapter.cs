...
// Type: Makina_Ikmal.Model.TalepKayitTabloCekTableAdapters.DataTable1TableAdapter
...
namespace Makina_Ikmal.Model.TalepKayitTabloCekTableAdapters
{
  ...
  public class DataTable1TableAdapter : Component
  {
    ...
    public virtual int Fill(TalepKayitTabloCek.DataTable1DataTable dataTable, string para)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (para == null)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.SelectCommand.Parameters[0].Value = (object) para;
    ...
    public virtual TalepKayitTabloCek.DataTable1DataTable GetData(string para)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (para == null)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) para;
      TalepKayitTabloCek.DataTable1DataTable data = new TalepKayitTabloCek.DataTable1DataTable();
