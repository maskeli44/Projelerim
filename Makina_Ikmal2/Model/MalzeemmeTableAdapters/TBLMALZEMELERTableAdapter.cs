...
// Type: Makina_Ikmal.Model.MalzeemmeTableAdapters.TBLMALZEMELERTableAdapter
...
namespace Makina_Ikmal.Model.MalzeemmeTableAdapters
{
  ...
  public class TBLMALZEMELERTableAdapter : Component
  {
    ...
    public virtual int Fill(Malzeemme.TBLMALZEMELERDataTable dataTable)
    {
    ...
    public virtual Malzeemme.TBLMALZEMELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      Malzeemme.TBLMALZEMELERDataTable data = new Malzeemme.TBLMALZEMELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme.TBLMALZEMELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZEMELER");
