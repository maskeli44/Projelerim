...
// Type: Makina_Ikmal.Model.MalzeemmeTableAdapters.TBLFILITRETableAdapter
...
namespace Makina_Ikmal.Model.MalzeemmeTableAdapters
{
  ...
  public class TBLFILITRETableAdapter : Component
  {
    ...
    public TBLFILITRETableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_SAVEDATE", SqlDbType.DateTime, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "SAVEDATE", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_GIRIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "GIRIS", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_CIKIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "CIKIS", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@SAVEDATE", SqlDbType.DateTime, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "SAVEDATE", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@SAVEDATE", SqlDbType.DateTime, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "SAVEDATE", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@GIRIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "GIRIS", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@CIKIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "CIKIS", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@KALAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "KALAN", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_SAVEDATE", SqlDbType.DateTime, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "SAVEDATE", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_GIRIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "GIRIS", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_CIKIS", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "CIKIS", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_KALAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "KALAN", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, KOD, UFKOD, OEMKOD, MALZEMEADI, DIGERADI, KULLANIMYERI, BIRIMID, GRUPID, GRUPID2, KDVID, BOLUMID, RAFNO, GOZNO, BARKOD, TARIHKONTROL, SERINOKONTROL, KMKONTROL, MALZEMEFOTO, \r\n                  KAYITTIPIID, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, GIRIS, CIKIS, KALAN\r\nFROM     TBLMALZEMELER\r\nWHERE  (GRUPID = 5) \r\n                ";
    ...
    public virtual int Fill(Malzeemme.TBLFILITREDataTable dataTable)
    {
    ...
    public virtual Malzeemme.TBLFILITREDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      Malzeemme.TBLFILITREDataTable data = new Malzeemme.TBLFILITREDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme.TBLFILITREDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFILITRE");
      ...
      string Original_KALAN)
    {
      ...
      if (Original_SAVEDATE.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[42].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[56].Value = (object) Original_GIRIS;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[58].Value = (object) Original_CIKIS;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[60].Value = (object) Original_KALAN;
      }
      ...
      string KALAN)
    {
      ...
      if (SAVEDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[20].Value = (object) SAVEDATE.Value;
      else
      ...
      if (GIRIS == null)
        ...
        this.Adapter.InsertCommand.Parameters[27].Value = (object) GIRIS;
      if (CIKIS == null)
        this.Adapter.InsertCommand.Parameters[28].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[28].Value = (object) CIKIS;
      if (KALAN == null)
        this.Adapter.InsertCommand.Parameters[29].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[29].Value = (object) KALAN;
      ...
      int ID)
    {
      ...
      if (SAVEDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[20].Value = (object) SAVEDATE.Value;
      else
      ...
      if (GIRIS == null)
        ...
        this.Adapter.UpdateCommand.Parameters[27].Value = (object) GIRIS;
      if (CIKIS == null)
        this.Adapter.UpdateCommand.Parameters[28].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[28].Value = (object) CIKIS;
      if (KALAN == null)
        this.Adapter.UpdateCommand.Parameters[29].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[29].Value = (object) KALAN;
      ...
      if (Original_SAVEDATE.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[72].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[86].Value = (object) Original_GIRIS;
      }
      if (Original_CIKIS == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[88].Value = (object) Original_CIKIS;
      }
      if (Original_KALAN == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[90].Value = (object) Original_KALAN;
      }
