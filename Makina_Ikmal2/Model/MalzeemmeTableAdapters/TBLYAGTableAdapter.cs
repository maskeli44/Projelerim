...
// Type: Makina_Ikmal.Model.MalzeemmeTableAdapters.TBLYAGTableAdapter
...
namespace Makina_Ikmal.Model.MalzeemmeTableAdapters
{
  ...
  public class TBLYAGTableAdapter : Component
  {
    ...
    public TBLYAGTableAdapter() => this.ClearBeforeFill = true;
    ...
    public virtual int Fill(Malzeemme.TBLYAGDataTable dataTable)
    {
    ...
    public virtual Malzeemme.TBLYAGDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      Malzeemme.TBLYAGDataTable data = new Malzeemme.TBLYAGDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme.TBLYAGDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(Malzeemme dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLYAG");
