...
// Type: Makina_Ikmal.Model.ustabas
...
namespace Makina_Ikmal.Model
{
  ...
  [Serializable]
  public class ustabas : DataSet
  {
    private ustabas.DataTable1DataTable tableDataTable1;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected ustabas(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new ustabas.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public ustabas.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      ustabas ustabas = (ustabas) base.Clone();
      ustabas.InitVars();
      ustabas.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) ustabas;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new ustabas.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (ustabas.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (ustabas);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/ustabas.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new ustabas.DataTable1DataTable();
    ...
    {
      ustabas ustabas = new ustabas();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = ustabas.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = ustabas.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      ustabas.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<ustabas.DataTable1Row>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustabas.DataTable1Row this[int index] => (ustabas.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustabas.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustabas.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustabas.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustabas.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(ustabas.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustabas.DataTable1Row AddDataTable1Row(
        int ARACID,
        DateTime GIRISTARIH,
        DateTime CIKISTARIH,
        int BAKIMGRUBUID,
        int BAKIMYAPUSTAID)
      {
        ustabas.DataTable1Row row = (ustabas.DataTable1Row) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustabas.DataTable1Row FindByID(int ID) => (ustabas.DataTable1Row) this.Rows.Find(new object[1]
      {
        (object) ID
      });
      ...
      {
        ustabas.DataTable1DataTable dataTable1DataTable = (ustabas.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new ustabas.DataTable1DataTable();
      ...
      private void InitClass()
      {
        ...
        this.columnBAKIMGRUBUID.AllowDBNull = false;
        this.columnBAKIMYAPUSTAID.AllowDBNull = false;
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustabas.DataTable1Row NewDataTable1Row() => (ustabas.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new ustabas.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (ustabas.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new ustabas.DataTable1RowChangeEvent((ustabas.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new ustabas.DataTable1RowChangeEvent((ustabas.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new ustabas.DataTable1RowChangeEvent((ustabas.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new ustabas.DataTable1RowChangeEvent((ustabas.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(ustabas.DataTable1Row row) => this.Rows.Remove((DataRow) row);
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (ustabas.DataTable1DataTable) this.Table;
      }
      ...
      {
        get => (int) this[this.tableDataTable1.BAKIMGRUBUIDColumn];
      ...
      {
        get => (int) this[this.tableDataTable1.BAKIMYAPUSTAIDColumn];
    ...
    {
      private ustabas.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(ustabas.DataTable1Row row, DataRowAction action)
      {
        this.eventRow = row;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustabas.DataTable1Row Row => this.eventRow;
