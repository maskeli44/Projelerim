...
// Type: Makina_Ikmal.Model.AracKarnesiYapilanBakimlarTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiYapilanBakimlarTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      AracKarnesiYapilanBakimlar dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracKarnesiYapilanBakimlar dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(AracKarnesiYapilanBakimlar dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiYapilanBakimlar dataSet)
    {
      if (dataSet == null)
