...
// Type: Makina_Ikmal.Model.BaskanlikIsEmriTvEkranCikisYapanTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.BaskanlikIsEmriTvEkranCikisYapanTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      BaskanlikIsEmriTvEkranCikisYapan dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(BaskanlikIsEmriTvEkranCikisYapan dataSet)
    {
      if (dataSet == null)
