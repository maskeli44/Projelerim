...
// Type: Makina_Ikmal.Model.MoldelAtolye.ustaEkran_isemri
...
namespace Makina_Ikmal.Model.MoldelAtolye
{
  ...
  [XmlRoot("ustaEkran_isemri")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class ustaEkran_isemri : DataSet
  {
    private ustaEkran_isemri.DataTable1DataTable tableDataTable1;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public ustaEkran_isemri()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected ustaEkran_isemri(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new ustaEkran_isemri.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public ustaEkran_isemri.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      ustaEkran_isemri ustaEkranIsemri = (ustaEkran_isemri) base.Clone();
      ustaEkranIsemri.InitVars();
      ustaEkranIsemri.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) ustaEkranIsemri;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new ustaEkran_isemri.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (ustaEkran_isemri.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (ustaEkran_isemri);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/ustaEkran_isemri.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new ustaEkran_isemri.DataTable1DataTable();
    ...
    {
      ustaEkran_isemri ustaEkranIsemri = new ustaEkran_isemri();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = ustaEkranIsemri.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = ustaEkranIsemri.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      ustaEkran_isemri.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<ustaEkran_isemri.DataTable1Row>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustaEkran_isemri.DataTable1Row this[int index] => (ustaEkran_isemri.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustaEkran_isemri.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustaEkran_isemri.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustaEkran_isemri.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event ustaEkran_isemri.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(ustaEkran_isemri.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustaEkran_isemri.DataTable1Row AddDataTable1Row(
        string KOD,
        string PLAKA,
        DateTime GIRISTARIH,
        DateTime CIKISTARIH,
        int BAKIMYAPUSTAID)
      {
        ustaEkran_isemri.DataTable1Row row = (ustaEkran_isemri.DataTable1Row) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustaEkran_isemri.DataTable1Row FindByID(int ID) => (ustaEkran_isemri.DataTable1Row) this.Rows.Find(new object[1]
      {
        (object) ID
      });
      ...
      {
        ustaEkran_isemri.DataTable1DataTable dataTable1DataTable = (ustaEkran_isemri.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new ustaEkran_isemri.DataTable1DataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustaEkran_isemri.DataTable1Row NewDataTable1Row() => (ustaEkran_isemri.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new ustaEkran_isemri.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (ustaEkran_isemri.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new ustaEkran_isemri.DataTable1RowChangeEvent((ustaEkran_isemri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new ustaEkran_isemri.DataTable1RowChangeEvent((ustaEkran_isemri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new ustaEkran_isemri.DataTable1RowChangeEvent((ustaEkran_isemri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new ustaEkran_isemri.DataTable1RowChangeEvent((ustaEkran_isemri.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(ustaEkran_isemri.DataTable1Row row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = ustaEkranIsemri.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (ustaEkran_isemri.DataTable1DataTable) this.Table;
      }
    ...
    {
      private ustaEkran_isemri.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(ustaEkran_isemri.DataTable1Row row, DataRowAction action)
      {
        this.eventRow = row;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public ustaEkran_isemri.DataTable1Row Row => this.eventRow;
