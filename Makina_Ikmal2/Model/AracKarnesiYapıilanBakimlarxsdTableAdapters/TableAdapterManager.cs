...
// Type: Makina_Ikmal.Model.AracKarnesiYapıilanBakimlarxsdTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiYapıilanBakimlarxsdTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      AracKarnesiYapıilanBakimlarxsd dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiYapıilanBakimlarxsd dataSet)
    {
      if (dataSet == null)
