...
// Type: Makina_Ikmal.Model.AracKarnesiMalzemeToplamlariTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiMalzemeToplamlariTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      AracKarnesiMalzemeToplamlari dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracKarnesiMalzemeToplamlari dataSet, List<DataRow> allAddedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiMalzemeToplamlari dataSet)
    {
      if (dataSet == null)
