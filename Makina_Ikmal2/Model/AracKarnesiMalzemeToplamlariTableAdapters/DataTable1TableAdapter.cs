...
// Type: Makina_Ikmal.Model.AracKarnesiMalzemeToplamlariTableAdapters.DataTable1TableAdapter
...
namespace Makina_Ikmal.Model.AracKarnesiMalzemeToplamlariTableAdapters
{
  ...
  public class DataTable1TableAdapter : Component
  {
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT        TBLDEPOFISHRKT.ID AS DepoFisHrktID, TBLDEPOFISHRKT.MALZEMEID, TBLDEPOFISHRKT.MIKTAR, TBLDEPOFISHRKT.FIYAT, TBLDEPOFISHRKT.TUTAR, TBLDEPOFISHRKT.DEPOFISID AS DepoFisID, \r\n                         TBLDEPOFIS.ISEMRIID AS IsEmriId, TBLISEMRI.ARACID\r\nFROM            TBLDEPOFISHRKT INNER JOIN\r\n                         TBLDEPOFIS ON TBLDEPOFISHRKT.DEPOFISID = TBLDEPOFIS.ID INNER JOIN\r\n                         TBLISEMRI ON TBLDEPOFIS.ISEMRIID = TBLISEMRI.ID\r\nWHERE        (TBLISEMRI.ARACID = @aracid)";
    ...
    public virtual int Fill(
      AracKarnesiMalzemeToplamlari.DataTable1DataTable dataTable,
      int? aracid)
    {
    ...
    public virtual AracKarnesiMalzemeToplamlari.DataTable1DataTable GetData(int? aracid)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (aracid.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) aracid.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
      AracKarnesiMalzemeToplamlari.DataTable1DataTable data = new AracKarnesiMalzemeToplamlari.DataTable1DataTable();
