...
// Type: Makina_Ikmal.Model.AracKarnesiAtolyeIsEmirTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiAtolyeIsEmirTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      AracKarnesiAtolyeIsEmir dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracKarnesiAtolyeIsEmir dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLISEMRITableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(AracKarnesiAtolyeIsEmir dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLISEMRITableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiAtolyeIsEmir dataSet)
    {
      if (dataSet == null)
