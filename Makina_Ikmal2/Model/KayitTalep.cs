...
// Type: Makina_Ikmal.Model.KayitTalep
...
namespace Makina_Ikmal.Model
{
  ...
  [Serializable]
  public class KayitTalep : DataSet
  {
    private KayitTalep.DataTable1DataTable tableDataTable1;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected KayitTalep(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new KayitTalep.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public KayitTalep.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      KayitTalep kayitTalep = (KayitTalep) base.Clone();
      kayitTalep.InitVars();
      kayitTalep.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) kayitTalep;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new KayitTalep.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (KayitTalep.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (KayitTalep);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/KayitTalep.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new KayitTalep.DataTable1DataTable();
    ...
    {
      KayitTalep kayitTalep = new KayitTalep();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = kayitTalep.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = kayitTalep.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      KayitTalep.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<KayitTalep.DataTable1Row>
    {
      ...
      private DataColumn columnisemri_id;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataColumn isemri_idColumn => this.columnisemri_id;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public KayitTalep.DataTable1Row this[int index] => (KayitTalep.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event KayitTalep.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event KayitTalep.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event KayitTalep.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event KayitTalep.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(KayitTalep.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public KayitTalep.DataTable1Row AddDataTable1Row(
        int ARACID,
        string KOD,
        string PLAKA,
        string ARACACIKLAMA,
        ...
        int ISEMRIDURUMID)
      {
        KayitTalep.DataTable1Row row = (KayitTalep.DataTable1Row) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public KayitTalep.DataTable1Row FindByID(int ID) => (KayitTalep.DataTable1Row) this.Rows.Find(new object[1]
      {
        (object) ID
      });
      ...
      {
        KayitTalep.DataTable1DataTable dataTable1DataTable = (KayitTalep.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new KayitTalep.DataTable1DataTable();
      ...
      internal void InitVars()
      {
        ...
        this.columnisemri_id = this.Columns["isemri_id"];
      ...
      private void InitClass()
      {
        ...
        this.columnisemri_id = new DataColumn("isemri_id", typeof (int), (string) null, MappingType.Element);
        this.Columns.Add(this.columnisemri_id);
        ...
        this.columnisemri_id.AutoIncrement = true;
        this.columnisemri_id.AutoIncrementSeed = -1L;
        this.columnisemri_id.AutoIncrementStep = -1L;
        this.columnisemri_id.AllowDBNull = false;
        this.columnisemri_id.ReadOnly = true;
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public KayitTalep.DataTable1Row NewDataTable1Row() => (KayitTalep.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new KayitTalep.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (KayitTalep.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new KayitTalep.DataTable1RowChangeEvent((KayitTalep.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new KayitTalep.DataTable1RowChangeEvent((KayitTalep.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new KayitTalep.DataTable1RowChangeEvent((KayitTalep.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new KayitTalep.DataTable1RowChangeEvent((KayitTalep.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(KayitTalep.DataTable1Row row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = kayitTalep.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (KayitTalep.DataTable1DataTable) this.Table;
      }
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public int isemri_id
      {
        get => (int) this[this.tableDataTable1.isemri_idColumn];
        set => this[this.tableDataTable1.isemri_idColumn] = (object) value;
      }
    ...
    {
      private KayitTalep.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(KayitTalep.DataTable1Row row, DataRowAction action)
      {
        this.eventRow = row;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public KayitTalep.DataTable1Row Row => this.eventRow;
