...
// Type: Makina_Ikmal.Model.AracKarnesiKullanılanMalzemelerTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.AracKarnesiKullanılanMalzemelerTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      AracKarnesiKullanılanMalzemeler dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracKarnesiKullanılanMalzemeler dataSet)
    {
      if (dataSet == null)
