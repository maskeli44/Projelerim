...
// Type: Makina_Ikmal.Model.BaskanlikIsEmriTvEkranTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.BaskanlikIsEmriTvEkranTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      BaskanlikIsEmriTvEkran dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(BaskanlikIsEmriTvEkran dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(BaskanlikIsEmriTvEkran dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(BaskanlikIsEmriTvEkran dataSet)
    {
      if (dataSet == null)
