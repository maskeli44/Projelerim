...
// Type: Makina_Ikmal.Model.AracSigortaKontrolTableAdapters.TableAdapterManager
  ...
  public class TableAdapterManager : Component
  {
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._tBLARACLARTableAdapter != null && this._tBLARACLARTableAdapter.Connection != null ? (IDbConnection) this._tBLARACLARTableAdapter.Connection : (IDbConnection) null;
      }
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(AracSigortaKontrol dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(AracSigortaKontrol dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLARACLARTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(AracSigortaKontrol dataSet)
    {
      if (dataSet == null)
