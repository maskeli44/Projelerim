...
// Type: Makina_Ikmal.Model.AracKarnesiAtolyeIsEmirleri
...
namespace Makina_Ikmal.Model
{
  ...
  [XmlRoot("AracKarnesiAtolyeIsEmirleri")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class AracKarnesiAtolyeIsEmirleri : DataSet
  {
    private AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable tableTBLISEMRI;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public AracKarnesiAtolyeIsEmirleri()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected AracKarnesiAtolyeIsEmirleri(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (TBLISEMRI)] != null)
            base.Tables.Add((DataTable) new AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable(dataSet.Tables[nameof (TBLISEMRI)]));
    ...
    public AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable TBLISEMRI => this.tableTBLISEMRI;
    ...
    {
      AracKarnesiAtolyeIsEmirleri atolyeIsEmirleri = (AracKarnesiAtolyeIsEmirleri) base.Clone();
      atolyeIsEmirleri.InitVars();
      atolyeIsEmirleri.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) atolyeIsEmirleri;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["TBLISEMRI"] != null)
          base.Tables.Add((DataTable) new AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable(dataSet.Tables["TBLISEMRI"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableTBLISEMRI = (AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable) base.Tables["TBLISEMRI"];
    ...
    {
      this.DataSetName = nameof (AracKarnesiAtolyeIsEmirleri);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/AracKarnesiAtolyeIsEmirleri.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableTBLISEMRI = new AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable();
    ...
    {
      AracKarnesiAtolyeIsEmirleri atolyeIsEmirleri = new AracKarnesiAtolyeIsEmirleri();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = atolyeIsEmirleri.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = atolyeIsEmirleri.GetSchemaSerializable();
    ...
    public delegate void TBLISEMRIRowChangeEventHandler(
      object sender,
      AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class TBLISEMRIDataTable : TypedTableBase<AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow this[int index] => (AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEventHandler TBLISEMRIRowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEventHandler TBLISEMRIRowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEventHandler TBLISEMRIRowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEventHandler TBLISEMRIRowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddTBLISEMRIRow(AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow AddTBLISEMRIRow(
        int Arıza_Nedeni,
        DateTime GIRISTARIH,
        DateTime CIKISTARIH,
        ...
        int ARACID)
      {
        AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow row = (AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow FindByID(int ID) => (AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) this.Rows.Find(new object[1]
      {
        (object) ID
      });
      ...
      {
        AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable tblisemriDataTable = (AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow NewTBLISEMRIRow() => (AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.TBLISEMRIRowChanged == null)
          return;
        this.TBLISEMRIRowChanged((object) this, new AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEvent((AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.TBLISEMRIRowChanging == null)
          return;
        this.TBLISEMRIRowChanging((object) this, new AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEvent((AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.TBLISEMRIRowDeleted == null)
          return;
        this.TBLISEMRIRowDeleted((object) this, new AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEvent((AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.TBLISEMRIRowDeleting == null)
          return;
        this.TBLISEMRIRowDeleting((object) this, new AracKarnesiAtolyeIsEmirleri.TBLISEMRIRowChangeEvent((AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveTBLISEMRIRow(AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = atolyeIsEmirleri.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class TBLISEMRIRow : DataRow
    {
      ...
      internal TBLISEMRIRow(DataRowBuilder rb)
        : base(rb)
      {
        this.tableTBLISEMRI = (AracKarnesiAtolyeIsEmirleri.TBLISEMRIDataTable) this.Table;
      }
    ...
    {
      private AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public TBLISEMRIRowChangeEvent(
        AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow row,
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public AracKarnesiAtolyeIsEmirleri.TBLISEMRIRow Row => this.eventRow;
