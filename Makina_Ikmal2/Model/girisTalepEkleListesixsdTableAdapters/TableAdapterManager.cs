...
// Type: Makina_Ikmal.Model.girisTalepEkleListesixsdTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.girisTalepEkleListesixsdTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      girisTalepEkleListesixsd dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(girisTalepEkleListesixsd dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(girisTalepEkleListesixsd dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(girisTalepEkleListesixsd dataSet)
    {
      if (dataSet == null)
