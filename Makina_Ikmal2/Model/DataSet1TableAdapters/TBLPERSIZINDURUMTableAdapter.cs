...
// Type: Makina_Ikmal.Model.DataSet1TableAdapters.TBLPERSIZINDURUMTableAdapter
...
namespace Makina_Ikmal.Model.DataSet1TableAdapters
{
  ...
  public class TBLPERSIZINDURUMTableAdapter : Component
  {
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [TBLPERSIZINDURUM] WHERE (((@IsNull_PERSONELID = 1 AND [PERSONELID] IS NULL) OR ([PERSONELID] = @Original_PERSONELID)) AND ((@IsNull_IZINYILI = 1 AND [IZINYILI] IS NULL) OR ([IZINYILI] = @Original_IZINYILI)) AND ((@IsNull_IZINHAKKI = 1 AND [IZINHAKKI] IS NULL) OR ([IZINHAKKI] = @Original_IZINHAKKI)) AND ((@IsNull_KULLANILANIZIN = 1 AND [KULLANILANIZIN] IS NULL) OR ([KULLANILANIZIN] = @Original_KULLANILANIZIN)) AND ([ID] = @Original_ID) AND ((@IsNull_PERSONELIZINID = 1 AND [PERSONELIZINID] IS NULL) OR ([PERSONELIZINID] = @Original_PERSONELIZINID)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [TBLPERSIZINDURUM] ([PERSONELID], [IZINYILI], [IZINHAKKI], [KULLANILANIZIN], [PERSONELIZINID]) VALUES (@PERSONELID, @IZINYILI, @IZINHAKKI, @KULLANILANIZIN, @PERSONELIZINID);\r\nSELECT PERSONELID, IZINYILI, IZINHAKKI, KULLANILANIZIN, ID, PERSONELIZINID FROM TBLPERSIZINDURUM WHERE (ID = SCOPE_IDENTITY()) ORDER BY IZINYILI DESC";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [TBLPERSIZINDURUM] SET [PERSONELID] = @PERSONELID, [IZINYILI] = @IZINYILI, [IZINHAKKI] = @IZINHAKKI, [KULLANILANIZIN] = @KULLANILANIZIN, [PERSONELIZINID] = @PERSONELIZINID WHERE (((@IsNull_PERSONELID = 1 AND [PERSONELID] IS NULL) OR ([PERSONELID] = @Original_PERSONELID)) AND ((@IsNull_IZINYILI = 1 AND [IZINYILI] IS NULL) OR ([IZINYILI] = @Original_IZINYILI)) AND ((@IsNull_IZINHAKKI = 1 AND [IZINHAKKI] IS NULL) OR ([IZINHAKKI] = @Original_IZINHAKKI)) AND ((@IsNull_KULLANILANIZIN = 1 AND [KULLANILANIZIN] IS NULL) OR ([KULLANILANIZIN] = @Original_KULLANILANIZIN)) AND ([ID] = @Original_ID) AND ((@IsNull_PERSONELIZINID = 1 AND [PERSONELIZINID] IS NULL) OR ([PERSONELIZINID] = @Original_PERSONELIZINID)));\r\nSELECT PERSONELID, IZINYILI, IZINHAKKI, KULLANILANIZIN, ID, PERSONELIZINID FROM TBLPERSIZINDURUM WHERE (ID = @ID) ORDER BY IZINYILI DESC";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT PERSONELID, IZINYILI, IZINHAKKI, KULLANILANIZIN, ID, PERSONELIZINID\r\nFROM     TBLPERSIZINDURUM\r\nWHERE  (PERSONELID = @personelid)\r\nORDER BY IZINYILI DESC";
      this._commandCollection[0].CommandType = CommandType.Text;
      this._commandCollection[0].Parameters.Add(new SqlParameter("@personelid", SqlDbType.Int, 4, ParameterDirection.Input, (byte) 0, (byte) 0, "PERSONELID", DataRowVersion.Current, false, (object) null, "", "", ""));
    }
    ...
    public virtual int Fill(DataSet1.TBLPERSIZINDURUMDataTable dataTable, int? personelid)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (personelid.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) personelid.Value;
      else
    ...
    public virtual DataSet1.TBLPERSIZINDURUMDataTable GetData(int? personelid)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (personelid.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) personelid.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
      DataSet1.TBLPERSIZINDURUMDataTable data = new DataSet1.TBLPERSIZINDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(DataSet1.TBLPERSIZINDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSIZINDURUM");
      ...
      int? Original_PERSONELIZINID)
    {
      if (Original_PERSONELID.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[1].Value = (object) Original_PERSONELID.Value;
      }
      else
      {
      ...
      if (Original_IZINYILI.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[3].Value = (object) Original_IZINYILI.Value;
      }
      else
      {
      ...
      if (Original_IZINHAKKI.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[5].Value = (object) Original_IZINHAKKI.Value;
      }
      else
      {
      ...
      if (Original_KULLANILANIZIN.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[7].Value = (object) Original_KULLANILANIZIN.Value;
      }
      else
      {
      ...
      this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_ID;
      if (Original_PERSONELIZINID.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[9].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_PERSONELIZINID.Value;
      }
      else
      {
      ...
      int? PERSONELIZINID)
    {
      ...
      if (IZINYILI.HasValue)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) IZINYILI.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      if (IZINHAKKI.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) IZINHAKKI.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      if (KULLANILANIZIN.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) KULLANILANIZIN.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (PERSONELIZINID.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) PERSONELIZINID.Value;
      else
      ...
      int ID)
    {
      ...
      if (IZINYILI.HasValue)
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) IZINYILI.Value;
      else
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) DBNull.Value;
      if (IZINHAKKI.HasValue)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) IZINHAKKI.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      if (KULLANILANIZIN.HasValue)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) KULLANILANIZIN.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      if (PERSONELIZINID.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) PERSONELIZINID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      if (Original_PERSONELID.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) Original_PERSONELID.Value;
      }
      else
      {
      ...
      if (Original_IZINYILI.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) Original_IZINYILI.Value;
      }
      else
      {
      ...
      if (Original_IZINHAKKI.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[10].Value = (object) Original_IZINHAKKI.Value;
      }
      else
      {
      ...
      if (Original_KULLANILANIZIN.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) Original_KULLANILANIZIN.Value;
      }
      else
      {
      ...
      if (Original_PERSONELIZINID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_PERSONELIZINID.Value;
      }
      else
      {
    ...
    public virtual int Update(
      ...
      int? Original_PERSONELIZINID)
    {
      return this.Update(PERSONELID, IZINYILI, IZINHAKKI, KULLANILANIZIN, PERSONELIZINID, Original_PERSONELID, Original_IZINYILI, Original_IZINHAKKI, Original_KULLANILANIZIN, Original_ID, Original_PERSONELIZINID, Original_ID);
    }
  }
}
