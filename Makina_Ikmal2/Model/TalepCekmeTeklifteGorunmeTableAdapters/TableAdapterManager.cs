...
// Type: Makina_Ikmal.Model.TalepCekmeTeklifteGorunmeTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.Model.TalepCekmeTeklifteGorunmeTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      TalepCekmeTeklifteGorunme dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(TalepCekmeTeklifteGorunme dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(TalepCekmeTeklifteGorunme dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(TalepCekmeTeklifteGorunme dataSet)
    {
      if (dataSet == null)
