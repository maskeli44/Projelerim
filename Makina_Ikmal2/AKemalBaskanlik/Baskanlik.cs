...
// Type: Makina_Ikmal.AKemalBaskanlik.Baskanlik
...
{
  public class Baskanlik : XtraForm
  {
    ...
    public Baskanlik() => this.InitializeComponent();

    private void accordionControlElement2_Click(object sender, EventArgs e)
    {
      this.yet.yetkiislemleri("BAŞKANLIK");
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      AracKarnesi aracKarnesi = new AracKarnesi();
      aracKarnesi.MdiParent = (Form) this;
      aracKarnesi.Show();
    }
    ...
    private void accordionControlElement3_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      IsEmriTvEkran isEmriTvEkran = new IsEmriTvEkran();
      isEmriTvEkran.MdiParent = (Form) this;
      isEmriTvEkran.Show();
    }
    ...
    private void accordionControlElement4_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      IsEmriAnaliz isEmriAnaliz = new IsEmriAnaliz();
      isEmriAnaliz.MdiParent = (Form) this;
      isEmriAnaliz.Show();
    }
    ...
    private void accordionControlElement6_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      MalzemeAnaliz malzemeAnaliz = new MalzemeAnaliz();
      malzemeAnaliz.MdiParent = (Form) this;
      malzemeAnaliz.Show();
    }

    private void Baskanlik_FormClosed(object sender, FormClosedEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Baskanlik));
      ...
      this.accordionControlElement2.Text = "Araç Karnesi";
      ...
      this.accordionControlElement3.Text = "İş Emri TV Ekran";
      ...
      this.accordionControlElement4.Text = "İş Emri Analizi";
      ...
      this.accordionControlElement6.Text = "Malzeme Analizi";
      ...
      this.Name = nameof (Baskanlik);
      this.WindowState = FormWindowState.Maximized;
      this.FormClosed += new FormClosedEventHandler(this.Baskanlik_FormClosed);
