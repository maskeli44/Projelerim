...
// Type: Makina_Ikmal.Tasit.Basinsan
...
namespace Makina_Ikmal.Tasit
{
  public class Basinsan : XtraForm
  {
    ...
    {
      if (this.yet.MenuYetkilendirme("Taşıt Görev Listesi"))
      {
    ...
    private void InitializeComponent()
    {
      ...
      this.accordionControl1.Size = new Size(232, 466);
      ...
      this.accordionControlElement2.ImageOptions.Image = (Image) Resources.transit_32x321;
      this.accordionControlElement2.Name = "accordionControlElement2";
      this.accordionControlElement2.Style = ElementStyle.Item;
      this.accordionControlElement2.Text = "Taşıt Görev Listesi";
