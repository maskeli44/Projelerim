...
// Type: Makina_Ikmal.ModelYeni.izinRaporTableAdapters.DataTable1TableAdapter
...
namespace Makina_Ikmal.ModelYeni.izinRaporTableAdapters
{
  ...
  public class DataTable1TableAdapter : Component
  {
    ...
    public virtual int Fill(izinRapor.DataTable1DataTable dataTable)
    {
    ...
    public virtual izinRapor.DataTable1DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      izinRapor.DataTable1DataTable data = new izinRapor.DataTable1DataTable();
