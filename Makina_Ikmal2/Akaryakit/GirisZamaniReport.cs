...
// Type: Makina_Ikmal.Akaryakit.GirisZamaniReport
...
{
  public class GirisZamaniReport : XtraReport
  {
    ...
    public GirisZamaniReport() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.xrTable1.SizeF = new SizeF(712.6667f, 281.25f);
      ...
      this.xrTableCell1.Text = "ARAÇ - GİRİŞ ZAMANI - YAKIT KONTROL KARTI";
      ...
      {
        new ExpressionBinding("BeforePrint", "Text", "?mudurluk")
      });
      ...
      this.xrLabel3.LocationFloat = new PointFloat(100f, 38.20832f);
      ...
      this.xrLabel2.LocationFloat = new PointFloat(303.7292f, 10.00001f);
      ...
      this.xrLabel4.LocationFloat = new PointFloat(104.1666f, 67.00001f);
      ...
      this.xrPictureBox2.LocationFloat = new PointFloat(544.7916f, 0.0f);
      ...
      this.ebysSayi.Description = "Parameter1";
      ...
      this.birimAD.Description = "Parameter1";
      ...
      this.Margins = new Margins(49, 50, 36, 100);
