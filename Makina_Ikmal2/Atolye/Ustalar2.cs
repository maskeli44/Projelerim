...
// Type: Makina_Ikmal.Atolye.Ustalar2
...
namespace Makina_Ikmal.Atolye
{
  public class Ustalar2 : XtraForm
  {
    ...
    private void Ustalar2_Load(object sender, EventArgs e)
    {
      ...
      this.searchLookUpEdit3.Properties.DataSource = (object) this.db.TBLBAKIMGRUBU.ToList<TBLBAKIMGRUBU>();
    ...
    private void simpleButton1_Click(object sender, EventArgs e)
    {
      ...
      EkleFormu ekleFormu = new EkleFormu();
      ((EkleFormu) Application.OpenForms["EkleFormu"])?.tetikle();
    ...
    private void searchLookUpEdit3_EditValueChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        TBLBAKIMTANIM tblbakimtanim = this.db.TBLBAKIMTANIM.FirstOrDefault<TBLBAKIMTANIM>((Expression<System.Func<TBLBAKIMTANIM, bool>>) (x => x.BAKIMGRUBUID == (int?) id));
        if (tblbakimtanim.YAPILANBAKIM == null)
          return;
        this.textEdit1.Text = tblbakimtanim.YAPILANBAKIM;
      }
      catch (Exception ex)
      {
      }
