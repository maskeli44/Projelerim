...
// Type: Makina_Ikmal.Atolye.isemirDetay
...
{
  public class isemirDetay : XtraForm
  {
    ...
    public isemirDetay() => this.InitializeComponent();
    ...
    private void isemirDetay_Load(object sender, EventArgs e)
    {
      ...
      this.dataTable2TableAdapter.Fill(this.isemirmalzeme.DataTable2, new int?(YetkiClass.secim_id));
    ...
    private void InitializeComponent()
    {
      ...
      this.gridControl1.Size = new Size(1196, 281);
      ...
      this.gridControl2.DataSource = (object) this.dataTable2BindingSource;
      this.gridControl2.Dock = DockStyle.Fill;
      this.gridControl2.EmbeddedNavigator.Margin = new Padding(3, 2, 3, 2);
      this.gridControl2.Location = new Point(0, 281);
      ...
      this.gridControl2.Size = new Size(1196, 574);
      ...
      this.gridView2.CustomDrawRowIndicator += new RowIndicatorCustomDrawEventHandler(this.gridView2_CustomDrawRowIndicator);
      this.gridView2.CustomColumnDisplayText += new CustomColumnDisplayTextEventHandler(this.gridView2_CustomColumnDisplayText);
      ...
      this.colMALZEMEADI.ColumnEdit = (RepositoryItem) this.mal;
      ...
      this.colBIRIMADI.ColumnEdit = (RepositoryItem) this.birim;
      ...
      this.ClientSize = new Size(1196, 855);
      this.Controls.Add((Control) this.gridControl2);
      this.Controls.Add((Control) this.gridControl1);
      this.Margin = new Padding(3, 2, 3, 2);
      this.Name = nameof (isemirDetay);
