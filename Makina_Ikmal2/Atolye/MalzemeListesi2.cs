...
// Type: Makina_Ikmal.Atolye.MalzemeListesi2
...
{
  public class MalzemeListesi2 : XtraForm
  {
    ...
    public MalzemeListesi2() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MalzemeListesi2));
      ...
      this.colDIGERADI.VisibleIndex = 7;
      ...
      this.colKULLANIMYERI.VisibleIndex = 4;
      ...
      this.Name = nameof (MalzemeListesi2);
