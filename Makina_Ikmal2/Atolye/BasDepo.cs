...
// Type: Makina_Ikmal.Atolye.BasDepo
...
namespace Makina_Ikmal.Atolye
{
  public class BasDepo : XtraForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.accordionControlElement2.Text = "İş Emir Listesi";
      ...
      this.accordionControlElement3.Text = "İş Emri Usta Ekranı";
      this.accordionControlElement3.Click += new EventHandler(this.accordionControlElement3_Click);
      this.accordionControlElement6.ImageOptions.Image = (Image) Resources.home_32x32;
      this.accordionControlElement6.Name = "accordionControlElement6";
      this.accordionControlElement6.Style = ElementStyle.Item;
      this.accordionControlElement6.Text = "Atölyeler";
      ...
      this.accordionControlElement4.Text = "Atölye Ustaları";
      ...
      this.accordionControlElement5.Text = "Bakım Tanımları";
