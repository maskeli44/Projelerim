...
// Type: Makina_Ikmal.Atolye.YagBakim2
...
namespace Makina_Ikmal.Atolye
{
  public class YagBakim2 : XtraReport
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.xrLabel7.LocationFloat = new PointFloat(293.1669f, 435.8341f);
      ...
      this.xrLabel6.LocationFloat = new PointFloat(61.33366f, 435.8341f);
      ...
      this.xrLabel8.LocationFloat = new PointFloat(579.8334f, 435.8341f);
      ...
      this.xrTable129.LocationFloat = new PointFloat(109.6667f, 68.33334f);
      ...
      {
        new ExpressionBinding("BeforePrint", "Text", "[Query_1].[ADI]")
      });
