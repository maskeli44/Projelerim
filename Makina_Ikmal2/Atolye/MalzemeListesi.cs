...
// Type: Makina_Ikmal.Atolye.MalzemeListesi
...
namespace Makina_Ikmal.Atolye
{
  public class MalzemeListesi : XtraForm
  {
    ...
    private void gridControl1_DoubleClick_2(object sender, EventArgs e)
    {
      ...
      ((TalepKayıt) Application.OpenForms["TalepKayıt"])?.liste2();
      ((Makina_Ikmal.Depo.CikisFisEkle) Application.OpenForms["CikisFisEkle"])?.tetikle();
      ((TalepDuzenleme) Application.OpenForms["TalepDuzenleme"])?.tetikle();
      this.Close();
    }
    ...
    private void aramaTxt_ItemPress(object sender, ItemClickEventArgs e)
    {
    }
    ...
    private void barButtonItem21_ItemClick(object sender, ItemClickEventArgs e)
    {
      try
      {
        YetkiClass.yeni_kart_mal = this.aramaTxt.EditValue.ToString();
      }
      catch (Exception ex)
      {
      }
    ...
    private void barCheckItem7_CheckedChanged(object sender, ItemClickEventArgs e) => this.filtreMal();

    private void barCheckItem8_CheckedChanged(object sender, ItemClickEventArgs e) => this.filtreMal();

    private void filtreMal()
    {
    ...
    private string secmeislemi()
    {
      ...
      if (this.barCheckItem7.Checked)
        this.secme += "[KAYITTIPIID] = 1 OR";
      if (this.barCheckItem8.Checked)
        this.secme += "  [KAYITTIPIID] = 2 OR";
      try
      {
    ...
    private void InitializeComponent()
    {
      ...
      this.aramaTxt.ItemPress += new ItemClickEventHandler(this.aramaTxt_ItemPress);
      ...
      this.colDIGERADI.Caption = "Diğer Ad";
      ...
      this.colDIGERADI.VisibleIndex = 10;
      ...
      this.colGRUPID2.VisibleIndex = 8;
      ...
      this.colBOLUMID.FieldName = "KDVID";
      ...
      this.colKAYITTIPIID.Caption = "Kayıt Tipi";
      ...
      this.barButtonItem21.Caption = "Yeni Malzeme Kart";
      this.barButtonItem21.Id = 28;
      this.barButtonItem21.ImageOptions.Image = (Image) Resources.addfile_16x161;
      this.barButtonItem21.ImageOptions.LargeImage = (Image) Resources.addfile_32x321;
      this.barButtonItem21.Name = "barButtonItem21";
      this.barButtonItem21.ItemClick += new ItemClickEventHandler(this.barButtonItem21_ItemClick);
      this.barCheckItem7.Caption = "Mal";
      this.barCheckItem7.CheckBoxVisibility = CheckBoxVisibility.BeforeText;
      this.barCheckItem7.Id = 29;
      ...
      this.barCheckItem8.Caption = "Hizmet";
      ...
      this.ribbonPageGroup3.ItemLinks.Add((BarItem) this.barCheckItem8);
      ...
      this.contextMenuStrip1.Size = new Size(117, 48);
      this.düzenleToolStripMenuItem.Name = "düzenleToolStripMenuItem";
      this.düzenleToolStripMenuItem.Size = new Size(116, 22);
      this.düzenleToolStripMenuItem.Text = "Düzenle";
      this.düzenleToolStripMenuItem.Click += new EventHandler(this.düzenleToolStripMenuItem_Click);
      this.silToolStripMenuItem.Name = "silToolStripMenuItem";
      this.silToolStripMenuItem.Size = new Size(116, 22);
