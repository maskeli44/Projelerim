...
// Type: Makina_Ikmal.Atolye.GunlukTarihRaporu_bakimyeri
...
{
  public class GunlukTarihRaporu_bakimyeri : XtraReport
  {
    ...
    private Makina_Ikmal.Model.ikitarihTableAdapters.DataTable1TableAdapter dataTable1TableAdapter;
    private Parameter kucuk;
    private Parameter buyuk;
    private Makina_Ikmal.Model.isemirmalzemeTableAdapters.DataTable1TableAdapter dataTable1TableAdapter1;

    public GunlukTarihRaporu_bakimyeri() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (GunlukTarihRaporu_bakimyeri));
      ...
      this.dataTable1TableAdapter = new Makina_Ikmal.Model.ikitarihTableAdapters.DataTable1TableAdapter();
      this.kucuk = new Parameter();
      this.buyuk = new Parameter();
      this.dataTable1TableAdapter1 = new Makina_Ikmal.Model.isemirmalzemeTableAdapters.DataTable1TableAdapter();
      ...
      {
        new ExpressionBinding("BeforePrint", "Text", "[BAKIMYERIID]")
      });
      ...
      this.FilterString = componentResourceManager.GetString("$this.FilterString");
