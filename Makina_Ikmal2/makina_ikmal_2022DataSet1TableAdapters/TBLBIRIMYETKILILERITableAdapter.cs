...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLBIRIMYETKILILERITableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLBIRIMYETKILILERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLBIRIMYETKILILERIDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLBIRIMYETKILILERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLBIRIMYETKILILERIDataTable data = new makina_ikmal_2022DataSet1.TBLBIRIMYETKILILERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBIRIMYETKILILERI");
