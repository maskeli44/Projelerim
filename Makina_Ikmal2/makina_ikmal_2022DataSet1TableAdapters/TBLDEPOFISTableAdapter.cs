...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLDEPOFISTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLDEPOFISTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLDEPOFISDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLDEPOFISDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLDEPOFISDataTable data = new makina_ikmal_2022DataSet1.TBLDEPOFISDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLDEPOFIS");
