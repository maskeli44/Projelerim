...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLMALZMARKATableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLMALZMARKATableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLMALZMARKADataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLMALZMARKADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLMALZMARKADataTable data = new makina_ikmal_2022DataSet1.TBLMALZMARKADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZMARKA");
