...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLPERSONELISTIHDAMDURUMTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLPERSONELISTIHDAMDURUMTableAdapter : Component
  {
    ...
    public TBLPERSONELISTIHDAMDURUMTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "TBLPERSONELISTIHDAMDURUM",
        ColumnMappings = {
          {
            "ID",
            "ID"
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLPERSONELISTIHDAMDURUM] WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)))";
      this._adapter.DeleteCommand.CommandType = CommandType.Text;
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_ID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ID", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLPERSONELISTIHDAMDURUM] ([ID], [ADI]) VALUES (@ID, @ADI);\r\nSELECT ID, ADI FROM TBLPERSONELISTIHDAMDURUM WHERE (ID = @ID)";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ID", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLPERSONELISTIHDAMDURUM] SET [ID] = @ID, [ADI] = @ADI WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)));\r\nSELECT ID, ADI FROM TBLPERSONELISTIHDAMDURUM WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ID", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_ID", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ID", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ADI FROM dbo.TBLPERSONELISTIHDAMDURUM";
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLPERSONELISTIHDAMDURUMDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLPERSONELISTIHDAMDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLPERSONELISTIHDAMDURUMDataTable data = new makina_ikmal_2022DataSet1.TBLPERSONELISTIHDAMDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELISTIHDAMDURUM");
