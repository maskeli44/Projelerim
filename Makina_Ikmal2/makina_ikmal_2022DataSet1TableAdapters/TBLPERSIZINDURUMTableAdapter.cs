...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLPERSIZINDURUMTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLPERSIZINDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLPERSIZINDURUMDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLPERSIZINDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLPERSIZINDURUMDataTable data = new makina_ikmal_2022DataSet1.TBLPERSIZINDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSIZINDURUM");
