...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLAYARLARTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLAYARLARTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLAYARLARDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLAYARLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLAYARLARDataTable data = new makina_ikmal_2022DataSet1.TBLAYARLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLAYARLAR");
