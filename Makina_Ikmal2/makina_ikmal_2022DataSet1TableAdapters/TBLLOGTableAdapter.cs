...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLLOGTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLLOGTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLLOGDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLLOGDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLLOGDataTable data = new makina_ikmal_2022DataSet1.TBLLOGDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLLOG");
