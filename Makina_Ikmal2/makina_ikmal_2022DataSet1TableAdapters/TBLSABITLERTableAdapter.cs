...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLSABITLERTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLSABITLERTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLSABITLERDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLSABITLERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLSABITLERDataTable data = new makina_ikmal_2022DataSet1.TBLSABITLERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLSABITLER");
