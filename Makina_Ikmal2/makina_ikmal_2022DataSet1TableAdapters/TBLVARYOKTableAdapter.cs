...
// Type: Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters.TBLVARYOKTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSet1TableAdapters
{
  ...
  public class TBLVARYOKTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet1.TBLVARYOKDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet1.TBLVARYOKDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet1.TBLVARYOKDataTable data = new makina_ikmal_2022DataSet1.TBLVARYOKDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet1 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLVARYOK");
