...
// Type: Makina_Ikmal.YagBolum.YagFiltreBakimBos
...
{
  public class YagFiltreBakimBos : XtraReport
  {
    ...
    public YagFiltreBakimBos() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (YagFiltreBakimBos));
      ...
      this.PageHeader.HeightF = 65.08331f;
      ...
      this.xrLabel3.LocationFloat = new PointFloat(175.8333f, 19.0833f);
      ...
      this.GroupHeader1.Controls.AddRange(new XRControl[120]
      {
      ...
      this.GroupHeader1.HeightF = 502.1667f;
      ...
      this.xrLabel8.LocationFloat = new PointFloat(586.8335f, 460.0008f);
