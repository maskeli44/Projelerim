...
// Type: Makina_Ikmal.insankaynak.PersoneIzin
...
{
  public class PersoneIzin : XtraForm
  {
    private bellEntities db = new bellEntities();
    private BindingList<PersoneIzin.ElemanlarDurum> list = new BindingList<PersoneIzin.ElemanlarDurum>();
    ...
    private SimpleButton izinleriEkleButton;
    ...
    public PersoneIzin() => this.InitializeComponent();
    ...
    private void PersoneIzin_Load(object sender, EventArgs e)
    {
      ...
      this.SubeMudurSluEdit.EditValue = (object) sorumlu.subemuduru;
    ...
    private void Kayit()
    {
      try
      {
        TBLPERSONELIZIN entity1 = new TBLPERSONELIZIN()
        {
          IZINTURU = this.izinTuruComboEdit.Text,
          IZINYILLARI = this.izinYillariTextEdit.Text,
          IZINGUNSAY = this.izinGunSayisiTextEdit.Text,
          PERSID = new int?(Convert.ToInt32(this.personelAdiSluEdit.EditValue)),
          IZINSURESI = this.izinSuresiTextEdit.Text,
          BASLANGICTARIHI = new DateTime?(this.baslangicTarihDateEdit.DateTime),
          BITISTARIHI = new DateTime?(this.bitisTarihDateEdit.DateTime),
          GOREVEBASTARIH = new DateTime?(this.gorevBasDateEdit.DateTime),
          IZINDEBULADRES = this.izinAdresMemoEdit.Text
        };
        entity1.IZINTURU = this.izinTuruComboEdit.Text.ToString();
        if (this.SubeMudurSluEdit.Text != "")
          entity1.SBMUDURID = new int?(Convert.ToInt32(this.SubeMudurSluEdit.EditValue));
        if (this.daireBaskanSluEdit.Text != "")
          entity1.DAIREBSKID = new int?(Convert.ToInt32(this.daireBaskanSluEdit.EditValue));
        if (this.insanKayDBskSluEdit.Text != "")
          entity1.INSANDAIREBSKID = new int?(Convert.ToInt32(this.insanKayDBskSluEdit.EditValue));
        if (this.daireBaskanSluEdit.Text != "")
          entity1.DAIREBSKID = new int?(Convert.ToInt32(this.daireBaskanSluEdit.EditValue));
        if (this.genelSekreterYardSluEdit.Text != "")
          entity1.GENELSEKYRDID = new int?(Convert.ToInt32(this.genelSekreterYardSluEdit.EditValue));
        if (this.muduryerineCombo.Text != "")
          entity1.MUDURYERINE = new int?(Convert.ToInt32(this.muduryerineCombo.EditValue));
        entity1.IZINDURUM = this.izinDurumComboEdit.Text;
        entity1.ONAYTARIH = new DateTime?(this.onayDateEdit.DateTime);
        ...
        {
          this.db.TBLPERSONELIZIN.Add(entity1);
          this.db.SaveChanges();
          YetkiClass.secim_id = int.Parse(this.db.TBLPERSONELIZIN.OrderByDescending<TBLPERSONELIZIN, int>((Expression<System.Func<TBLPERSONELIZIN, int>>) (p => p.ID)).Select<TBLPERSONELIZIN, int>((Expression<System.Func<TBLPERSONELIZIN, int>>) (r => r.ID)).First<int>().ToString());
          TBLPERSIZINDURUM entity2 = new TBLPERSIZINDURUM();
          for (int rowHandle = 0; rowHandle < this.gridView2.DataRowCount; ++rowHandle)
          {
            if (this.gridView2.GetRowCellValue(rowHandle, "istek") != null && Convert.ToInt32(this.gridView2.GetRowCellValue(rowHandle, "istek")) != 0)
            {
              entity2.PERSONELIZINID = new int?(YetkiClass.secim_id);
              entity2.PERSONELID = new int?(Convert.ToInt32(this.personelAdiSluEdit.EditValue));
              entity2.KULLANILANIZIN = new int?(Convert.ToInt32(this.gridView2.GetRowCellValue(rowHandle, "istek")));
              entity2.IZINYILI = new int?(Convert.ToInt32(this.gridView2.GetRowCellValue(rowHandle, "yil")));
              entity2.IZINHAKKI = new int?(0);
              this.db.TBLPERSIZINDURUM.Add(entity2);
              this.db.SaveChanges();
            }
          }
    ...
    private void izinleriEkleButton_Click(object sender, EventArgs e)
    {
      ...
      {
        this.izinYillariTextEdit.Text = "";
        string str = "";
        int tutar = 0;
        int num = 0;
        for (int rowHandle = 0; rowHandle < this.gridView2.DataRowCount; ++rowHandle)
        {
          if (Convert.ToInt32(this.gridView2.GetRowCellValue(rowHandle, "istek")) != 0 && this.gridView2.GetRowCellValue(rowHandle, "istek") != null)
          {
            str = str + this.gridView2.GetRowCellValue(rowHandle, "yil").ToString() + ",";
            tutar += Convert.ToInt32(this.gridView2.GetRowCellValue(rowHandle, "istek"));
            ++num;
          }
        }
        try
        {
          this.izinYillariTextEdit.Text = str.Substring(0, str.Length - 1);
        }
        catch (Exception ex)
        {
        }
        this.izinGunSayisiTextEdit.Text = tutar.ToString();
        if (num == 1)
          this.izinSuresiTextEdit.Text = "Yılından " + tutar.ToString() + " " + this.kul.sayitoyazi(tutar);
        else
          this.izinSuresiTextEdit.Text = "Yıllarından " + tutar.ToString() + " " + this.kul.sayitoyazi(tutar);
      }
      else
      {
        int num1 = (int) XtraMessageBox.Show("Eklenecek izin listesi yok ");
      }
    }
    ...
    private void searchLookUpEdit1View_CellValueChanged(object sender, CellValueChangedEventArgs e)
    {
      ...
      foreach (var data in source.Select(selector))
      {
        ...
        if (num2 > 0)
          this.list.Add(new PersoneIzin.ElemanlarDurum()
          {
      ...
      this.gridControl1.DataSource = (object) this.list.ToList<PersoneIzin.ElemanlarDurum>();
    }
    ...
    {
      if (this.izinTuruComboEdit.Text == "Yıllık")
      {
        int num1 = 0;
        this.list.Clear();
        this.izinYillariTextEdit.Enabled = false;
        this.izinSuresiTextEdit.Enabled = false;
        this.izinGunSayisiTextEdit.Enabled = false;
        int deger = Convert.ToInt32(this.personelAdiSluEdit.EditValue);
        IQueryable<IGrouping<int?, TBLPERSIZINDURUM>> source = this.db.TBLPERSIZINDURUM.Where<TBLPERSIZINDURUM>((Expression<System.Func<TBLPERSIZINDURUM, bool>>) (hd => hd.PERSONELID == (int?) deger)).GroupBy<TBLPERSIZINDURUM, int?>((Expression<System.Func<TBLPERSIZINDURUM, int?>>) (hd => hd.IZINYILI));
        Expression<System.Func<IGrouping<int?, TBLPERSIZINDURUM>, \u003C\u003Ef__AnonymousType47<int?, int?, int?, int?>>> selector = g => new
        {
      ...
      else
      {
        ...
        this.izinYillariTextEdit.Enabled = true;
        this.izinSuresiTextEdit.Enabled = true;
        this.izinGunSayisiTextEdit.Enabled = true;
      }
    }

    private void gridView2_CellValueChanged(object sender, CellValueChangedEventArgs e)
    {
      if (Convert.ToInt32(this.gridView2.GetFocusedRowCellValue("kalan")) >= Convert.ToInt32(this.gridView2.GetFocusedRowCellValue("istek")))
        return;
      int num = (int) XtraMessageBox.Show("İstenilen izin sayısı kalan izini geçemez");
      this.gridView2.SetFocusedRowCellValue("istek", (object) 0);
    }
    ...
    private void YazdirButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      if (this.radioButton2.Checked)
      {
        mudurizin mudurizin = new mudurizin();
        mudurizin.Parameters["id"].Value = (object) YetkiClass.secim_id;
        mudurizin.Parameters["id"].Visible = false;
        new ReportPrintTool((IReport) mudurizin).ShowPreviewDialog();
      }
      else
      {
        if (!this.radioButton1.Checked)
    ...
    {
      int per_id = Convert.ToInt32(this.personelAdiSluEdit.EditValue);
      DbSet<TBLPERSIZINDURUM> tblpersizindurum1 = this.db.TBLPERSIZINDURUM;
      Expression<System.Func<TBLPERSIZINDURUM, bool>> predicate = (Expression<System.Func<TBLPERSIZINDURUM, bool>>) (x => x.PERSONELIZINID == (int?) YetkiClass.secim_id && x.PERSONELID == (int?) per_id);
      foreach (TBLPERSIZINDURUM tblpersizindurum2 in (IEnumerable<TBLPERSIZINDURUM>) tblpersizindurum1.Where<TBLPERSIZINDURUM>(predicate))
      {
        TBLPERSIZINDURUM item2 = tblpersizindurum2;
        this.db.TBLPERSIZINDURUM.FirstOrDefault<TBLPERSIZINDURUM>((Expression<System.Func<TBLPERSIZINDURUM, bool>>) (x => x.ID == item2.ID)).KULLANILANIZIN = new int?(0);
        this.db.SaveChanges();
      }
    ...
    {
      string str = "";
      return this.baslangicTarihDateEdit.Text != "" && this.bitisTarihDateEdit.Text != "" ? new KullaniciSonId().sayitoyazi((b - a).Days) : str;
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (PersoneIzin));
      ...
      this.istek = new GridColumn();
      this.izinleriEkleButton = new SimpleButton();
      ...
      this.ribbonControl1.Size = new Size(959, 100);
      ...
      this.layoutControl1.Controls.Add((Control) this.izinleriEkleButton);
      ...
      this.layoutControl1.Size = new Size(959, 631);
      this.layoutControl1.TabIndex = 1;
      this.layoutControl1.Text = "layoutControl1";
      this.muduryerineCombo.EditValue = (object) "";
      this.muduryerineCombo.Location = new Point(147, 597);
      ...
      this.muduryerineCombo.Size = new Size(353, 24);
      ...
      this.labelControl1.Location = new Point(504, 10);
      this.labelControl1.Margin = new Padding(3, 2, 3, 2);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(444, 34);
      this.labelControl1.StyleController = (IStyleController) this.layoutControl1;
      this.labelControl1.TabIndex = 32;
      this.labelControl1.Text = "İzin Yılları";
      this.labelControl1.ToolTipIconType = ToolTipIconType.Exclamation;
      this.gridControl1.EmbeddedNavigator.Margin = new Padding(3, 2, 3, 2);
      this.gridControl1.Location = new Point(504, 48);
      this.gridControl1.MainView = (BaseView) this.gridView2;
      this.gridControl1.Margin = new Padding(3, 2, 3, 2);
      this.gridControl1.MenuManager = (IDXMenuManager) this.ribbonControl1;
      this.gridControl1.Name = "gridControl1";
      this.gridControl1.Size = new Size(444, 547);
      ...
      this.yil.Caption = "Yıl";
      this.yil.FieldName = "yil";
      this.yil.MinWidth = 21;
      this.yil.Name = "yil";
      this.yil.OptionsColumn.AllowEdit = false;
      this.yil.OptionsColumn.ReadOnly = true;
      this.yil.Visible = true;
      this.yil.VisibleIndex = 0;
      this.yil.Width = 81;
      this.kalan.Caption = "Kalan İzin";
      this.kalan.FieldName = "kalan";
      this.kalan.MinWidth = 21;
      this.kalan.Name = "kalan";
      this.kalan.OptionsColumn.AllowEdit = false;
      this.kalan.OptionsColumn.ReadOnly = true;
      this.kalan.Visible = true;
      this.kalan.VisibleIndex = 1;
      this.kalan.Width = 81;
      this.istek.Caption = "İstenen İzin";
      this.istek.FieldName = "istek";
      this.istek.MinWidth = 21;
      this.istek.Name = "istek";
      this.istek.Summary.AddRange(new GridSummaryItem[1]
      {
        (GridSummaryItem) new GridColumnSummaryItem(SummaryItemType.Sum, "istek", "={0:0.##}")
      });
      this.istek.Visible = true;
      this.istek.VisibleIndex = 2;
      this.istek.Width = 81;
      this.izinleriEkleButton.ImageOptions.ImageToTextAlignment = ImageAlignToText.LeftCenter;
      this.izinleriEkleButton.Location = new Point(504, 599);
      this.izinleriEkleButton.Name = "izinleriEkleButton";
      this.izinleriEkleButton.Size = new Size(444, 22);
      this.izinleriEkleButton.StyleController = (IStyleController) this.layoutControl1;
      this.izinleriEkleButton.TabIndex = 29;
      this.izinleriEkleButton.Text = "İzinleri Ekle";
      this.izinleriEkleButton.Click += new EventHandler(this.izinleriEkleButton_Click);
      this.layoutControl6.Location = new Point(305, 206);
      this.layoutControl6.Name = "layoutControl6";
      this.layoutControl6.Root = this.layoutControlGroup5;
      this.layoutControl6.Size = new Size(195, 24);
      ...
      this.layoutControlGroup5.Size = new Size(195, 24);
      this.layoutControlGroup5.TextVisible = false;
      this.layoutControl5.Location = new Point(305, 178);
      this.layoutControl5.Name = "layoutControl5";
      this.layoutControl5.Root = this.layoutControlGroup4;
      this.layoutControl5.Size = new Size(195, 24);
      ...
      this.layoutControlGroup4.Size = new Size(195, 24);
      this.layoutControlGroup4.TextVisible = false;
      this.layoutControl4.Location = new Point(305, 150);
      this.layoutControl4.Name = "layoutControl4";
      this.layoutControl4.Root = this.layoutControlGroup3;
      this.layoutControl4.Size = new Size(195, 24);
      ...
      this.layoutControlGroup3.Size = new Size(195, 24);
      this.layoutControlGroup3.TextVisible = false;
      this.layoutControl3.Location = new Point(305, 122);
      this.layoutControl3.Name = "layoutControl3";
      this.layoutControl3.Root = this.layoutControlGroup2;
      this.layoutControl3.Size = new Size(195, 24);
      ...
      this.layoutControlGroup2.Size = new Size(195, 24);
      this.layoutControlGroup2.TextVisible = false;
      this.layoutControl2.Location = new Point(314, 38);
      this.layoutControl2.Name = "layoutControl2";
      this.layoutControl2.Root = this.layoutControlGroup1;
      this.layoutControl2.Size = new Size(186, 24);
      this.layoutControl2.TabIndex = 24;
      this.layoutControl2.Text = "layoutControl2";
      this.layoutControlGroup1.EnableIndentsWithoutBorders = DefaultBoolean.True;
      this.layoutControlGroup1.GroupBordersVisible = false;
      this.layoutControlGroup1.Name = "layoutControlGroup1";
      this.layoutControlGroup1.Size = new Size(186, 24);
      this.layoutControlGroup1.TextVisible = false;
      this.gorevBasDateEdit.EditValue = (object) null;
      this.gorevBasDateEdit.Location = new Point(147, 206);
      ...
      this.gorevBasDateEdit.Size = new Size(154, 24);
      ...
      this.genelSekreterYardSluEdit.Location = new Point(147, 569);
      ...
      this.genelSekreterYardSluEdit.Size = new Size(353, 24);
      ...
      this.gridColumn6.Caption = "Adı Soyadı";
      ...
      this.insanKayDBskSluEdit.Location = new Point(147, 541);
      ...
      this.insanKayDBskSluEdit.Size = new Size(353, 24);
      ...
      this.daireBaskanSluEdit.Location = new Point(147, 513);
      ...
      this.daireBaskanSluEdit.Size = new Size(353, 24);
      ...
      this.izinDurumComboEdit.Location = new Point(435, 457);
      ...
      this.izinDurumComboEdit.Size = new Size(65, 24);
      ...
      this.onayDateEdit.Location = new Point(147, 457);
      ...
      this.izinAdresMemoEdit.Size = new Size(353, 219);
      ...
      this.izinGunSayisiTextEdit.Location = new Point(147, 178);
      ...
      this.izinGunSayisiTextEdit.Size = new Size(154, 24);
      ...
      this.bitisTarihDateEdit.Location = new Point(147, 150);
      ...
      this.bitisTarihDateEdit.Size = new Size(154, 24);
      ...
      this.baslangicTarihDateEdit.Location = new Point(147, 122);
      ...
      this.baslangicTarihDateEdit.Size = new Size(154, 24);
      ...
      this.personelAdiSluEdit.Location = new Point(147, 10);
      ...
      this.personelAdiSluEdit.Size = new Size(353, 24);
      ...
      this.izinSuresiTextEdit.Location = new Point(147, 94);
      ...
      this.izinTuruComboEdit.Size = new Size(163, 24);
      ...
      this.SubeMudurSluEdit.Location = new Point(147, 485);
      ...
      this.SubeMudurSluEdit.Size = new Size(353, 24);
      ...
      this.Root.Size = new Size(959, 631);
      ...
      this.layoutControlItem2.Size = new Size(303, 28);
      ...
      this.layoutControlItem3.Size = new Size(493, 28);
      ...
      this.layoutControlItem4.Size = new Size(493, 28);
      ...
      this.layoutControlItem1.Size = new Size(493, 28);
      ...
      this.layoutControlItem5.Size = new Size(294, 28);
      ...
      this.layoutControlItem6.Size = new Size(294, 28);
      ...
      this.layoutControlItem12.Location = new Point(288, 447);
      this.layoutControlItem12.Name = "layoutControlItem12";
      this.layoutControlItem12.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem12.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem12.Size = new Size(205, 28);
      ...
      this.layoutControlItem13.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem13.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem13.Size = new Size(493, 28);
      ...
      this.layoutControlItem14.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem14.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem14.Size = new Size(493, 28);
      ...
      this.layoutControlItem15.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem15.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem15.Size = new Size(493, 28);
      ...
      this.layoutControlItem7.Size = new Size(294, 28);
      ...
      this.layoutControlItem8.Size = new Size(294, 28);
      ...
      this.layoutControlItem10.Size = new Size(493, 223);
      ...
      this.layoutControlItem11.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem11.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem11.Size = new Size(288, 28);
      ...
      this.layoutControlItem9.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.layoutControlItem9.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.layoutControlItem9.Size = new Size(493, 28);
      ...
      this.layoutControlItem19.Location = new Point(303, 28);
      this.layoutControlItem19.Name = "layoutControlItem19";
      this.layoutControlItem19.Size = new Size(190, 28);
      this.layoutControlItem19.TextSize = new Size(0, 0);
      this.layoutControlItem19.TextVisible = false;
      this.layoutControlItem20.Control = (Control) this.layoutControl3;
      this.layoutControlItem20.Location = new Point(294, 112);
      this.layoutControlItem20.Name = "layoutControlItem20";
      this.layoutControlItem20.Size = new Size(199, 28);
      this.layoutControlItem20.TextSize = new Size(0, 0);
      this.layoutControlItem20.TextVisible = false;
      this.layoutControlItem21.Control = (Control) this.layoutControl4;
      this.layoutControlItem21.Location = new Point(294, 140);
      this.layoutControlItem21.Name = "layoutControlItem21";
      this.layoutControlItem21.Size = new Size(199, 28);
      this.layoutControlItem21.TextSize = new Size(0, 0);
      this.layoutControlItem21.TextVisible = false;
      this.layoutControlItem22.Control = (Control) this.layoutControl5;
      this.layoutControlItem22.Location = new Point(294, 168);
      this.layoutControlItem22.Name = "layoutControlItem22";
      this.layoutControlItem22.Size = new Size(199, 28);
      this.layoutControlItem22.TextSize = new Size(0, 0);
      this.layoutControlItem22.TextVisible = false;
      this.layoutControlItem23.Control = (Control) this.layoutControl6;
      this.layoutControlItem23.Location = new Point(294, 196);
      this.layoutControlItem23.Name = "layoutControlItem23";
      this.layoutControlItem23.Size = new Size(199, 28);
      this.layoutControlItem23.TextSize = new Size(0, 0);
      this.layoutControlItem23.TextVisible = false;
      this.layoutControlItem24.Control = (Control) this.izinleriEkleButton;
      this.layoutControlItem24.Location = new Point(493, 589);
      this.layoutControlItem24.Name = "layoutControlItem24";
      this.layoutControlItem24.Size = new Size(448, 26);
      this.layoutControlItem24.TextSize = new Size(0, 0);
      this.layoutControlItem24.TextVisible = false;
      this.layoutControlItem25.Control = (Control) this.gridControl1;
      this.layoutControlItem25.Location = new Point(493, 38);
      this.layoutControlItem25.Name = "layoutControlItem25";
      this.layoutControlItem25.Size = new Size(448, 551);
      this.layoutControlItem25.TextSize = new Size(0, 0);
      this.layoutControlItem25.TextVisible = false;
      this.layoutControlItem26.Control = (Control) this.labelControl1;
      this.layoutControlItem26.Location = new Point(493, 0);
      this.layoutControlItem26.MinSize = new Size(68, 16);
      this.layoutControlItem26.Name = "layoutControlItem26";
      this.layoutControlItem26.Size = new Size(448, 38);
      ...
      this.asdasda.OptionsPrint.AppearanceItem.ForeColor = Color.Black;
      this.asdasda.OptionsPrint.AppearanceItem.Options.UseFont = true;
      this.asdasda.OptionsPrint.AppearanceItem.Options.UseForeColor = true;
      this.asdasda.Size = new Size(493, 28);
      ...
      this.ClientSize = new Size(959, 731);
