...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLMALZGRUPTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLMALZGRUPTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLMALZGRUPDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLMALZGRUPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLMALZGRUPDataTable data = new makina_ikmal_2022DataSet.TBLMALZGRUPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZGRUP");
