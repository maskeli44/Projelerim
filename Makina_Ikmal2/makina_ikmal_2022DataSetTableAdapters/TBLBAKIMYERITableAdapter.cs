...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLBAKIMYERITableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLBAKIMYERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLBAKIMYERIDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLBAKIMYERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLBAKIMYERIDataTable data = new makina_ikmal_2022DataSet.TBLBAKIMYERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBAKIMYERI");
