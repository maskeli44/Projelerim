...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLIDARISARTNAMETableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLIDARISARTNAMETableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLIDARISARTNAMEDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLIDARISARTNAMEDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLIDARISARTNAMEDataTable data = new makina_ikmal_2022DataSet.TBLIDARISARTNAMEDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIDARISARTNAME");
