...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLIHALELERTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLIHALELERTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLIHALELERDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLIHALELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLIHALELERDataTable data = new makina_ikmal_2022DataSet.TBLIHALELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIHALELER");
