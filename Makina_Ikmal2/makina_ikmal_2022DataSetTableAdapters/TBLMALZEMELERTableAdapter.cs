...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLMALZEMELERTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLMALZEMELERTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLMALZEMELERDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLMALZEMELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLMALZEMELERDataTable data = new makina_ikmal_2022DataSet.TBLMALZEMELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZEMELER");
