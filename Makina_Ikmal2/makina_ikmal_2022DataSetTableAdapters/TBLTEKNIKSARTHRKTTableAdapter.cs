...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLTEKNIKSARTHRKTTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLTEKNIKSARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLTEKNIKSARTHRKTDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLTEKNIKSARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLTEKNIKSARTHRKTDataTable data = new makina_ikmal_2022DataSet.TBLTEKNIKSARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTEKNIKSARTHRKT");
