...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLARACTRFCEZATableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLARACTRFCEZATableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLARACTRFCEZADataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLARACTRFCEZADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLARACTRFCEZADataTable data = new makina_ikmal_2022DataSet.TBLARACTRFCEZADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACTRFCEZA");
