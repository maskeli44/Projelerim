...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLPERSONELISTIHDAMDURUMTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLPERSONELISTIHDAMDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLPERSONELISTIHDAMDURUMDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLPERSONELISTIHDAMDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLPERSONELISTIHDAMDURUMDataTable data = new makina_ikmal_2022DataSet.TBLPERSONELISTIHDAMDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELISTIHDAMDURUM");
