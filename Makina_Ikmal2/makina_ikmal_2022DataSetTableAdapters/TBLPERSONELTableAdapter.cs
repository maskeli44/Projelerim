...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLPERSONELTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLPERSONELTableAdapter : Component
  {
    ...
    public virtual int Fill(
      makina_ikmal_2022DataSet.TBLPERSONELDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLPERSONELDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLPERSONELDataTable data = new makina_ikmal_2022DataSet.TBLPERSONELDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONEL");
