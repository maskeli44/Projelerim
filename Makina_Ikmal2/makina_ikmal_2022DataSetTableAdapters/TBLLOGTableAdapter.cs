...
// Type: Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters.TBLLOGTableAdapter
...
namespace Makina_Ikmal.makina_ikmal_2022DataSetTableAdapters
{
  ...
  public class TBLLOGTableAdapter : Component
  {
    ...
    public virtual int Fill(makina_ikmal_2022DataSet.TBLLOGDataTable dataTable)
    {
    ...
    public virtual makina_ikmal_2022DataSet.TBLLOGDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      makina_ikmal_2022DataSet.TBLLOGDataTable data = new makina_ikmal_2022DataSet.TBLLOGDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet.TBLLOGDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(makina_ikmal_2022DataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLLOG");
