...
// Type: Makina_Ikmal.SatinAlma.TeklifRaporlari.TeklifTekCokArac
...
{
  public class TeklifTekCokArac : XtraReport
  {
    ...
    public TeklifTekCokArac() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (TeklifTekCokArac));
      ...
      this.TopMargin.HeightF = 145.5417f;
      ...
      this.table1.LocationFloat = new PointFloat(565.4675f, 120.5417f);
      ...
      this.xrLabel1.LocationFloat = new PointFloat(220.5895f, 120.5417f);
      ...
      {
        new ExpressionBinding("BeforePrint", "Text", "[MALZEMEADI]+' '+[MALZACIKLAMA]+' '+[ARACACIKLAMA]+' '+[PLAKA]")
      });
      ...
      this.Margins = new Margins(47, 0, 146, 14);
