...
// Type: Makina_Ikmal.SatinAlma.GirisSayfasi
...
namespace Makina_Ikmal.SatinAlma
{
  public class GirisSayfasi : XtraForm
  {
    ...
    private void accordionControlElement2_Click(object sender, EventArgs e)
    {
      ...
      this.yet.yetkiislemleri("Talep Listesi");
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        TalepListesi openForm = (TalepListesi) Application.OpenForms["TalepListesi"];
        if (openForm != null)
        {
          openForm.Focus();
          openForm.listele();
        ...
        {
          TalepListesi talepListesi = new TalepListesi();
          talepListesi.MdiParent = (Form) this;
          talepListesi.Text = "Talep Listesi";
          talepListesi.listele();
          talepListesi.Show();
        }
      }
      else
    ...
    {
      this.textEdit1.Text = "Sayın " + YetkiClass.kullanici_ad;
      this.yet.yetkiislemleri("Teklif Listesi");
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        TeklifListesi openForm = (TeklifListesi) Application.OpenForms["TeklifListesi"];
        if (openForm != null)
        {
          openForm.Focus();
          openForm.Listele();
        ...
        {
          TeklifListesi teklifListesi = new TeklifListesi();
          teklifListesi.MdiParent = (Form) this;
          teklifListesi.Text = "Teklif Listesi";
          teklifListesi.Listele();
          teklifListesi.Show();
        }
      }
      else
    ...
    private void BasDepo_Load(object sender, EventArgs e)
    {
      ...
      this.textEdit1.Text = "Sayın " + YetkiClass.kullanici_ad;
      this.yet.yetkiislemleri("SATIN ALMA");
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        TalepListesi talepListesi = new TalepListesi();
        talepListesi.MdiParent = (Form) this;
    ...
    {
      this.textEdit1.Text = "Sayın " + YetkiClass.kullanici_ad;
      this.yet.yetkiislemleri("Firma Listesi");
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        FirmaListesi openForm = (FirmaListesi) Application.OpenForms["FirmaListesi"];
        if (openForm != null)
        {
          openForm.Focus();
          openForm.Yenile();
        ...
        {
          FirmaListesi firmaListesi = new FirmaListesi();
          firmaListesi.MdiParent = (Form) this;
          firmaListesi.Text = "Firma Listesi";
          firmaListesi.Yenile();
          firmaListesi.Show();
        }
      }
    ...
    private void accordionControlElement4_Click(object sender, EventArgs e)
    {
      ...
      {
        talepFisListesi openForm = (talepFisListesi) Application.OpenForms["talepFisListesi"];
        if (openForm != null)
        {
          openForm.Focus();
          openForm.listele();
    ...
    private void InitializeComponent()
    {
      ...
      this.accordionControlElement2.Text = "Talep Listesi";
      ...
      this.accordionControlElement3.Text = "Teklif Listesi";
      ...
      this.accordionControlElement6.Text = "Firma Listesi";
      ...
      this.accordionControlElement4.Text = "Talep Fişleri";
