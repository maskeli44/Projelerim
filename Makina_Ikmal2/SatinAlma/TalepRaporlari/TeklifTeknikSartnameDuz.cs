...
// Type: Makina_Ikmal.SatinAlma.TalepRaporlari.TeklifTeknikSartnameDuz
...
namespace Makina_Ikmal.SatinAlma.TalepRaporlari
{
  public class TeklifTeknikSartnameDuz : XtraReport
  {
    ...
    private void InitializeComponent()
    {
      ...
      table2.MetaSerializable = "<Meta X=\"185\" Y=\"30\" Width=\"125\" Height=\"685\" />";
      ...
      this.BottomMargin.HeightF = 6.250025f;
      this.BottomMargin.Name = "BottomMargin";
      this.Detail.Controls.AddRange(new XRControl[1]
      {
        (XRControl) this.xrTable2
      });
      this.Detail.HeightF = 19.16662f;
      this.Detail.Name = "Detail";
      this.xrTable2.LocationFloat = new PointFloat(0.0f, 1.666667f);
      ...
      this.xrTable2.SizeF = new SizeF(709.3335f, 15.41664f);
      ...
      this.GroupHeader1.HeightF = 40.41669f;
      this.GroupHeader1.Name = "GroupHeader1";
      this.xrLabel6.Font = new Font("Arial", 12f, FontStyle.Bold);
      this.xrLabel6.LocationFloat = new PointFloat(211.6667f, 10.00001f);
      this.xrLabel6.Multiline = true;
      this.xrLabel6.Name = "xrLabel6";
      this.xrLabel6.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
      this.xrLabel6.SizeF = new SizeF(192.9166f, 23f);
      ...
      this.xrLabel5.LocationFloat = new PointFloat(404.5834f, 10.00001f);
      this.xrLabel5.Multiline = true;
      this.xrLabel5.Name = "xrLabel5";
      this.xrLabel5.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
      this.xrLabel5.SizeF = new SizeF(260.8333f, 23f);
      ...
      this.Margins = new Margins(72, 48, 100, 6);
