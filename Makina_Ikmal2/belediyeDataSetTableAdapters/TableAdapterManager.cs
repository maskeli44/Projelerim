...
// Type: Makina_Ikmal.belediyeDataSetTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.belediyeDataSetTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(belediyeDataSet dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLISEMRITableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(belediyeDataSet dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLISEMRITableAdapter != null)
      {
