...
// Type: Makina_Ikmal.izinHakDuzenlemeTableAdapters.TBLPERSIZINDURUMTableAdapter
...
namespace Makina_Ikmal.izinHakDuzenlemeTableAdapters
{
  ...
  public class TBLPERSIZINDURUMTableAdapter : Component
  {
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [TBLPERSIZINDURUM] ([PERSONELID], [PERSONELIZINID], [IZINYILI], [IZINHAKKI], [KULLANILANIZIN]) VALUES (@PERSONELID, @PERSONELIZINID, @IZINYILI, @IZINHAKKI, @KULLANILANIZIN);\r\nSELECT ID, PERSONELID, PERSONELIZINID, IZINYILI, IZINHAKKI, KULLANILANIZIN FROM TBLPERSIZINDURUM WHERE (ID = SCOPE_IDENTITY())";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, PERSONELID, PERSONELIZINID, IZINYILI, IZINHAKKI, KULLANILANIZIN\r\nFROM     TBLPERSIZINDURUM\r\nWHERE  (PERSONELID = @per_id)";
      this._commandCollection[0].CommandType = CommandType.Text;
      this._commandCollection[0].Parameters.Add(new SqlParameter("@per_id", SqlDbType.Int, 4, ParameterDirection.Input, (byte) 0, (byte) 0, "PERSONELID", DataRowVersion.Current, false, (object) null, "", "", ""));
    }
    ...
    public virtual int Fill(
      izinHakDuzenleme.TBLPERSIZINDURUMDataTable dataTable,
      int? per_id)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (per_id.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) per_id.Value;
      else
    ...
    public virtual izinHakDuzenleme.TBLPERSIZINDURUMDataTable GetData(int? per_id)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (per_id.HasValue)
        this.Adapter.SelectCommand.Parameters[0].Value = (object) per_id.Value;
        ...
        this.Adapter.SelectCommand.Parameters[0].Value = (object) DBNull.Value;
      izinHakDuzenleme.TBLPERSIZINDURUMDataTable data = new izinHakDuzenleme.TBLPERSIZINDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(izinHakDuzenleme dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSIZINDURUM");
