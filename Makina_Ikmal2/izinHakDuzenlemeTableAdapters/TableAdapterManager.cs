...
// Type: Makina_Ikmal.izinHakDuzenlemeTableAdapters.TableAdapterManager
  ...
  public class TableAdapterManager : Component
  {
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._tBLPERSIZINDURUMTableAdapter != null && this._tBLPERSIZINDURUMTableAdapter.Connection != null ? (IDbConnection) this._tBLPERSIZINDURUMTableAdapter.Connection : (IDbConnection) null;
      }
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(izinHakDuzenleme dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tBLPERSIZINDURUMTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(izinHakDuzenleme dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tBLPERSIZINDURUMTableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(izinHakDuzenleme dataSet)
    {
      if (dataSet == null)
