...
// Type: Makina_Ikmal.DepoModel.cikisfishrktMalzemeleri
...
namespace Makina_Ikmal.DepoModel
{
  ...
  [XmlRoot("cikisfishrktMalzemeleri")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class cikisfishrktMalzemeleri : DataSet
  {
    private cikisfishrktMalzemeleri.DataTable1DataTable tableDataTable1;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public cikisfishrktMalzemeleri()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected cikisfishrktMalzemeleri(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new cikisfishrktMalzemeleri.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public cikisfishrktMalzemeleri.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      cikisfishrktMalzemeleri cikisfishrktMalzemeleri = (cikisfishrktMalzemeleri) base.Clone();
      cikisfishrktMalzemeleri.InitVars();
      cikisfishrktMalzemeleri.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) cikisfishrktMalzemeleri;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new cikisfishrktMalzemeleri.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (cikisfishrktMalzemeleri.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (cikisfishrktMalzemeleri);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/cikisfishrktMalzemeleri.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new cikisfishrktMalzemeleri.DataTable1DataTable();
    ...
    {
      cikisfishrktMalzemeleri cikisfishrktMalzemeleri = new cikisfishrktMalzemeleri();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = cikisfishrktMalzemeleri.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = cikisfishrktMalzemeleri.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      cikisfishrktMalzemeleri.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<cikisfishrktMalzemeleri.DataTable1Row>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public cikisfishrktMalzemeleri.DataTable1Row this[int index] => (cikisfishrktMalzemeleri.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event cikisfishrktMalzemeleri.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event cikisfishrktMalzemeleri.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event cikisfishrktMalzemeleri.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event cikisfishrktMalzemeleri.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(cikisfishrktMalzemeleri.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public cikisfishrktMalzemeleri.DataTable1Row AddDataTable1Row(
        string MALZEMEADI,
        string BIRIMADI,
        string DEPOADI,
        string MALZSERINO,
        ...
        Decimal Miktar)
      {
        cikisfishrktMalzemeleri.DataTable1Row row = (cikisfishrktMalzemeleri.DataTable1Row) this.NewRow();
      ...
      {
        cikisfishrktMalzemeleri.DataTable1DataTable dataTable1DataTable = (cikisfishrktMalzemeleri.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new cikisfishrktMalzemeleri.DataTable1DataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public cikisfishrktMalzemeleri.DataTable1Row NewDataTable1Row() => (cikisfishrktMalzemeleri.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new cikisfishrktMalzemeleri.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (cikisfishrktMalzemeleri.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new cikisfishrktMalzemeleri.DataTable1RowChangeEvent((cikisfishrktMalzemeleri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new cikisfishrktMalzemeleri.DataTable1RowChangeEvent((cikisfishrktMalzemeleri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new cikisfishrktMalzemeleri.DataTable1RowChangeEvent((cikisfishrktMalzemeleri.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new cikisfishrktMalzemeleri.DataTable1RowChangeEvent((cikisfishrktMalzemeleri.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(cikisfishrktMalzemeleri.DataTable1Row row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = cikisfishrktMalzemeleri.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (cikisfishrktMalzemeleri.DataTable1DataTable) this.Table;
      }
    ...
    {
      private cikisfishrktMalzemeleri.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(
        cikisfishrktMalzemeleri.DataTable1Row row,
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public cikisfishrktMalzemeleri.DataTable1Row Row => this.eventRow;
