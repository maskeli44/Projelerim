...
// Type: Makina_Ikmal.DepoModel.talepFishrktleri2
...
namespace Makina_Ikmal.DepoModel
{
  ...
  [XmlRoot("talepFishrktleri2")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class talepFishrktleri2 : DataSet
  {
    private talepFishrktleri2.DataTable1DataTable tableDataTable1;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public talepFishrktleri2()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected talepFishrktleri2(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (DataTable1)] != null)
            base.Tables.Add((DataTable) new talepFishrktleri2.DataTable1DataTable(dataSet.Tables[nameof (DataTable1)]));
    ...
    public talepFishrktleri2.DataTable1DataTable DataTable1 => this.tableDataTable1;
    ...
    {
      talepFishrktleri2 talepFishrktleri2 = (talepFishrktleri2) base.Clone();
      talepFishrktleri2.InitVars();
      talepFishrktleri2.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) talepFishrktleri2;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["DataTable1"] != null)
          base.Tables.Add((DataTable) new talepFishrktleri2.DataTable1DataTable(dataSet.Tables["DataTable1"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tableDataTable1 = (talepFishrktleri2.DataTable1DataTable) base.Tables["DataTable1"];
    ...
    {
      this.DataSetName = nameof (talepFishrktleri2);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/talepFishrktleri2.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tableDataTable1 = new talepFishrktleri2.DataTable1DataTable();
    ...
    {
      talepFishrktleri2 talepFishrktleri2 = new talepFishrktleri2();
      XmlSchemaComplexType typedDataSetSchema = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = talepFishrktleri2.Namespace
      });
      typedDataSetSchema.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = talepFishrktleri2.GetSchemaSerializable();
    ...
    public delegate void DataTable1RowChangeEventHandler(
      object sender,
      talepFishrktleri2.DataTable1RowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class DataTable1DataTable : TypedTableBase<talepFishrktleri2.DataTable1Row>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public talepFishrktleri2.DataTable1Row this[int index] => (talepFishrktleri2.DataTable1Row) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event talepFishrktleri2.DataTable1RowChangeEventHandler DataTable1RowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event talepFishrktleri2.DataTable1RowChangeEventHandler DataTable1RowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event talepFishrktleri2.DataTable1RowChangeEventHandler DataTable1RowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event talepFishrktleri2.DataTable1RowChangeEventHandler DataTable1RowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void AddDataTable1Row(talepFishrktleri2.DataTable1Row row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public talepFishrktleri2.DataTable1Row AddDataTable1Row(
        DateTime TARIH,
        string KOD,
        string PLAKA,
        string MALZEMEADI,
        ...
        string BOLUMADI)
      {
        talepFishrktleri2.DataTable1Row row = (talepFishrktleri2.DataTable1Row) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public talepFishrktleri2.DataTable1Row FindByID(int ID) => (talepFishrktleri2.DataTable1Row) this.Rows.Find(new object[1]
      {
        (object) ID
      });
      ...
      {
        talepFishrktleri2.DataTable1DataTable dataTable1DataTable = (talepFishrktleri2.DataTable1DataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new talepFishrktleri2.DataTable1DataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public talepFishrktleri2.DataTable1Row NewDataTable1Row() => (talepFishrktleri2.DataTable1Row) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new talepFishrktleri2.DataTable1Row(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (talepFishrktleri2.DataTable1Row);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanged == null)
          return;
        this.DataTable1RowChanged((object) this, new talepFishrktleri2.DataTable1RowChangeEvent((talepFishrktleri2.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowChanging == null)
          return;
        this.DataTable1RowChanging((object) this, new talepFishrktleri2.DataTable1RowChangeEvent((talepFishrktleri2.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleted == null)
          return;
        this.DataTable1RowDeleted((object) this, new talepFishrktleri2.DataTable1RowChangeEvent((talepFishrktleri2.DataTable1Row) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.DataTable1RowDeleting == null)
          return;
        this.DataTable1RowDeleting((object) this, new talepFishrktleri2.DataTable1RowChangeEvent((talepFishrktleri2.DataTable1Row) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void RemoveDataTable1Row(talepFishrktleri2.DataTable1Row row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = talepFishrktleri2.Namespace
        });
        typedTableSchema.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class DataTable1Row : DataRow
    {
      ...
      internal DataTable1Row(DataRowBuilder rb)
        : base(rb)
      {
        this.tableDataTable1 = (talepFishrktleri2.DataTable1DataTable) this.Table;
      }
    ...
    {
      private talepFishrktleri2.DataTable1Row eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public DataTable1RowChangeEvent(talepFishrktleri2.DataTable1Row row, DataRowAction action)
      {
        this.eventRow = row;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public talepFishrktleri2.DataTable1Row Row => this.eventRow;
