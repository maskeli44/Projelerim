...
// Type: Makina_Ikmal.DepoModel.CikisFisicinGirisfislistesiTableAdapters.TableAdapterManager
...
namespace Makina_Ikmal.DepoModel.CikisFisicinGirisfislistesiTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      CikisFisicinGirisfislistesi dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(CikisFisicinGirisfislistesi dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(CikisFisicinGirisfislistesi dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(CikisFisicinGirisfislistesi dataSet)
    {
      if (dataSet == null)
