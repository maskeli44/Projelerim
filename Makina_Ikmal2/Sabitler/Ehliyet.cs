...
// Type: Makina_Ikmal.Sabitler.Ehliyet
...
{
  public class Ehliyet : RibbonForm
  {
    ...
    private TBLPERSEHLIYETTableAdapter tBLPERSEHLIYETTableAdapter;
    private GridColumn colID;
    private GridColumn colEHLIYET;

    public Ehliyet() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLPERSEHLIYETTableAdapter.Fill(this.bellDataSet5.TBLPERSEHLIYET);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLPERSEHLIYET entity = new TBLPERSEHLIYET();
      entity.EHLIYET = this.egitimBilgisi.Text;
      if (this.db.TBLPERSEHLIYET.Where<TBLPERSEHLIYET>((Expression<System.Func<TBLPERSEHLIYET, bool>>) (hd => hd.EHLIYET == this.egitimBilgisi.Text)).Count<TBLPERSEHLIYET>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLPERSEHLIYET.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLPERSEHLIYETTableAdapter.Fill(this.bellDataSet5.TBLPERSEHLIYET);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("EHLIYET").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLPERSEHLIYET.FirstOrDefault<TBLPERSEHLIYET>((Expression<System.Func<TBLPERSEHLIYET, bool>>) (x => x.ID == YetkiClass.secim_id)).EHLIYET = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Ehliyet));
      ...
      this.colEHLIYET = new GridColumn();
      this.egitimBilgisi = new TextEdit();
      this.labelControl1 = new LabelControl();
      this.tBLPERSEHLIYETTableAdapter = new TBLPERSEHLIYETTableAdapter();
      ...
      this.gridControl1.DataSource = (object) this.tBLPERSEHLIYETBindingSource;
      ...
      this.colEHLIYET.MinWidth = 23;
      this.colEHLIYET.Name = "colEHLIYET";
      this.colEHLIYET.OptionsColumn.AllowEdit = false;
      this.colEHLIYET.OptionsColumn.ReadOnly = true;
      this.colEHLIYET.Visible = true;
      this.colEHLIYET.VisibleIndex = 0;
      this.colEHLIYET.Width = 87;
      ...
      this.labelControl1.Location = new Point(154, 199);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(157, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Ehliyet  Bilgisi";
      ...
      this.Name = nameof (Ehliyet);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = nameof (Ehliyet);
