...
// Type: Makina_Ikmal.Sabitler.AracDurum
...
{
  public class AracDurum : RibbonForm
  {
    ...
    private GridColumn colARACDURUM;

    public AracDurum() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tAHARACDURUMTableAdapter.Fill(this.bellDataSet6.TAHARACDURUM);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TAHARACDURUM entity = new TAHARACDURUM();
      entity.ARACDURUM = this.egitimBilgisi.Text;
      if (this.db.TAHARACDURUM.Where<TAHARACDURUM>((Expression<System.Func<TAHARACDURUM, bool>>) (hd => hd.ARACDURUM == this.egitimBilgisi.Text)).Count<TAHARACDURUM>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TAHARACDURUM.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tAHARACDURUMTableAdapter.Fill(this.bellDataSet6.TAHARACDURUM);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("ARACDURUM").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TAHARACDURUM.FirstOrDefault<TAHARACDURUM>((Expression<System.Func<TAHARACDURUM, bool>>) (x => x.ID == YetkiClass.secim_id)).ARACDURUM = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracDurum));
      ...
      this.colARACDURUM = new GridColumn();
      ...
      this.ribbonPage1.Text = "Araç Durum";
      ...
      this.gridControl1.DataSource = (object) this.tAHARACDURUMBindingSource;
      ...
      this.colID.Width = 87;
      this.colARACDURUM.Caption = "Araç Durumu";
      this.colARACDURUM.FieldName = "ARACDURUM";
      this.colARACDURUM.MinWidth = 23;
      this.colARACDURUM.Name = "colARACDURUM";
      this.colARACDURUM.OptionsColumn.AllowEdit = false;
      this.colARACDURUM.OptionsColumn.ReadOnly = true;
      this.colARACDURUM.Visible = true;
      this.colARACDURUM.VisibleIndex = 0;
      this.colARACDURUM.Width = 87;
      ...
      this.labelControl1.Location = new Point(140, 199);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(153, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Durum Bilgisi";
