...
// Type: Makina_Ikmal.Sabitler.PersonelDurum
...
{
  public class PersonelDurum : RibbonForm
  {
    ...
    private TBLPERSONELDURUMTableAdapter tBLPERSONELDURUMTableAdapter;

    public PersonelDurum() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLPERSONELDURUMTableAdapter.Fill(this.bellDataSet6.TBLPERSONELDURUM);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLPERSONELDURUM entity = new TBLPERSONELDURUM();
      entity.DURUM = this.egitimBilgisi.Text;
      if (this.db.TBLPERSONELDURUM.Where<TBLPERSONELDURUM>((Expression<System.Func<TBLPERSONELDURUM, bool>>) (hd => hd.DURUM == this.egitimBilgisi.Text)).Count<TBLPERSONELDURUM>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLPERSONELDURUM.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    {
      int temp = YetkiClass.secim_id;
      this.db.TBLPERSONELDURUM.FirstOrDefault<TBLPERSONELDURUM>((Expression<System.Func<TBLPERSONELDURUM, bool>>) (x => x.ID == temp)).DURUM = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (PersonelDurum));
      ...
      this.tBLPERSONELDURUMTableAdapter = new TBLPERSONELDURUMTableAdapter();
      ...
      this.gridControl1.DataSource = (object) this.tBLPERSONELDURUMBindingSource;
      ...
      this.tBLPERSONELDURUMBindingSource.DataSource = (object) this.bellDataSet6;
      ...
      this.labelControl1.Location = new Point(146, 199);
      ...
      this.Name = nameof (PersonelDurum);
