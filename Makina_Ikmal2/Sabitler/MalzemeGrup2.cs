...
// Type: Makina_Ikmal.Sabitler.MalzemeGrup2
...
{
  public class MalzemeGrup2 : RibbonForm
  {
    ...
    public MalzemeGrup2() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLMALZGRUP2TableAdapter.Fill(this.bellDataSet7.TBLMALZGRUP2);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLMALZGRUP2 entity = new TBLMALZGRUP2();
      entity.MALZEMEGRUP2 = this.egitimBilgisi.Text;
      if (this.db.TBLMALZGRUP2.Where<TBLMALZGRUP2>((Expression<System.Func<TBLMALZGRUP2, bool>>) (hd => hd.MALZEMEGRUP2 == this.egitimBilgisi.Text)).Count<TBLMALZGRUP2>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLMALZGRUP2.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLMALZGRUP2TableAdapter.Fill(this.bellDataSet7.TBLMALZGRUP2);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("MALZEMEGRUP2").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLMALZGRUP2.FirstOrDefault<TBLMALZGRUP2>((Expression<System.Func<TBLMALZGRUP2, bool>>) (x => x.ID == YetkiClass.secim_id)).MALZEMEGRUP2 = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MalzemeGrup2));
      ...
      this.gridControl1.DataSource = (object) this.tBLMALZGRUP2BindingSource;
      ...
      this.labelControl1.Size = new Size(139, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Malzeme Grup 2";
      ...
      this.Name = nameof (MalzemeGrup2);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = "Malzeme Grup Girişi";
