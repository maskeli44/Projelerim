...
// Type: Makina_Ikmal.Sabitler.ModelYili
...
{
  public class ModelYili : RibbonForm
  {
    ...
    private TAHMODELYILITableAdapter tAHMODELYILITableAdapter;
    private GridColumn colID;
    private GridColumn colYILI;

    public ModelYili() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tAHMODELYILITableAdapter.Fill(this.bellDataSet6.TAHMODELYILI);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TAHMODELYILI entity = new TAHMODELYILI();
      entity.YILI = this.egitimBilgisi.Text;
      if (this.db.TAHMODELYILI.Where<TAHMODELYILI>((Expression<System.Func<TAHMODELYILI, bool>>) (hd => hd.YILI == this.egitimBilgisi.Text)).Count<TAHMODELYILI>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TAHMODELYILI.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tAHMODELYILITableAdapter.Fill(this.bellDataSet6.TAHMODELYILI);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("YILI").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TAHMODELYILI.FirstOrDefault<TAHMODELYILI>((Expression<System.Func<TAHMODELYILI, bool>>) (x => x.ID == YetkiClass.secim_id)).YILI = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ModelYili));
      ...
      this.tAHMODELYILITableAdapter = new TAHMODELYILITableAdapter();
      ...
      this.ribbonPage1.Text = "Model Yılı";
      ...
      this.gridControl1.DataSource = (object) this.tAHMODELYILIBindingSource;
      ...
      this.colID.Width = 87;
      this.colYILI.DisplayFormat.FormatString = "d";
      this.colYILI.DisplayFormat.FormatType = FormatType.DateTime;
      this.colYILI.FieldName = "YILI";
      this.colYILI.MinWidth = 23;
      this.colYILI.Name = "colYILI";
      this.colYILI.OptionsColumn.AllowEdit = false;
      this.colYILI.OptionsColumn.ReadOnly = true;
      this.colYILI.Visible = true;
      this.colYILI.VisibleIndex = 0;
      this.colYILI.Width = 87;
      ...
      this.labelControl1.Size = new Size(149, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Model Bilgisi";
