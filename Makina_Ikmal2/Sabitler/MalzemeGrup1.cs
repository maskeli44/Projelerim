...
// Type: Makina_Ikmal.Sabitler.MalzemeGrup1
...
{
  public class MalzemeGrup1 : RibbonForm
  {
    ...
    public MalzemeGrup1() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLMALZGRUPTableAdapter.Fill(this.bellDataSet7.TBLMALZGRUP);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLMALZGRUP entity = new TBLMALZGRUP();
      entity.MALZEMEGRUP = this.egitimBilgisi.Text;
      if (this.db.TBLMALZGRUP.Where<TBLMALZGRUP>((Expression<System.Func<TBLMALZGRUP, bool>>) (hd => hd.MALZEMEGRUP == this.egitimBilgisi.Text)).Count<TBLMALZGRUP>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLMALZGRUP.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLMALZGRUPTableAdapter.Fill(this.bellDataSet7.TBLMALZGRUP);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("MALZEMEGRUP").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLMALZGRUP.FirstOrDefault<TBLMALZGRUP>((Expression<System.Func<TBLMALZGRUP, bool>>) (x => x.ID == YetkiClass.secim_id)).MALZEMEGRUP = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MalzemeGrup1));
      ...
      this.gridControl1.DataSource = (object) this.tBLMALZGRUPBindingSource;
      ...
      this.labelControl1.Text = "Malzeme Grup 1";
