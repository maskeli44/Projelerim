...
// Type: Makina_Ikmal.Sabitler.GorevUnvan
...
{
  public class GorevUnvan : RibbonForm
  {
    ...
    public GorevUnvan() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLPERSKURUMGOREVTableAdapter.Fill(this.bellDataSet5.TBLPERSKURUMGOREV);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLPERSKURUMGOREV entity = new TBLPERSKURUMGOREV();
      entity.KURUMGOREV = this.egitimBilgisi.Text;
      if (this.db.TBLPERSKURUMGOREV.Where<TBLPERSKURUMGOREV>((Expression<System.Func<TBLPERSKURUMGOREV, bool>>) (hd => hd.KURUMGOREV == this.egitimBilgisi.Text)).Count<TBLPERSKURUMGOREV>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLPERSKURUMGOREV.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLPERSKURUMGOREVTableAdapter.Fill(this.bellDataSet5.TBLPERSKURUMGOREV);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("KURUMGOREV").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLPERSKURUMGOREV.FirstOrDefault<TBLPERSKURUMGOREV>((Expression<System.Func<TBLPERSKURUMGOREV, bool>>) (x => x.ID == YetkiClass.secim_id)).KURUMGOREV = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (GorevUnvan));
      ...
      this.gridControl1.DataSource = (object) this.tBLPERSKURUMGOREVBindingSource;
      ...
      this.colID.Width = 87;
      this.colKURUMGOREV.Caption = "Görev";
      this.colKURUMGOREV.FieldName = "KURUMGOREV";
      this.colKURUMGOREV.MinWidth = 23;
      this.colKURUMGOREV.Name = "colKURUMGOREV";
      this.colKURUMGOREV.OptionsColumn.AllowEdit = false;
      this.colKURUMGOREV.OptionsColumn.ReadOnly = true;
      this.colKURUMGOREV.Visible = true;
      this.colKURUMGOREV.VisibleIndex = 0;
      this.colKURUMGOREV.Width = 87;
      ...
      this.labelControl1.Location = new Point(105, 199);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(206, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Görev Unvan Bilgisi";
      ...
      this.Name = nameof (GorevUnvan);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = "Görev Unvan";
