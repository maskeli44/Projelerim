...
// Type: Makina_Ikmal.Sabitler.Unvan
...
namespace Makina_Ikmal.Sabitler
{
  public class Unvan : RibbonForm
  {
    ...
    public Unvan() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLPERSUNVANTableAdapter.Fill(this.bellDataSet5.TBLPERSUNVAN);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLPERSUNVAN entity = new TBLPERSUNVAN();
      entity.UNVAN = this.egitimBilgisi.Text;
      if (this.db.TBLPERSUNVAN.Where<TBLPERSUNVAN>((Expression<System.Func<TBLPERSUNVAN, bool>>) (hd => hd.UNVAN == this.egitimBilgisi.Text)).Count<TBLPERSUNVAN>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLPERSUNVAN.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLPERSUNVANTableAdapter.Fill(this.bellDataSet5.TBLPERSUNVAN);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("UNVAN").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLPERSUNVAN.FirstOrDefault<TBLPERSUNVAN>((Expression<System.Func<TBLPERSUNVAN, bool>>) (x => x.ID == YetkiClass.secim_id)).UNVAN = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Unvan));
      ...
      this.gridControl1.DataSource = (object) this.tBLPERSUNVANBindingSource;
      ...
      this.labelControl1.Location = new Point(161, 199);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(150, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Unvan Bilgisi";
      ...
      this.Name = nameof (Unvan);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = nameof (Unvan);
