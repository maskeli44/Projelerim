...
// Type: Makina_Ikmal.Sabitler.MalzemeBolum
...
{
  public class MalzemeBolum : RibbonForm
  {
    ...
    public MalzemeBolum() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLMALZBOLUMTableAdapter.Fill(this.bellDataSet7.TBLMALZBOLUM);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLMALZBOLUM entity = new TBLMALZBOLUM();
      entity.BOLUMADI = this.egitimBilgisi.Text;
      if (this.db.TBLMALZBOLUM.Where<TBLMALZBOLUM>((Expression<System.Func<TBLMALZBOLUM, bool>>) (hd => hd.BOLUMADI == this.egitimBilgisi.Text)).Count<TBLMALZBOLUM>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLMALZBOLUM.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLMALZBOLUMTableAdapter.Fill(this.bellDataSet7.TBLMALZBOLUM);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("BOLUMADI").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLMALZBOLUM.FirstOrDefault<TBLMALZBOLUM>((Expression<System.Func<TBLMALZBOLUM, bool>>) (x => x.ID == YetkiClass.secim_id)).BOLUMADI = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MalzemeBolum));
      ...
      this.gridControl1.DataSource = (object) this.tBLMALZBOLUMBindingSource;
      ...
      this.labelControl1.Size = new Size(183, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Yeni Bölüm Adı Bilgisi";
