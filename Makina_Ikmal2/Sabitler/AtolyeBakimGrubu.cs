...
// Type: Makina_Ikmal.Sabitler.AtolyeBakimGrubu
...
{
  public class AtolyeBakimGrubu : RibbonForm
  {
    ...
    public AtolyeBakimGrubu() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLBAKIMGRUBUTableAdapter.Fill(this.bellDataSet7.TBLBAKIMGRUBU);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLBAKIMGRUBU entity = new TBLBAKIMGRUBU();
      entity.GRUPADI = this.egitimBilgisi.Text;
      if (this.db.TBLBAKIMGRUBU.Where<TBLBAKIMGRUBU>((Expression<System.Func<TBLBAKIMGRUBU, bool>>) (hd => hd.GRUPADI == this.egitimBilgisi.Text)).Count<TBLBAKIMGRUBU>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLBAKIMGRUBU.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLBAKIMGRUBUTableAdapter.Fill(this.bellDataSet7.TBLBAKIMGRUBU);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("GRUPADI").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLBAKIMGRUBU.FirstOrDefault<TBLBAKIMGRUBU>((Expression<System.Func<TBLBAKIMGRUBU, bool>>) (x => x.ID == YetkiClass.secim_id)).GRUPADI = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AtolyeBakimGrubu));
      ...
      this.ribbonPage1.Text = "Bakım Grubu";
      ...
      this.gridControl1.DataSource = (object) this.tBLBAKIMGRUBUBindingSource;
      ...
      this.tBLBAKIMGRUBUBindingSource.DataSource = (object) this.bellDataSet7;
      ...
      this.colID.Width = 87;
      this.colGRUPADI.Caption = "Bakım Grup Adı";
      ...
      this.labelControl1.Location = new Point(156, 202);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(109, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Bakım Grubu";
      ...
      this.Name = nameof (AtolyeBakimGrubu);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = "Bakım Grubu";
