...
// Type: Makina_Ikmal.Sabitler.AracKayitMarka
...
{
  public class AracKayitMarka : RibbonForm
  {
    ...
    public AracKayitMarka() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLARACMARKATableAdapter.Fill(this.bellDataSet5.TBLARACMARKA);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLARACMARKA entity = new TBLARACMARKA();
      entity.ARACMARKA = this.egitimBilgisi.Text;
      if (this.db.TBLARACMARKA.Where<TBLARACMARKA>((Expression<System.Func<TBLARACMARKA, bool>>) (hd => hd.ARACMARKA == this.egitimBilgisi.Text)).Count<TBLARACMARKA>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLARACMARKA.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLARACMARKATableAdapter.Fill(this.bellDataSet5.TBLARACMARKA);

    private void gridControl1_Click(object sender, EventArgs e)
    {
      YetkiClass.secim = "guncelle";
      YetkiClass.secim_id = Convert.ToInt32(this.gridView1.GetFocusedRowCellValue("ID"));
      this.egitimBilgisi.Text = this.gridView1.GetFocusedRowCellValue("ARACMARKA").ToString();
    }

    private void egitimSilButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      this.db.TBLARACMARKA.FirstOrDefault<TBLARACMARKA>((Expression<System.Func<TBLARACMARKA, bool>>) (x => x.ID == YetkiClass.secim_id)).ARACMARKA = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracKayitMarka));
      ...
      this.ribbonPage1.Text = "Araç Marka";
      ...
      this.gridControl1.DataSource = (object) this.tBLARACMARKABindingSource;
      ...
      this.colID.Width = 87;
      this.colARACMARKA.Caption = "Araç Marka";
      this.colARACMARKA.FieldName = "ARACMARKA";
      this.colARACMARKA.MinWidth = 23;
      this.colARACMARKA.Name = "colARACMARKA";
      this.colARACMARKA.OptionsColumn.AllowEdit = false;
      this.colARACMARKA.OptionsColumn.ReadOnly = true;
      this.colARACMARKA.Visible = true;
      this.colARACMARKA.VisibleIndex = 0;
      this.colARACMARKA.Width = 87;
      ...
      this.labelControl1.Location = new Point(175, 202);
      this.labelControl1.Margin = new Padding(3, 4, 3, 4);
      this.labelControl1.Name = "labelControl1";
      this.labelControl1.Size = new Size(95, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Araç Marka";
      ...
      this.Name = nameof (AracKayitMarka);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = "Araç Marka Girişi";
