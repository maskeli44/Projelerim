...
// Type: Makina_Ikmal.Sabitler.AracKayitAnaGrup
...
{
  public class AracKayitAnaGrup : RibbonForm
  {
    ...
    public AracKayitAnaGrup() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLARACGRUBUTableAdapter.Fill(this.bellDataSet5.TBLARACGRUBU);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLARACGRUBU entity = new TBLARACGRUBU();
      entity.GRUPADI = this.egitimBilgisi.Text;
      if (this.db.TBLARACGRUBU.Where<TBLARACGRUBU>((Expression<System.Func<TBLARACGRUBU, bool>>) (hd => hd.GRUPADI == this.egitimBilgisi.Text)).Count<TBLARACGRUBU>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLARACGRUBU.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLARACGRUBUTableAdapter.Fill(this.bellDataSet5.TBLARACGRUBU);
    ...
    {
      this.db.TBLARACGRUBU.FirstOrDefault<TBLARACGRUBU>((Expression<System.Func<TBLARACGRUBU, bool>>) (x => x.ID == YetkiClass.secim_id)).GRUPADI = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracKayitAnaGrup));
      ...
      this.gridControl1.DataSource = (object) this.tBLARACGRUBUBindingSource;
      ...
      this.labelControl1.Size = new Size(125, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Araç Ana Grup";
      ...
      this.Name = nameof (AracKayitAnaGrup);
