...
// Type: Makina_Ikmal.Sabitler.AracKayitAltGrup
...
{
  public class AracKayitAltGrup : RibbonForm
  {
    ...
    public AracKayitAltGrup() => this.InitializeComponent();

    private void EgitimDurumu_Load(object sender, EventArgs e) => this.tBLARACGRUBU2TableAdapter.Fill(this.bellDataSet5.TBLARACGRUBU2);

    private void yeniEgitimKaydetButton_ItemClick(object sender, ItemClickEventArgs e)
    {
      TBLARACGRUBU2 entity = new TBLARACGRUBU2();
      entity.GRUPADI = this.egitimBilgisi.Text;
      if (this.db.TBLARACGRUBU2.Where<TBLARACGRUBU2>((Expression<System.Func<TBLARACGRUBU2, bool>>) (hd => hd.GRUPADI == this.egitimBilgisi.Text)).Count<TBLARACGRUBU2>() > 0)
      {
        int num = (int) MessageBox.Show("Aynı kayıt tekrar kayıt edilemez.");
      }
      else
      {
        this.db.TBLARACGRUBU2.Add(entity);
        this.db.SaveChanges();
      }
      this.listele();
    }
    ...
    private void listele() => this.tBLARACGRUBU2TableAdapter.Fill(this.bellDataSet5.TBLARACGRUBU2);
    ...
    {
      this.db.TBLARACGRUBU2.FirstOrDefault<TBLARACGRUBU2>((Expression<System.Func<TBLARACGRUBU2, bool>>) (x => x.ID == YetkiClass.secim_id)).GRUPADI = this.egitimBilgisi.Text;
      this.db.SaveChanges();
      this.listele();
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracKayitAltGrup));
      ...
      this.ribbonPage1.Text = "Araç Grubu";
      ...
      this.gridControl1.DataSource = (object) this.tBLARACGRUBU2BindingSource;
      ...
      this.labelControl1.Size = new Size(112, 24);
      this.labelControl1.TabIndex = 6;
      this.labelControl1.Text = "Araç Alt Grup";
      ...
      this.Name = nameof (AracKayitAltGrup);
      this.Ribbon = this.ribbon;
      this.StatusBar = this.ribbonStatusBar;
      this.Text = "Araç Grup Girişi";
