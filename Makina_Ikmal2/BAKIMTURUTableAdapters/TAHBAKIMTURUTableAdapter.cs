...
// Type: Makina_Ikmal.BAKIMTURUTableAdapters.TAHBAKIMTURUTableAdapter
...
namespace Makina_Ikmal.BAKIMTURUTableAdapters
{
  ...
  public class TAHBAKIMTURUTableAdapter : Component
  {
    ...
    public virtual int Fill(BAKIMTURU.TAHBAKIMTURUDataTable dataTable)
    {
    ...
    public virtual BAKIMTURU.TAHBAKIMTURUDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BAKIMTURU.TAHBAKIMTURUDataTable data = new BAKIMTURU.TAHBAKIMTURUDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BAKIMTURU.TAHBAKIMTURUDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BAKIMTURU dataSet) => this.Adapter.Update((DataSet) dataSet, "TAHBAKIMTURU");
