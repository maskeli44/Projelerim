...
// Type: Makina_Ikmal.Mudurlukk.Basinsan
...
namespace Makina_Ikmal.Mudurlukk
{
  public class Basinsan : XtraForm
  {
    ...
    private void accordionControlElement5_Click(object sender, EventArgs e) => new Makina_Ikmal.Aambar.BasDepo().Show();

    private void accordionControlElement10_Click(object sender, EventArgs e) => new Makina_Ikmal.SatinAlma.GirisSayfasi().Show();
    ...
    {
      AracKullanuımRaporu aracKullanuımRaporu = new AracKullanuımRaporu();
      aracKullanuımRaporu.MdiParent = (Form) this;
      aracKullanuımRaporu.Show();
    }
    ...
    {
      int num = (int) new Anasayfa().ShowDialog();
    }

    private void accordionControlElement11_Click(object sender, EventArgs e) => this.acil();

    public void acil()
    {
      TalepOnay talepOnay = new TalepOnay();
      talepOnay.MdiParent = (Form) this;
      talepOnay.Show();
    }

    private void accordionControlElement12_Click(object sender, EventArgs e)
    {
      LogListele logListele = new LogListele();
      logListele.MdiParent = (Form) this;
      logListele.Show();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.accordionControl1.Elements.AddRange(new AccordionControlElement[14]
      {
