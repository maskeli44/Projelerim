...
// Type: Makina_Ikmal.Mudurlukk.TalepDuzenleme
...
namespace Makina_Ikmal.Mudurlukk
{
  public class TalepDuzenleme : XtraForm
  {
    ...
    private void guncelle()
    {
      try
      {
        ...
        if (this.checkEdit1.Checked)
        {
          ...
          tbltalepfis.MUDONAYZAMAN = new DateTime?(DateTime.Now);
        }
          ...
          if (Convert.ToInt32(this.gridView4.GetRowCellValue(rowHandle, "ID")) == 0)
          {
            try
            {
              this.db.TBLTALEPFISHRKT.Add(new TBLTALEPFISHRKT()
              {
                ...
                MIKTAR = new Decimal?((Decimal) Convert.ToInt32(this.gridView4.GetRowCellValue(rowHandle, "MIKTAR"))),
                FIYAT = new Decimal?(Convert.ToDecimal(this.gridView4.GetRowCellValue(rowHandle, "FIYAT"))),
                TUTAR = new Decimal?((Decimal) Convert.ToInt32(this.gridView4.GetRowCellValue(rowHandle, "TUTAR"))),
                ISTENENMIKTAR = new Decimal?((Decimal) Convert.ToInt32(this.gridView4.GetRowCellValue(rowHandle, "ISTENENMIKTAR"))),
    ...
    public void tetikle() => this.gridControl1.DataSource = (object) MalzemeDegerAktarma.list.ToList<ElemanlarDurum1>();
    ...
    private void guncelleload()
    {
      ...
      int num1 = 2;
      if (talepdurumid1.GetValueOrDefault() == num1 & talepdurumid1.HasValue)
      {
        this.checkEdit1.Checked = true;
      }
      else
      {
        int? talepdurumid2 = sorgu.TALEPDURUMID;
        int num2 = 3;
        if (talepdurumid2.GetValueOrDefault() == num2 & talepdurumid2.HasValue)
        {
          this.checkEdit1.Checked = true;
        }
        else
        {
          talepdurumid2 = sorgu.TALEPDURUMID;
          int num3 = 1;
          if (talepdurumid2.GetValueOrDefault() == num3 & talepdurumid2.HasValue)
          {
          ...
          else
          {
            talepdurumid2 = sorgu.TALEPDURUMID;
            int num4 = 4;
            if (talepdurumid2.GetValueOrDefault() == num4 & talepdurumid2.HasValue)
      ...
      int? talepdurumid3 = sorgu.TALEPDURUMID;
      int num5 = 2;
      if (!(talepdurumid3.GetValueOrDefault() == num5 & talepdurumid3.HasValue))
        ;
    }
    ...
    private void searchLookUpEdit1View_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        this.aracaciklamaLabel.Text = gridView.GetFocusedRowCellValue("ARACACIKLAMA").ToString();
      }
      catch (Exception ex)
      {
      }
    ...
    private void InitializeComponent()
    {
      ...
      this.isemriSearchLoop.Properties.DataSource = (object) this.tBLISEMRIBindingSource;
      ...
      this.gridColumn1.AppearanceCell.Font = new Font("Tahoma", 12f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.gridColumn1.AppearanceCell.Options.UseFont = true;
      this.gridColumn1.AppearanceHeader.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 162);
      ...
      this.gridColumn2.AppearanceCell.Font = new Font("Tahoma", 12f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.gridColumn2.AppearanceCell.Options.UseFont = true;
      this.gridColumn2.AppearanceHeader.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 162);
      ...
      this.gridColumn3.AppearanceCell.Font = new Font("Tahoma", 12f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.gridColumn3.AppearanceCell.Options.UseFont = true;
      this.gridColumn3.AppearanceHeader.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 162);
      ...
      this.gridColumn4.AppearanceCell.Font = new Font("Tahoma", 12f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.gridColumn4.AppearanceCell.Options.UseFont = true;
      this.gridColumn4.AppearanceHeader.Font = new Font("Tahoma", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 162);
