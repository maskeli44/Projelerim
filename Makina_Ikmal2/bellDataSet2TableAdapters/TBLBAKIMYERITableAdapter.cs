...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLBAKIMYERITableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLBAKIMYERITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLBAKIMYERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLBAKIMYERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLBAKIMYERIDataTable data = new bellDataSet2.TBLBAKIMYERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLBAKIMYERIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBAKIMYERI");
