...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLISLEMTIPITableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLISLEMTIPITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLISLEMTIPIDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLISLEMTIPIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLISLEMTIPIDataTable data = new bellDataSet2.TBLISLEMTIPIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLISLEMTIPIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISLEMTIPI");
