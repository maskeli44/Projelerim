...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLKULLANICILARTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLKULLANICILARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLKULLANICILARDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLKULLANICILARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLKULLANICILARDataTable data = new bellDataSet2.TBLKULLANICILARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLKULLANICILARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLKULLANICILAR");
