...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLIHALELERTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLIHALELERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLIHALELERDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLIHALELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLIHALELERDataTable data = new bellDataSet2.TBLIHALELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLIHALELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIHALELER");
