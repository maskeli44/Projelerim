...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLMALZBIRIMTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLMALZBIRIMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLMALZBIRIMDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLMALZBIRIMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLMALZBIRIMDataTable data = new bellDataSet2.TBLMALZBIRIMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLMALZBIRIMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZBIRIM");
