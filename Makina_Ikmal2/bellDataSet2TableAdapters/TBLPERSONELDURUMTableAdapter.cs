...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLPERSONELDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLPERSONELDURUMTableAdapter : Component
  {
    ...
    public TBLPERSONELDURUMTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLPERSONELDURUM] WHERE (([ID] = @Original_ID) AND ((@IsNull_DURUM = 1 AND [DURUM] IS NULL) OR ([DURUM] = @Original_DURUM)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLPERSONELDURUM] ([DURUM]) VALUES (@DURUM);\r\nSELECT ID, DURUM FROM TBLPERSONELDURUM WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLPERSONELDURUM] SET [DURUM] = @DURUM WHERE (([ID] = @Original_ID) AND ((@IsNull_DURUM = 1 AND [DURUM] IS NULL) OR ([DURUM] = @Original_DURUM)));\r\nSELECT ID, DURUM FROM TBLPERSONELDURUM WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, DURUM FROM dbo.TBLPERSONELDURUM";
    ...
    public virtual int Fill(bellDataSet2.TBLPERSONELDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLPERSONELDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLPERSONELDURUMDataTable data = new bellDataSet2.TBLPERSONELDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLPERSONELDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELDURUM");
    ...
    public virtual int Delete(int Original_ID, string Original_DURUM)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_DURUM;
      }
    ...
    public virtual int Insert(string DURUM)
    {
      if (DURUM == null)
        ...
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DURUM;
    ...
    public virtual int Update(string DURUM, int Original_ID, string Original_DURUM, int ID)
    {
      if (DURUM == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) DURUM;
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) Original_DURUM;
      }
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DataObjectMethod(DataObjectMethodType.Update, true)]
    public virtual int Update(string DURUM, int Original_ID, string Original_DURUM) => this.Update(DURUM, Original_ID, Original_DURUM, Original_ID);
  }
}
