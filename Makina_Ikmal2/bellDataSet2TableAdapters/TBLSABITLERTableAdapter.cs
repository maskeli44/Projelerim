...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLSABITLERTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLSABITLERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLSABITLERDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLSABITLERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLSABITLERDataTable data = new bellDataSet2.TBLSABITLERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLSABITLERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLSABITLER");
