...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLTASITPERSTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLTASITPERSTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLTASITPERSDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLTASITPERSDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLTASITPERSDataTable data = new bellDataSet2.TBLTASITPERSDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLTASITPERSDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITPERS");
