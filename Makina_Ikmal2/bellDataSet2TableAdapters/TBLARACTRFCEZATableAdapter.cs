...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLARACTRFCEZATableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLARACTRFCEZATableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLARACTRFCEZADataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLARACTRFCEZADataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLARACTRFCEZADataTable data = new bellDataSet2.TBLARACTRFCEZADataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLARACTRFCEZADataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACTRFCEZA");
