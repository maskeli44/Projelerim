...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLMALZGRUPTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLMALZGRUPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLMALZGRUPDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLMALZGRUPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLMALZGRUPDataTable data = new bellDataSet2.TBLMALZGRUPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLMALZGRUPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZGRUP");
