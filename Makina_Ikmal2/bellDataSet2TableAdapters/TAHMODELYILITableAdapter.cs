...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TAHMODELYILITableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TAHMODELYILITableAdapter : Component
  {
    ...
    public TAHMODELYILITableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TAHMODELYILI] WHERE (([ID] = @Original_ID) AND ((@IsNull_YILI = 1 AND [YILI] IS NULL) OR ([YILI] = @Original_YILI)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TAHMODELYILI] ([YILI]) VALUES (@YILI);\r\nSELECT ID, YILI FROM TAHMODELYILI WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TAHMODELYILI] SET [YILI] = @YILI WHERE (([ID] = @Original_ID) AND ((@IsNull_YILI = 1 AND [YILI] IS NULL) OR ([YILI] = @Original_YILI)));\r\nSELECT ID, YILI FROM TAHMODELYILI WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, YILI FROM dbo.TAHMODELYILI";
    ...
    public virtual int Fill(bellDataSet2.TAHMODELYILIDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TAHMODELYILIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TAHMODELYILIDataTable data = new bellDataSet2.TAHMODELYILIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TAHMODELYILIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TAHMODELYILI");
    ...
    public virtual int Delete(int Original_ID, string Original_YILI)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_YILI;
      }
    ...
    public virtual int Insert(string YILI)
    {
      if (YILI == null)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) YILI;
    ...
    public virtual int Update(string YILI, int Original_ID, string Original_YILI, int ID)
    {
      if (YILI == null)
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) YILI;
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) Original_YILI;
      }
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DataObjectMethod(DataObjectMethodType.Update, true)]
    public virtual int Update(string YILI, int Original_ID, string Original_YILI) => this.Update(YILI, Original_ID, Original_YILI, Original_ID);
  }
}
