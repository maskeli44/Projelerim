...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLTALEPHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLTALEPHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLTALEPHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLTALEPHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLTALEPHRKTDataTable data = new bellDataSet2.TBLTALEPHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLTALEPHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPHRKT");
