...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLPERSONELISTIHDAMDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLPERSONELISTIHDAMDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet2.TBLPERSONELISTIHDAMDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLPERSONELISTIHDAMDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLPERSONELISTIHDAMDURUMDataTable data = new bellDataSet2.TBLPERSONELISTIHDAMDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELISTIHDAMDURUM");
