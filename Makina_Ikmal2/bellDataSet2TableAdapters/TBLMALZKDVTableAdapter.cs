...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLMALZKDVTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLMALZKDVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLMALZKDVDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLMALZKDVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLMALZKDVDataTable data = new bellDataSet2.TBLMALZKDVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLMALZKDVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZKDV");
