...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLPERSUNVANTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLPERSUNVANTableAdapter : Component
  {
    ...
    public TBLPERSUNVANTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_UNVAN", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_UNVAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLPERSUNVAN] ([UNVAN], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@UNVAN, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, UNVAN, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLPERSUNVAN WHERE (ID = SCOPE_IDENTITY())";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@UNVAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLPERSUNVAN] SET [UNVAN] = @UNVAN, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_UNVAN = 1 AND [UNVAN] IS NULL) OR ([UNVAN] = @Original_UNVAN)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, UNVAN, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLPERSUNVAN WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@UNVAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_UNVAN", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_UNVAN", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "UNVAN", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, UNVAN, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLPERSUNVAN";
    ...
    public virtual int Fill(bellDataSet2.TBLPERSUNVANDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLPERSUNVANDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLPERSUNVANDataTable data = new bellDataSet2.TBLPERSUNVANDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLPERSUNVANDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSUNVAN");
      ...
      string Original_EDITIP)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_UNVAN;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[6].Value = (object) Original_SAVEDATE;
      }
      ...
      string EDITIP)
    {
      if (UNVAN == null)
        ...
        this.Adapter.InsertCommand.Parameters[0].Value = (object) UNVAN;
      if (SAVEUSER == null)
      ...
      if (SAVEDATE == null)
        ...
        this.Adapter.InsertCommand.Parameters[2].Value = (object) SAVEDATE;
      if (EDITUSER == null)
      ...
      int ID)
    {
      if (UNVAN == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) UNVAN;
      if (SAVEUSER == null)
      ...
      if (SAVEDATE == null)
        ...
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) SAVEDATE;
      if (EDITUSER == null)
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_UNVAN;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_SAVEDATE;
      }
      if (Original_EDITUSER == null)
      {
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(UNVAN, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_UNVAN, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
