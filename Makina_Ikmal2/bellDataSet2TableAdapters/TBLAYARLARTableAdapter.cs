...
// Type: Makina_Ikmal.bellDataSet2TableAdapters.TBLAYARLARTableAdapter
...
namespace Makina_Ikmal.bellDataSet2TableAdapters
{
  ...
  public class TBLAYARLARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet2.TBLAYARLARDataTable dataTable)
    {
    ...
    public virtual bellDataSet2.TBLAYARLARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet2.TBLAYARLARDataTable data = new bellDataSet2.TBLAYARLARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2.TBLAYARLARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet2 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLAYARLAR");
