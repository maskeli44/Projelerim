...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLPERSONELDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLPERSONELDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLPERSONELDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLPERSONELDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLPERSONELDURUMDataTable data = new bellDataSet.TBLPERSONELDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLPERSONELDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELDURUM");
