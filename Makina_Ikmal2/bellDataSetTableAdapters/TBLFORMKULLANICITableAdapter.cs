...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLFORMKULLANICITableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLFORMKULLANICITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLFORMKULLANICIDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLFORMKULLANICIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLFORMKULLANICIDataTable data = new bellDataSet.TBLFORMKULLANICIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLFORMKULLANICIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFORMKULLANICI");
