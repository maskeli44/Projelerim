...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLKULLANICILARTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLKULLANICILARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLKULLANICILARDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLKULLANICILARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLKULLANICILARDataTable data = new bellDataSet.TBLKULLANICILARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLKULLANICILARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLKULLANICILAR");
