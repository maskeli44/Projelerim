...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLTALEPHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLTALEPHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLTALEPHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLTALEPHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLTALEPHRKTDataTable data = new bellDataSet.TBLTALEPHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLTALEPHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPHRKT");
