...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLFIRMALARTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLFIRMALARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLFIRMALARDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLFIRMALARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLFIRMALARDataTable data = new bellDataSet.TBLFIRMALARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLFIRMALARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFIRMALAR");
