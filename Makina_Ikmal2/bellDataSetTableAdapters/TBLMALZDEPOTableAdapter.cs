...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLMALZDEPOTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLMALZDEPOTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLMALZDEPODataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLMALZDEPODataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLMALZDEPODataTable data = new bellDataSet.TBLMALZDEPODataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLMALZDEPODataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZDEPO");
