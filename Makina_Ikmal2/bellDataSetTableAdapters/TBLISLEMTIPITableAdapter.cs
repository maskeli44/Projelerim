...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLISLEMTIPITableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLISLEMTIPITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLISLEMTIPIDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLISLEMTIPIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLISLEMTIPIDataTable data = new bellDataSet.TBLISLEMTIPIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLISLEMTIPIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISLEMTIPI");
