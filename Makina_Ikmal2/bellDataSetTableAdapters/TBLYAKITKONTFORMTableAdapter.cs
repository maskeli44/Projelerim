...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLYAKITKONTFORMTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLYAKITKONTFORMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLYAKITKONTFORMDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLYAKITKONTFORMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLYAKITKONTFORMDataTable data = new bellDataSet.TBLYAKITKONTFORMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLYAKITKONTFORMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLYAKITKONTFORM");
