...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLMALZBOLUMTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLMALZBOLUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLMALZBOLUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLMALZBOLUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLMALZBOLUMDataTable data = new bellDataSet.TBLMALZBOLUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLMALZBOLUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZBOLUM");
