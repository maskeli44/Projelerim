...
// Type: Makina_Ikmal.bellDataSetTableAdapters.TBLPERSONELTableAdapter
...
namespace Makina_Ikmal.bellDataSetTableAdapters
{
  ...
  public class TBLPERSONELTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet.TBLPERSONELDataTable dataTable)
    {
    ...
    public virtual bellDataSet.TBLPERSONELDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet.TBLPERSONELDataTable data = new bellDataSet.TBLPERSONELDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet.TBLPERSONELDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONEL");
