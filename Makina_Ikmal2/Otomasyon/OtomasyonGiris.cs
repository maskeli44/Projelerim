...
// Type: Makina_Ikmal.Otomasyon.OtomasyonGiris
...
{
  public class OtomasyonGiris : XtraForm
  {
    ...
    public OtomasyonGiris() => this.InitializeComponent();

    private void accordionControlElement2_Click(object sender, EventArgs e)
    {
      this.yet.yetkiislemleri("İş Emri Listesi");
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        ...
        AracKullanuımRaporu openForm = (AracKullanuımRaporu) Application.OpenForms["AracKullanuımRaporu"];
        if (openForm != null)
          openForm.Focus();
        else
    ...
    private void accordionControlElement3_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki == 1 && YetkiClass.menuyetki == "Hayır")
      {
        Makina_Ikmal.Otomasyon.YakitKarti.YakitKarti openForm = (Makina_Ikmal.Otomasyon.YakitKarti.YakitKarti) Application.OpenForms["YakitKarti"];
        if (openForm != null)
        {
          openForm.Yenile();
          openForm.Focus();
        ...
        {
          Makina_Ikmal.Otomasyon.YakitKarti.YakitKarti yakitKarti = new Makina_Ikmal.Otomasyon.YakitKarti.YakitKarti();
          yakitKarti.MdiParent = (Form) this;
          yakitKarti.Yenile();
          yakitKarti.Show();
        }
      }
    ...
    private void OtomasyonGiris_FormClosed(object sender, FormClosedEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (OtomasyonGiris));
      ...
      this.accordionControl1.Size = new Size(252, 466);
      ...
      this.accordionControlElement2.Text = "Araç Kullanım Raporu";
      ...
      this.accordionControlElement3.Text = "Yakıt Kartı";
      ...
      this.Name = nameof (OtomasyonGiris);
      this.Text = "Otomasyon";
      this.WindowState = FormWindowState.Maximized;
      this.FormClosed += new FormClosedEventHandler(this.OtomasyonGiris_FormClosed);
