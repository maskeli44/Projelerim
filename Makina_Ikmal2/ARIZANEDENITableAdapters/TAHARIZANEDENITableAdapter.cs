...
// Type: Makina_Ikmal.ARIZANEDENITableAdapters.TAHARIZANEDENITableAdapter
...
namespace Makina_Ikmal.ARIZANEDENITableAdapters
{
  ...
  public class TAHARIZANEDENITableAdapter : Component
  {
    ...
    public virtual int Fill(ARIZANEDENI.TAHARIZANEDENIDataTable dataTable)
    {
    ...
    public virtual ARIZANEDENI.TAHARIZANEDENIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      ARIZANEDENI.TAHARIZANEDENIDataTable data = new ARIZANEDENI.TAHARIZANEDENIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(ARIZANEDENI.TAHARIZANEDENIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(ARIZANEDENI dataSet) => this.Adapter.Update((DataSet) dataSet, "TAHARIZANEDENI");
