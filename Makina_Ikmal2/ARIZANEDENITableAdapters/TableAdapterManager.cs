...
// Type: Makina_Ikmal.ARIZANEDENITableAdapters.TableAdapterManager
  ...
  public class TableAdapterManager : Component
  {
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._tAHARIZANEDENITableAdapter != null && this._tAHARIZANEDENITableAdapter.Connection != null ? (IDbConnection) this._tAHARIZANEDENITableAdapter.Connection : (IDbConnection) null;
      }
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(ARIZANEDENI dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._tAHARIZANEDENITableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(ARIZANEDENI dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._tAHARIZANEDENITableAdapter != null)
      {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(ARIZANEDENI dataSet)
    {
      if (dataSet == null)
