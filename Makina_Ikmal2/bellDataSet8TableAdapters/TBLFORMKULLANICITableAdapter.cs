...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLFORMKULLANICITableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLFORMKULLANICITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLFORMKULLANICIDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLFORMKULLANICIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLFORMKULLANICIDataTable data = new bellDataSet8.TBLFORMKULLANICIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLFORMKULLANICIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFORMKULLANICI");
