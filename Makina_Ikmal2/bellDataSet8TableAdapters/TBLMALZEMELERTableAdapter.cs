...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLMALZEMELERTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLMALZEMELERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLMALZEMELERDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLMALZEMELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLMALZEMELERDataTable data = new bellDataSet8.TBLMALZEMELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLMALZEMELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZEMELER");
