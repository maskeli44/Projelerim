...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLFIRMALARTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLFIRMALARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLFIRMALARDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLFIRMALARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLFIRMALARDataTable data = new bellDataSet8.TBLFIRMALARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLFIRMALARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLFIRMALAR");
