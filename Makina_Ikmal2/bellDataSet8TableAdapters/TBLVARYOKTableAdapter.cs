...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLVARYOKTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLVARYOKTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLVARYOKDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLVARYOKDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLVARYOKDataTable data = new bellDataSet8.TBLVARYOKDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLVARYOKDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLVARYOK");
