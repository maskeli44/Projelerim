...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLIDARISARTHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLIDARISARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLIDARISARTHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLIDARISARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLIDARISARTHRKTDataTable data = new bellDataSet8.TBLIDARISARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLIDARISARTHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIDARISARTHRKT");
