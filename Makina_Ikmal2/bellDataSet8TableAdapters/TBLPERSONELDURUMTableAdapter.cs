...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLPERSONELDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLPERSONELDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLPERSONELDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLPERSONELDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLPERSONELDURUMDataTable data = new bellDataSet8.TBLPERSONELDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLPERSONELDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELDURUM");
