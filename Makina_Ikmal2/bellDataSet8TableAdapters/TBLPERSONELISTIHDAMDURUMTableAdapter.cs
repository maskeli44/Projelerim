...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLPERSONELISTIHDAMDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLPERSONELISTIHDAMDURUMTableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet8.TBLPERSONELISTIHDAMDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLPERSONELISTIHDAMDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLPERSONELISTIHDAMDURUMDataTable data = new bellDataSet8.TBLPERSONELISTIHDAMDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLPERSONELISTIHDAMDURUM");
