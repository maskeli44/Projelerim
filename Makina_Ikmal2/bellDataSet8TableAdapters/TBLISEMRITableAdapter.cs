...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLISEMRITableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLISEMRITableAdapter : Component
  {
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_ATIKYAG", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ATIKYAG", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_ATIKYAG", SqlDbType.Decimal, 0, ParameterDirection.Input, (byte) 18, (byte) 2, "ATIKYAG", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.InsertCommand = new SqlCommand();
      this._adapter.InsertCommand.Connection = this.Connection;
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLISEMRI] ([KOD], [ATOLYEID], [ARACID], [GIRISTARIH], [GIRISSAAT], [CIKISTARIH], [CIKISSAAT], [ARIZANEDENIID], [BILDIRILENARIZA], [ISEMRIDURUMID], [BAKIMYERIID], [BAKIMYERACKLM], [ARACIGETIREN], [BAKIMKMSI], [SONRAKIBKMKM], [SONRAKIBKMTRH], [BAKIMSAATI], [SONRAKIBKMSAAT], [ISEMRISIRANO], [YAPILANBAKIMOZETI], [IMZAATOLYESEFID], [ISBITIMORANI], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP], [BAKIMTURUID], [BAKIMDERECESIID], [ATIKYAG]) VALUES (@KOD, @ATOLYEID, @ARACID, @GIRISTARIH, @GIRISSAAT, @CIKISTARIH, @CIKISSAAT, @ARIZANEDENIID, @BILDIRILENARIZA, @ISEMRIDURUMID, @BAKIMYERIID, @BAKIMYERACKLM, @ARACIGETIREN, @BAKIMKMSI, @SONRAKIBKMKM, @SONRAKIBKMTRH, @BAKIMSAATI, @SONRAKIBKMSAAT, @ISEMRISIRANO, @YAPILANBAKIMOZETI, @IMZAATOLYESEFID, @ISBITIMORANI, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP, @BAKIMTURUID, @BAKIMDERECESIID, @ATIKYAG);\r\nSELECT ID, KOD, ATOLYEID, ARACID, GIRISTARIH, GIRISSAAT, CIKISTARIH, CIKISSAAT, ARIZANEDENIID, BILDIRILENARIZA, ISEMRIDURUMID, BAKIMYERIID, BAKIMYERACKLM, ARACIGETIREN, BAKIMKMSI, SONRAKIBKMKM, SONRAKIBKMTRH, BAKIMSAATI, SONRAKIBKMSAAT, ISEMRISIRANO, YAPILANBAKIMOZETI, IMZAATOLYESEFID, ISBITIMORANI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, BAKIMTURUID, BAKIMDERECESIID, ATIKYAG FROM TBLISEMRI WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@ATIKYAG", SqlDbType.Decimal, 0, ParameterDirection.Input, (byte) 18, (byte) 2, "ATIKYAG", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand = new SqlCommand();
      this._adapter.UpdateCommand.Connection = this.Connection;
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLISEMRI] SET [KOD] = @KOD, [ATOLYEID] = @ATOLYEID, [ARACID] = @ARACID, [GIRISTARIH] = @GIRISTARIH, [GIRISSAAT] = @GIRISSAAT, [CIKISTARIH] = @CIKISTARIH, [CIKISSAAT] = @CIKISSAAT, [ARIZANEDENIID] = @ARIZANEDENIID, [BILDIRILENARIZA] = @BILDIRILENARIZA, [ISEMRIDURUMID] = @ISEMRIDURUMID, [BAKIMYERIID] = @BAKIMYERIID, [BAKIMYERACKLM] = @BAKIMYERACKLM, [ARACIGETIREN] = @ARACIGETIREN, [BAKIMKMSI] = @BAKIMKMSI, [SONRAKIBKMKM] = @SONRAKIBKMKM, [SONRAKIBKMTRH] = @SONRAKIBKMTRH, [BAKIMSAATI] = @BAKIMSAATI, [SONRAKIBKMSAAT] = @SONRAKIBKMSAAT, [ISEMRISIRANO] = @ISEMRISIRANO, [YAPILANBAKIMOZETI] = @YAPILANBAKIMOZETI, [IMZAATOLYESEFID] = @IMZAATOLYESEFID, [ISBITIMORANI] = @ISBITIMORANI, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP, [BAKIMTURUID] = @BAKIMTURUID, [BAKIMDERECESIID] = @BAKIMDERECESIID, [ATIKYAG] = @ATIKYAG WHERE (([ID] = @Original_ID) AND ((@IsNull_KOD = 1 AND [KOD] IS NULL) OR ([KOD] = @Original_KOD)) AND ((@IsNull_ATOLYEID = 1 AND [ATOLYEID] IS NULL) OR ([ATOLYEID] = @Original_ATOLYEID)) AND ((@IsNull_ARACID = 1 AND [ARACID] IS NULL) OR ([ARACID] = @Original_ARACID)) AND ((@IsNull_GIRISTARIH = 1 AND [GIRISTARIH] IS NULL) OR ([GIRISTARIH] = @Original_GIRISTARIH)) AND ((@IsNull_GIRISSAAT = 1 AND [GIRISSAAT] IS NULL) OR ([GIRISSAAT] = @Original_GIRISSAAT)) AND ((@IsNull_CIKISTARIH = 1 AND [CIKISTARIH] IS NULL) OR ([CIKISTARIH] = @Original_CIKISTARIH)) AND ((@IsNull_CIKISSAAT = 1 AND [CIKISSAAT] IS NULL) OR ([CIKISSAAT] = @Original_CIKISSAAT)) AND ((@IsNull_ARIZANEDENIID = 1 AND [ARIZANEDENIID] IS NULL) OR ([ARIZANEDENIID] = @Original_ARIZANEDENIID)) AND ((@IsNull_ISEMRIDURUMID = 1 AND [ISEMRIDURUMID] IS NULL) OR ([ISEMRIDURUMID] = @Original_ISEMRIDURUMID)) AND ((@IsNull_BAKIMYERIID = 1 AND [BAKIMYERIID] IS NULL) OR ([BAKIMYERIID] = @Original_BAKIMYERIID)) AND ((@IsNull_BAKIMYERACKLM = 1 AND [BAKIMYERACKLM] IS NULL) OR ([BAKIMYERACKLM] = @Original_BAKIMYERACKLM)) AND ((@IsNull_ARACIGETIREN = 1 AND [ARACIGETIREN] IS NULL) OR ([ARACIGETIREN] = @Original_ARACIGETIREN)) AND ((@IsNull_BAKIMKMSI = 1 AND [BAKIMKMSI] IS NULL) OR ([BAKIMKMSI] = @Original_BAKIMKMSI)) AND ((@IsNull_SONRAKIBKMKM = 1 AND [SONRAKIBKMKM] IS NULL) OR ([SONRAKIBKMKM] = @Original_SONRAKIBKMKM)) AND ((@IsNull_SONRAKIBKMTRH = 1 AND [SONRAKIBKMTRH] IS NULL) OR ([SONRAKIBKMTRH] = @Original_SONRAKIBKMTRH)) AND ((@IsNull_BAKIMSAATI = 1 AND [BAKIMSAATI] IS NULL) OR ([BAKIMSAATI] = @Original_BAKIMSAATI)) AND ((@IsNull_SONRAKIBKMSAAT = 1 AND [SONRAKIBKMSAAT] IS NULL) OR ([SONRAKIBKMSAAT] = @Original_SONRAKIBKMSAAT)) AND ((@IsNull_ISEMRISIRANO = 1 AND [ISEMRISIRANO] IS NULL) OR ([ISEMRISIRANO] = @Original_ISEMRISIRANO)) AND ((@IsNull_IMZAATOLYESEFID = 1 AND [IMZAATOLYESEFID] IS NULL) OR ([IMZAATOLYESEFID] = @Original_IMZAATOLYESEFID)) AND ((@IsNull_ISBITIMORANI = 1 AND [ISBITIMORANI] IS NULL) OR ([ISBITIMORANI] = @Original_ISBITIMORANI)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)) AND ((@IsNull_BAKIMTURUID = 1 AND [BAKIMTURUID] IS NULL) OR ([BAKIMTURUID] = @Original_BAKIMTURUID)) AND ((@IsNull_BAKIMDERECESIID = 1 AND [BAKIMDERECESIID] IS NULL) OR ([BAKIMDERECESIID] = @Original_BAKIMDERECESIID)) AND ((@IsNull_ATIKYAG = 1 AND [ATIKYAG] IS NULL) OR ([ATIKYAG] = @Original_ATIKYAG)));\r\nSELECT ID, KOD, ATOLYEID, ARACID, GIRISTARIH, GIRISSAAT, CIKISTARIH, CIKISSAAT, ARIZANEDENIID, BILDIRILENARIZA, ISEMRIDURUMID, BAKIMYERIID, BAKIMYERACKLM, ARACIGETIREN, BAKIMKMSI, SONRAKIBKMKM, SONRAKIBKMTRH, BAKIMSAATI, SONRAKIBKMSAAT, ISEMRISIRANO, YAPILANBAKIMOZETI, IMZAATOLYESEFID, ISBITIMORANI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, BAKIMTURUID, BAKIMDERECESIID, ATIKYAG FROM TBLISEMRI WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@ATIKYAG", SqlDbType.Decimal, 0, ParameterDirection.Input, (byte) 18, (byte) 2, "ATIKYAG", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_ATIKYAG", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "ATIKYAG", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_ATIKYAG", SqlDbType.Decimal, 0, ParameterDirection.Input, (byte) 18, (byte) 2, "ATIKYAG", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, KOD, ATOLYEID, ARACID, GIRISTARIH, GIRISSAAT, CIKISTARIH, CIKISSAAT, ARIZANEDENIID, BILDIRILENARIZA, ISEMRIDURUMID, BAKIMYERIID, BAKIMYERACKLM, ARACIGETIREN, BAKIMKMSI, SONRAKIBKMKM, SONRAKIBKMTRH, BAKIMSAATI, SONRAKIBKMSAAT, ISEMRISIRANO, YAPILANBAKIMOZETI, IMZAATOLYESEFID, ISBITIMORANI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, BAKIMTURUID, BAKIMDERECESIID, ATIKYAG FROM dbo.TBLISEMRI";
    ...
    public virtual int Fill(bellDataSet8.TBLISEMRIDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLISEMRIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLISEMRIDataTable data = new bellDataSet8.TBLISEMRIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLISEMRIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISEMRI");
      ...
      Decimal? Original_ATIKYAG)
    {
      ...
      if (Original_ATIKYAG.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[61].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[62].Value = (object) Original_ATIKYAG.Value;
      }
      else
      {
      ...
      Decimal? ATIKYAG)
    {
      ...
      if (ATIKYAG.HasValue)
        this.Adapter.InsertCommand.Parameters[32].Value = (object) ATIKYAG.Value;
      else
      ...
      int ID)
    {
      ...
      if (ATIKYAG.HasValue)
        this.Adapter.UpdateCommand.Parameters[32].Value = (object) ATIKYAG.Value;
      else
      ...
      if (Original_ATIKYAG.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[95].Value = (object) Original_ATIKYAG.Value;
      }
      else
      {
    ...
    public virtual int Update(
      ...
      Decimal? Original_ATIKYAG)
    {
      return this.Update(KOD, ATOLYEID, ARACID, GIRISTARIH, GIRISSAAT, CIKISTARIH, CIKISSAAT, ARIZANEDENIID, BILDIRILENARIZA, ISEMRIDURUMID, BAKIMYERIID, BAKIMYERACKLM, ARACIGETIREN, BAKIMKMSI, SONRAKIBKMKM, SONRAKIBKMTRH, BAKIMSAATI, SONRAKIBKMSAAT, ISEMRISIRANO, YAPILANBAKIMOZETI, IMZAATOLYESEFID, ISBITIMORANI, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, BAKIMTURUID, BAKIMDERECESIID, ATIKYAG, Original_ID, Original_KOD, Original_ATOLYEID, Original_ARACID, Original_GIRISTARIH, Original_GIRISSAAT, Original_CIKISTARIH, Original_CIKISSAAT, Original_ARIZANEDENIID, Original_ISEMRIDURUMID, Original_BAKIMYERIID, Original_BAKIMYERACKLM, Original_ARACIGETIREN, Original_BAKIMKMSI, Original_SONRAKIBKMKM, Original_SONRAKIBKMTRH, Original_BAKIMSAATI, Original_SONRAKIBKMSAAT, Original_ISEMRISIRANO, Original_IMZAATOLYESEFID, Original_ISBITIMORANI, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_BAKIMTURUID, Original_BAKIMDERECESIID, Original_ATIKYAG, Original_ID);
    }
  }
}
