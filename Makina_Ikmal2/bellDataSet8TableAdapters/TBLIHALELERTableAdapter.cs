...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLIHALELERTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLIHALELERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLIHALELERDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLIHALELERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLIHALELERDataTable data = new bellDataSet8.TBLIHALELERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLIHALELERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLIHALELER");
