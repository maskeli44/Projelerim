...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLTASITPERSTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLTASITPERSTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLTASITPERSDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLTASITPERSDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLTASITPERSDataTable data = new bellDataSet8.TBLTASITPERSDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLTASITPERSDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITPERS");
