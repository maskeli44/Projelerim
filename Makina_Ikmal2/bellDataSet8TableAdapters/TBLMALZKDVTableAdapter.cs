...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLMALZKDVTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLMALZKDVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLMALZKDVDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLMALZKDVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLMALZKDVDataTable data = new bellDataSet8.TBLMALZKDVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLMALZKDVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZKDV");
