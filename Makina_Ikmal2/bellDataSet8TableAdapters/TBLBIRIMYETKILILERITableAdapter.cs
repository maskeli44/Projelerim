...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLBIRIMYETKILILERITableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLBIRIMYETKILILERITableAdapter : Component
  {
    ...
    public virtual int Fill(
      bellDataSet8.TBLBIRIMYETKILILERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLBIRIMYETKILILERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLBIRIMYETKILILERIDataTable data = new bellDataSet8.TBLBIRIMYETKILILERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBIRIMYETKILILERI");
