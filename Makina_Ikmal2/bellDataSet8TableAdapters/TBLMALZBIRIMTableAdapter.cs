...
// Type: Makina_Ikmal.bellDataSet8TableAdapters.TBLMALZBIRIMTableAdapter
...
namespace Makina_Ikmal.bellDataSet8TableAdapters
{
  ...
  public class TBLMALZBIRIMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet8.TBLMALZBIRIMDataTable dataTable)
    {
    ...
    public virtual bellDataSet8.TBLMALZBIRIMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet8.TBLMALZBIRIMDataTable data = new bellDataSet8.TBLMALZBIRIMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8.TBLMALZBIRIMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet8 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZBIRIM");
