...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLSABITLERTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLSABITLERTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLSABITLERDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLSABITLERDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLSABITLERDataTable data = new bellDataSet6.TBLSABITLERDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLSABITLERDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLSABITLER");
