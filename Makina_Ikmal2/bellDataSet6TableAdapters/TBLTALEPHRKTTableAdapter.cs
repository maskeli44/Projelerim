...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLTALEPHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLTALEPHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLTALEPHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLTALEPHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLTALEPHRKTDataTable data = new bellDataSet6.TBLTALEPHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLTALEPHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEPHRKT");
