...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLKULLANICILARTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLKULLANICILARTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLKULLANICILARDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLKULLANICILARDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLKULLANICILARDataTable data = new bellDataSet6.TBLKULLANICILARDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLKULLANICILARDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLKULLANICILAR");
