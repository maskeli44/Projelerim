...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLTASITGOREVTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLTASITGOREVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLTASITGOREVDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLTASITGOREVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLTASITGOREVDataTable data = new bellDataSet6.TBLTASITGOREVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLTASITGOREVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITGOREV");
