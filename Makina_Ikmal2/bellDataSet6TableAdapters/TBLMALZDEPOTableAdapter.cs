...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLMALZDEPOTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLMALZDEPOTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLMALZDEPODataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLMALZDEPODataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLMALZDEPODataTable data = new bellDataSet6.TBLMALZDEPODataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLMALZDEPODataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZDEPO");
