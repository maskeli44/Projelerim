...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLTEKNIKSARTHRKTTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLTEKNIKSARTHRKTTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLTEKNIKSARTHRKTDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLTEKNIKSARTHRKTDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLTEKNIKSARTHRKTDataTable data = new bellDataSet6.TBLTEKNIKSARTHRKTDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLTEKNIKSARTHRKTDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTEKNIKSARTHRKT");
