...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLMALZGRUP2TableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLMALZGRUP2TableAdapter : Component
  {
    ...
    public TBLMALZGRUP2TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_MALZEMEGRUP2", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_MALZEMEGRUP2", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLMALZGRUP2] ([MALZEMEGRUP2], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@MALZEMEGRUP2, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, MALZEMEGRUP2, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLMALZGRUP2 WHERE (ID = SCOPE_IDENTITY())";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@MALZEMEGRUP2", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLMALZGRUP2] SET [MALZEMEGRUP2] = @MALZEMEGRUP2, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_MALZEMEGRUP2 = 1 AND [MALZEMEGRUP2] IS NULL) OR ([MALZEMEGRUP2] = @Original_MALZEMEGRUP2)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, MALZEMEGRUP2, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLMALZGRUP2 WHERE (ID = @ID)";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@MALZEMEGRUP2", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_MALZEMEGRUP2", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_MALZEMEGRUP2", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "MALZEMEGRUP2", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, MALZEMEGRUP2, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLMALZGRUP2";
    ...
    public virtual int Fill(bellDataSet6.TBLMALZGRUP2DataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLMALZGRUP2DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLMALZGRUP2DataTable data = new bellDataSet6.TBLMALZGRUP2DataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLMALZGRUP2DataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZGRUP2");
      ...
      string Original_EDITIP)
    {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_MALZEMEGRUP2;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[4].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.DeleteCommand.Parameters[5].Value = (object) 0;
        this.Adapter.DeleteCommand.Parameters[6].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[8].Value = (object) Original_EDITUSER;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[10].Value = (object) Original_EDITDATE;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[14].Value = (object) Original_EDITMAC;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[16].Value = (object) Original_SAVEIP;
      }
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[18].Value = (object) Original_EDITIP;
      }
    ...
    public virtual int Insert(
      ...
      string EDITIP)
    {
      if (MALZEMEGRUP2 == null)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) MALZEMEGRUP2;
      if (SAVEUSER == null)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) EDITDATE;
      if (SAVEMAC == null)
      ...
      if (EDITMAC == null)
        ...
        this.Adapter.InsertCommand.Parameters[6].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) EDITIP;
      ...
      int ID)
    {
      if (MALZEMEGRUP2 == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) MALZEMEGRUP2;
      if (SAVEUSER == null)
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) SAVEUSER;
      if (SAVEDATE.HasValue)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) SAVEDATE.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      if (EDITUSER == null)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) EDITUSER;
      if (EDITDATE == null)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) EDITDATE;
      if (SAVEMAC == null)
      ...
      if (EDITMAC == null)
        ...
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) EDITMAC;
      if (SAVEIP == null)
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[7].Value = (object) SAVEIP;
      if (EDITIP == null)
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) EDITIP;
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[11].Value = (object) Original_MALZEMEGRUP2;
      }
      if (Original_SAVEUSER == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[13].Value = (object) Original_SAVEUSER;
      }
      if (Original_SAVEDATE.HasValue)
      {
        this.Adapter.UpdateCommand.Parameters[14].Value = (object) 0;
        this.Adapter.UpdateCommand.Parameters[15].Value = (object) Original_SAVEDATE.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[17].Value = (object) Original_EDITUSER;
      }
      if (Original_EDITDATE == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[19].Value = (object) Original_EDITDATE;
      }
      if (Original_SAVEMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[21].Value = (object) Original_SAVEMAC;
      }
      if (Original_EDITMAC == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[23].Value = (object) Original_EDITMAC;
      }
      if (Original_SAVEIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[25].Value = (object) Original_SAVEIP;
      }
      if (Original_EDITIP == null)
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[27].Value = (object) Original_EDITIP;
      }
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(MALZEMEGRUP2, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_MALZEMEGRUP2, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
