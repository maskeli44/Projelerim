...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLARACGRUBUTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLARACGRUBUTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLARACGRUBUDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLARACGRUBUDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLARACGRUBUDataTable data = new bellDataSet6.TBLARACGRUBUDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLARACGRUBUDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLARACGRUBU");
