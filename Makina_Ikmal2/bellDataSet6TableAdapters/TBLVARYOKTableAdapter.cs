...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLVARYOKTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLVARYOKTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLVARYOKDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLVARYOKDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLVARYOKDataTable data = new bellDataSet6.TBLVARYOKDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLVARYOKDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLVARYOK");
