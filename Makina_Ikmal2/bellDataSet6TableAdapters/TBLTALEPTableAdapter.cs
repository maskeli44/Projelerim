...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLTALEPTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLTALEPTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLTALEPDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLTALEPDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLTALEPDataTable data = new bellDataSet6.TBLTALEPDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLTALEPDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTALEP");
