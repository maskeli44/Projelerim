...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLISEMIRDURUMTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLISEMIRDURUMTableAdapter : Component
  {
    ...
    public TBLISEMIRDURUMTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLISEMIRDURUM] WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLISEMIRDURUM] ([ADI]) VALUES (@ADI);\r\nSELECT ID, ADI FROM TBLISEMIRDURUM WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLISEMIRDURUM] SET [ADI] = @ADI WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)));\r\nSELECT ID, ADI FROM TBLISEMIRDURUM WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ADI FROM dbo.TBLISEMIRDURUM";
    ...
    public virtual int Fill(bellDataSet6.TBLISEMIRDURUMDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLISEMIRDURUMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLISEMIRDURUMDataTable data = new bellDataSet6.TBLISEMIRDURUMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLISEMIRDURUMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISEMIRDURUM");
    ...
    public virtual int Insert(string ADI)
    {
      if (ADI == null)
        ...
        this.Adapter.InsertCommand.Parameters[0].Value = (object) ADI;
    ...
    public virtual int Update(string ADI, int Original_ID, string Original_ADI, int ID)
    {
      if (ADI == null)
        ...
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) ADI;
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) Original_ADI;
      }
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DataObjectMethod(DataObjectMethodType.Update, true)]
    public virtual int Update(string ADI, int Original_ID, string Original_ADI) => this.Update(ADI, Original_ID, Original_ADI, Original_ID);
  }
}
