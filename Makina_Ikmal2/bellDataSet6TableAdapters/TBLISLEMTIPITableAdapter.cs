...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLISLEMTIPITableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLISLEMTIPITableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLISLEMTIPIDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLISLEMTIPIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLISLEMTIPIDataTable data = new bellDataSet6.TBLISLEMTIPIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLISLEMTIPIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLISLEMTIPI");
