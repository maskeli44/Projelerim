...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLDEPOFISTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLDEPOFISTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLDEPOFISDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLDEPOFISDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLDEPOFISDataTable data = new bellDataSet6.TBLDEPOFISDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLDEPOFISDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLDEPOFIS");
