...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLTASITPERSTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLTASITPERSTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLTASITPERSDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLTASITPERSDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLTASITPERSDataTable data = new bellDataSet6.TBLTASITPERSDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLTASITPERSDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLTASITPERS");
