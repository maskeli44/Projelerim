...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLMALZBIRIMTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLMALZBIRIMTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLMALZBIRIMDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLMALZBIRIMDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLMALZBIRIMDataTable data = new bellDataSet6.TBLMALZBIRIMDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLMALZBIRIMDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZBIRIM");
