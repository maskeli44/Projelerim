...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLBELDMUDURLUKTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLBELDMUDURLUKTableAdapter : Component
  {
    ...
    public TBLBELDMUDURLUKTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_BELDMUDURLUK", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_BELDMUDURLUK", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Original, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLBELDMUDURLUK] ([BELDBIRIMID], [BELDMUDURLUK], [SAVEUSER], [SAVEDATE], [EDITUSER], [EDITDATE], [SAVEMAC], [EDITMAC], [SAVEIP], [EDITIP]) VALUES (@BELDBIRIMID, @BELDMUDURLUK, @SAVEUSER, @SAVEDATE, @EDITUSER, @EDITDATE, @SAVEMAC, @EDITMAC, @SAVEIP, @EDITIP);\r\nSELECT ID, BELDBIRIMID, BELDMUDURLUK, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLBELDMUDURLUK WHERE (ID = SCOPE_IDENTITY())";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@BELDMUDURLUK", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLBELDMUDURLUK] SET [BELDBIRIMID] = @BELDBIRIMID, [BELDMUDURLUK] = @BELDMUDURLUK, [SAVEUSER] = @SAVEUSER, [SAVEDATE] = @SAVEDATE, [EDITUSER] = @EDITUSER, [EDITDATE] = @EDITDATE, [SAVEMAC] = @SAVEMAC, [EDITMAC] = @EDITMAC, [SAVEIP] = @SAVEIP, [EDITIP] = @EDITIP WHERE (([ID] = @Original_ID) AND ((@IsNull_BELDBIRIMID = 1 AND [BELDBIRIMID] IS NULL) OR ([BELDBIRIMID] = @Original_BELDBIRIMID)) AND ((@IsNull_BELDMUDURLUK = 1 AND [BELDMUDURLUK] IS NULL) OR ([BELDMUDURLUK] = @Original_BELDMUDURLUK)) AND ((@IsNull_SAVEUSER = 1 AND [SAVEUSER] IS NULL) OR ([SAVEUSER] = @Original_SAVEUSER)) AND ((@IsNull_SAVEDATE = 1 AND [SAVEDATE] IS NULL) OR ([SAVEDATE] = @Original_SAVEDATE)) AND ((@IsNull_EDITUSER = 1 AND [EDITUSER] IS NULL) OR ([EDITUSER] = @Original_EDITUSER)) AND ((@IsNull_EDITDATE = 1 AND [EDITDATE] IS NULL) OR ([EDITDATE] = @Original_EDITDATE)) AND ((@IsNull_SAVEMAC = 1 AND [SAVEMAC] IS NULL) OR ([SAVEMAC] = @Original_SAVEMAC)) AND ((@IsNull_EDITMAC = 1 AND [EDITMAC] IS NULL) OR ([EDITMAC] = @Original_EDITMAC)) AND ((@IsNull_SAVEIP = 1 AND [SAVEIP] IS NULL) OR ([SAVEIP] = @Original_SAVEIP)) AND ((@IsNull_EDITIP = 1 AND [EDITIP] IS NULL) OR ([EDITIP] = @Original_EDITIP)));\r\nSELECT ID, BELDBIRIMID, BELDMUDURLUK, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM TBLBELDMUDURLUK WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@BELDMUDURLUK", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_BELDMUDURLUK", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Original, true, (object) null, "", "", ""));
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_BELDMUDURLUK", SqlDbType.NVarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "BELDMUDURLUK", DataRowVersion.Original, false, (object) null, "", "", ""));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, BELDBIRIMID, BELDMUDURLUK, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP FROM dbo.TBLBELDMUDURLUK";
    ...
    public virtual int Fill(bellDataSet6.TBLBELDMUDURLUKDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLBELDMUDURLUKDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLBELDMUDURLUKDataTable data = new bellDataSet6.TBLBELDMUDURLUKDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLBELDMUDURLUKDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBELDMUDURLUK");
      ...
      string Original_EDITIP)
    {
      ...
      if (Original_BELDBIRIMID.HasValue)
      {
        ...
        this.Adapter.DeleteCommand.Parameters[2].Value = (object) Original_BELDBIRIMID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.DeleteCommand.Parameters[4].Value = (object) Original_BELDMUDURLUK;
      }
      ...
      string EDITIP)
    {
      if (BELDBIRIMID.HasValue)
        this.Adapter.InsertCommand.Parameters[0].Value = (object) BELDBIRIMID.Value;
      else
        this.Adapter.InsertCommand.Parameters[0].Value = (object) DBNull.Value;
      if (BELDMUDURLUK == null)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) BELDMUDURLUK;
      if (SAVEUSER == null)
    ...
    {
      if (BELDBIRIMID.HasValue)
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) BELDBIRIMID.Value;
      else
        this.Adapter.UpdateCommand.Parameters[0].Value = (object) DBNull.Value;
      if (BELDMUDURLUK == null)
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) BELDMUDURLUK;
      if (SAVEUSER == null)
      ...
      if (Original_BELDBIRIMID.HasValue)
      {
        ...
        this.Adapter.UpdateCommand.Parameters[12].Value = (object) Original_BELDBIRIMID.Value;
      }
      else
      {
      ...
      else
      {
        ...
        this.Adapter.UpdateCommand.Parameters[14].Value = (object) Original_BELDMUDURLUK;
      }
      if (Original_SAVEUSER == null)
      {
    ...
    public virtual int Update(
      ...
      string Original_EDITIP)
    {
      return this.Update(BELDBIRIMID, BELDMUDURLUK, SAVEUSER, SAVEDATE, EDITUSER, EDITDATE, SAVEMAC, EDITMAC, SAVEIP, EDITIP, Original_ID, Original_BELDBIRIMID, Original_BELDMUDURLUK, Original_SAVEUSER, Original_SAVEDATE, Original_EDITUSER, Original_EDITDATE, Original_SAVEMAC, Original_EDITMAC, Original_SAVEIP, Original_EDITIP, Original_ID);
    }
  }
}
