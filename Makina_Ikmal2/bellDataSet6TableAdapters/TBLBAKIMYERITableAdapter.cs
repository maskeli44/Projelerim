...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLBAKIMYERITableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLBAKIMYERITableAdapter : Component
  {
    ...
    public TBLBAKIMYERITableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBLBAKIMYERI] WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBLBAKIMYERI] ([ID], [ADI]) VALUES (@ID, @ADI);\r\nSELECT ID, ADI FROM TBLBAKIMYERI WHERE (ID = @ID)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBLBAKIMYERI] SET [ID] = @ID, [ADI] = @ADI WHERE (([ID] = @Original_ID) AND ((@IsNull_ADI = 1 AND [ADI] IS NULL) OR ([ADI] = @Original_ADI)));\r\nSELECT ID, ADI FROM TBLBAKIMYERI WHERE (ID = @ID)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ID, ADI FROM dbo.TBLBAKIMYERI";
    ...
    public virtual int Fill(bellDataSet6.TBLBAKIMYERIDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLBAKIMYERIDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLBAKIMYERIDataTable data = new bellDataSet6.TBLBAKIMYERIDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLBAKIMYERIDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLBAKIMYERI");
