...
// Type: Makina_Ikmal.bellDataSet6TableAdapters.TBLMALZKDVTableAdapter
...
namespace Makina_Ikmal.bellDataSet6TableAdapters
{
  ...
  public class TBLMALZKDVTableAdapter : Component
  {
    ...
    public virtual int Fill(bellDataSet6.TBLMALZKDVDataTable dataTable)
    {
    ...
    public virtual bellDataSet6.TBLMALZKDVDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      bellDataSet6.TBLMALZKDVDataTable data = new bellDataSet6.TBLMALZKDVDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6.TBLMALZKDVDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(bellDataSet6 dataSet) => this.Adapter.Update((DataSet) dataSet, "TBLMALZKDV");
