...
// Type: Makina_Ikmal.AracBolumu.YedekAracAlimTutanagiGuncelle
...
{
  public class YedekAracAlimTutanagiGuncelle : XtraForm
  {
    ...
    public YedekAracAlimTutanagiGuncelle() => this.InitializeComponent();
    ...
    {
      TBLARACYEDEKALIM tblaracyedekalim = this.db.TBLARACYEDEKALIM.FirstOrDefault<TBLARACYEDEKALIM>((Expression<System.Func<TBLARACYEDEKALIM, bool>>) (x => x.ID == YetkiClass.secim_id));
      try
      {
        if (this.plakaLook.Text != "")
          tblaracyedekalim.GIDENARACID = new int?(Convert.ToInt32(this.plakaLook.EditValue));
        if (this.plakaLook.Text != "")
          tblaracyedekalim.TARIH = new DateTime?(Convert.ToDateTime(this.tarihDate.EditValue));
        if (this.plakaLook.Text != "")
          tblaracyedekalim.SAAT = new DateTime?(Convert.ToDateTime(this.saatDate.EditValue));
        if (this.plakaLook.Text != "")
          tblaracyedekalim.DEGISIMSEBEBI = this.degisimSebebiTxt.Text;
        if (this.plakaLook.Text != "")
          tblaracyedekalim.YEDEKARAC = this.yedekAracTxt.Text;
        if (this.plakaLook.Text != "")
          tblaracyedekalim.YEDEKARACMARKA = this.yedekAracMarkaTxt.Text;
        if (this.plakaLook.Text != "")
          tblaracyedekalim.TESLIMALANID = new int?(Convert.ToInt32(this.teslimAlanLook.EditValue));
        if (this.plakaLook.Text != "")
          tblaracyedekalim.FIRMAYETKILISI = this.firmaYetkilisiTxt.Text;
        if (this.plakaLook.Text != "")
          tblaracyedekalim.TESLIMEDENID = new int?(Convert.ToInt32(this.teslimEdenLook.EditValue));
        if (this.plakaLook.Text != "")
          tblaracyedekalim.ILGILINOT = this.ilgiliNotTxt.Text;
        this.db.SaveChanges();
    ...
    {
      TBLARACYEDEKALIM tblaracyedekalim = this.db.TBLARACYEDEKALIM.FirstOrDefault<TBLARACYEDEKALIM>((Expression<System.Func<TBLARACYEDEKALIM, bool>>) (x => x.ID == YetkiClass.secim_id));
      this.plakaLook.EditValue = (object) tblaracyedekalim.GIDENARACID;
      this.tarihDate.EditValue = (object) tblaracyedekalim.TARIH;
      this.saatDate.EditValue = (object) tblaracyedekalim.SAAT;
      this.degisimSebebiTxt.EditValue = (object) tblaracyedekalim.DEGISIMSEBEBI;
      this.yedekAracTxt.EditValue = (object) tblaracyedekalim.YEDEKARAC;
      this.yedekAracMarkaTxt.EditValue = (object) tblaracyedekalim.YEDEKARACMARKA;
      this.teslimAlanLook.EditValue = (object) tblaracyedekalim.TESLIMALANID;
      this.firmaYetkilisiTxt.EditValue = (object) tblaracyedekalim.FIRMAYETKILISI;
      this.teslimEdenLook.EditValue = (object) tblaracyedekalim.TESLIMEDENID;
      this.ilgiliNotTxt.EditValue = (object) tblaracyedekalim.ILGILINOT;
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (YedekAracAlimTutanagiGuncelle));
      ...
      this.Name = nameof (YedekAracAlimTutanagiGuncelle);
