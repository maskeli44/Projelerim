...
// Type: Makina_Ikmal.AracBolumu.ZimmetKaydiEkle
...
{
  public class ZimmetKaydiEkle : XtraForm
  {
    ...
    public ZimmetKaydiEkle() => this.InitializeComponent();
    ...
    private void AracZimmetKaydi_Load(object sender, EventArgs e)
    {
      ...
      this.db.TBLARACLAR.FirstOrDefault<TBLARACLAR>((Expression<System.Func<TBLARACLAR, bool>>) (x => x.ID == YetkiClass.secim_id));
      this.tarihDate.EditValue = (object) DateTime.Now;
      this.saatDate.EditValue = (object) DateTime.Now;
    }
    ...
    private void kayit()
    {
      ...
      try
      {
        ...
        if (this.tahsisEdilenLook.Text != "")
        {
          ...
          entity.TAHSISEDILENID = new int?(tahsisedilen);
    ...
    private void simpleButton3_Click(object sender, EventArgs e)
    {
      ...
      int num = (int) new Ekle().ShowDialog();
      try
      {
        this.tBLPERSONELTableAdapter.Fill(this.bellDataSet5.TBLPERSONEL);
      }
    ...
    private void zimmetAlanLook_EditValueChanged(object sender, EventArgs e)
    {
      try
      {
        int id = Convert.ToInt32(this.zimmetAlanLook.EditValue);
        TBLPERSONEL tblpersonel = this.db.TBLPERSONEL.FirstOrDefault<TBLPERSONEL>((Expression<System.Func<TBLPERSONEL, bool>>) (x => x.ID == id));
        this.birimAdiLook.EditValue = (object) tblpersonel.BELDBIRIMIID;
        this.mudurlukLook.EditValue = (object) tblpersonel.BELDBIRIMIID;
      }
      catch (Exception ex)
      {
      }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ZimmetKaydiEkle));
      ...
      this.simpleButton3.ImageOptions.Image = (Image) Resources.add_16x1610;
      this.simpleButton3.Location = new Point(690, 68);
      this.simpleButton3.Margin = new Padding(3, 2, 3, 2);
      this.simpleButton3.Name = "simpleButton3";
      this.simpleButton3.PaintStyle = PaintStyles.Light;
      this.simpleButton3.Size = new Size(22, 28);
      ...
      this.simpleButton2.Location = new Point(690, 126);
      ...
      this.simpleButton1.Location = new Point(690, 100);
      ...
      this.ilgiliNotTxt.Location = new Point(274, 208);
      ...
      this.tarihDate.EditValue = (object) null;
      this.tarihDate.Location = new Point(274, 40);
      ...
      this.zimmetAlanLook.Location = new Point(274, 68);
      ...
      this.zimmetAlanLook.Properties.AppearanceDropDown.Font = new Font("Tahoma", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.zimmetAlanLook.Properties.AppearanceDropDown.Options.UseFont = true;
      ...
      this.zimmetAlanLook.Size = new Size(412, 24);
      this.zimmetAlanLook.StyleController = (IStyleController) this.layoutControl1;
      this.zimmetAlanLook.TabIndex = 7;
      this.zimmetAlanLook.EditValueChanged += new EventHandler(this.zimmetAlanLook_EditValueChanged);
      ...
      this.birimAdiLook.Location = new Point(274, 100);
      ...
      this.birimAdiLook.Properties.AppearanceDropDown.Font = new Font("Tahoma", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.birimAdiLook.Properties.AppearanceDropDown.Options.UseFont = true;
      ...
      this.mudurlukLook.Location = new Point(274, 126);
      ...
      this.mudurlukLook.Properties.AppearanceDropDown.Font = new Font("Tahoma", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.mudurlukLook.Properties.AppearanceDropDown.Options.UseFont = true;
      ...
      this.tahsisEdilenLook.Location = new Point(274, 152);
      ...
      this.tahsisEdilenLook.Properties.AppearanceDropDown.Font = new Font("Tahoma", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.tahsisEdilenLook.Properties.AppearanceDropDown.Options.UseFont = true;
      ...
      this.gridColumn5.Caption = "Tahsis Edilen";
      ...
      this.layoutControlItem4.Location = new Point(171, 56);
      this.layoutControlItem4.MinSize = new Size(50, 25);
      this.layoutControlItem4.Name = "layoutControlItem4";
      this.layoutControlItem4.Size = new Size(507, 32);
      ...
      this.layoutControlItem5.Location = new Point(171, 88);
      ...
      this.layoutControlItem6.Location = new Point(171, 114);
      ...
      this.layoutControlItem7.Location = new Point(171, 140);
      ...
      this.layoutControlItem8.Location = new Point(171, 168);
      ...
      this.layoutControlItem14.Location = new Point(678, 88);
      ...
      this.layoutControlItem15.Location = new Point(678, 114);
      this.layoutControlItem15.Name = "layoutControlItem15";
      this.layoutControlItem15.Size = new Size(26, 26);
      this.layoutControlItem15.TextSize = new Size(0, 0);
      this.layoutControlItem15.TextVisible = false;
      this.layoutControlItem16.Control = (Control) this.simpleButton3;
      this.layoutControlItem16.Location = new Point(678, 56);
      this.layoutControlItem16.MinSize = new Size(22, 25);
      this.layoutControlItem16.Name = "layoutControlItem16";
      this.layoutControlItem16.Size = new Size(26, 32);
      ...
      this.Name = nameof (ZimmetKaydiEkle);
