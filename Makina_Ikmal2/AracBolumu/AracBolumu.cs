...
// Type: Makina_Ikmal.AracBolumu.AracBolumu
...
{
  public class AracBolumu : XtraForm
  {
    ...
    public AracBolumu() => this.InitializeComponent();

    private void accordionControlElement2_Click(object sender, EventArgs e)
    {
      this.yet.yetkiislemleri("ARAÇ BÖLÜMÜ");
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      AracListesi openForm = (AracListesi) Application.OpenForms["AracListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.Yenile();
    ...
    private void accordionControlElement3_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      ZimmetListesi openForm = (ZimmetListesi) Application.OpenForms["ZimmetListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.Yenile();
      ...
      {
        ZimmetListesi zimmetListesi = new ZimmetListesi();
        zimmetListesi.MdiParent = (Form) this;
        zimmetListesi.Show();
      }
    }
    ...
    private void accordionControlElement4_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      TrafikCezaKaydiListesi openForm = (TrafikCezaKaydiListesi) Application.OpenForms["TrafikCezaKaydiListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.listele();
      ...
      {
        TrafikCezaKaydiListesi cezaKaydiListesi = new TrafikCezaKaydiListesi();
        cezaKaydiListesi.MdiParent = (Form) this;
        cezaKaydiListesi.Show();
      }
    }
    ...
    private void accordionControlElement6_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      YedekAracAlimListesi openForm = (YedekAracAlimListesi) Application.OpenForms["YedekAracAlimListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.Yenile();
      ...
      {
        YedekAracAlimListesi yedekAracAlimListesi = new YedekAracAlimListesi();
        yedekAracAlimListesi.MdiParent = (Form) this;
        yedekAracAlimListesi.Show();
      }
    }
    ...
    private void accordionControlElement5_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      MuayeneKontrolListesi openForm = (MuayeneKontrolListesi) Application.OpenForms["MuayeneKontrolListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.Yenile();
      ...
      {
        MuayeneKontrolListesi muayeneKontrolListesi = new MuayeneKontrolListesi();
        muayeneKontrolListesi.MdiParent = (Form) this;
        muayeneKontrolListesi.Show();
      }
    }
    ...
    private void accordionControlElement7_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      AracHgsListesi openForm = (AracHgsListesi) Application.OpenForms["AracHgsListesi"];
      if (openForm != null)
      {
        openForm.Focus();
      }
      ...
      {
        AracHgsListesi aracHgsListesi = new AracHgsListesi();
        aracHgsListesi.MdiParent = (Form) this;
        aracHgsListesi.Show();
      }
    }
    ...
    private void accordionControlElement8_Click(object sender, EventArgs e)
    {
      ...
      if (YetkiClass.ListelemeYetki != 1 || !(YetkiClass.menuyetki == "Hayır"))
        return;
      SigortaKontrolListesi openForm = (SigortaKontrolListesi) Application.OpenForms["SigortaKontrolListesi"];
      if (openForm != null)
      {
        openForm.Focus();
        openForm.Listele();
      ...
      {
        SigortaKontrolListesi sigortaKontrolListesi = new SigortaKontrolListesi();
        sigortaKontrolListesi.MdiParent = (Form) this;
        sigortaKontrolListesi.Show();
      }
    }

    private void AracBolumu_FormClosed(object sender, FormClosedEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Makina_Ikmal.AracBolumu.AracBolumu));
      ...
      this.accordionControl1.Elements.AddRange(new AccordionControlElement[10]
      {
      ...
      this.accordionControl1.Size = new Size(229, 466);
      ...
      this.accordionControlElement2.Appearance.Disabled.Font = new Font("Microsoft Sans Serif", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      ...
      this.accordionControlElement2.Text = "Araç Listesi";
      this.accordionControlElement2.Click += new EventHandler(this.accordionControlElement2_Click);
      this.accordionControlElement3.Appearance.Disabled.Font = new Font("Microsoft Sans Serif", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      ...
      this.accordionControlElement3.Text = "Zimmet Listesi";
      this.accordionControlElement3.Click += new EventHandler(this.accordionControlElement3_Click);
      this.accordionControlElement4.Appearance.Disabled.Font = new Font("Microsoft Sans Serif", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      ...
      this.accordionControlElement4.Text = "Trafik Ceza Listesi";
      this.accordionControlElement4.Click += new EventHandler(this.accordionControlElement4_Click);
      this.accordionControlElement6.Appearance.Disabled.Font = new Font("Microsoft Sans Serif", 11.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      ...
      this.accordionControlElement6.Text = "Yedek Araç Alım";
      this.accordionControlElement6.Click += new EventHandler(this.accordionControlElement6_Click);
      this.accordionControlElement5.ImageOptions.Image = (Image) Resources.gradientbluedatabar_32x32;
      this.accordionControlElement5.Name = "accordionControlElement5";
      this.accordionControlElement5.Style = ElementStyle.Item;
      this.accordionControlElement5.Text = "Muayene Kontrol";
      ...
      this.accordionControlElement7.Text = "Araç Hgs";
      ...
      this.accordionControlElement8.Text = "Sigorta Kontrol";
      ...
      this.Name = nameof (AracBolumu);
      this.WindowState = FormWindowState.Maximized;
      this.FormClosed += new FormClosedEventHandler(this.AracBolumu_FormClosed);
