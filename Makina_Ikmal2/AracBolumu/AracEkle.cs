...
// Type: Makina_Ikmal.AracBolumu.AracEkle
...
{
  public class AracEkle : XtraForm
  {
    ...
    private LayoutControlItem hgslook;
    ...
    public AracEkle() => this.InitializeComponent();

    private void Ekle2_Load(object sender, EventArgs e) => this.yenile();
    ...
    private void kayit()
    {
      TBLARACLAR entity1 = new TBLARACLAR();
      TBLARACRESIM entity2 = new TBLARACRESIM();
      try
      {
        if (this.plakaTxt.Text != "")
          entity1.PLAKA = this.plakaTxt.Text;
        if (this.aracTipiLook.Text != "")
          entity1.ARACTIPIID = new int?(Convert.ToInt32(this.aracTipiLook.EditValue));
        if (this.aracDurumLook.Text != "")
          entity1.ARACDURUMID = new int?(Convert.ToInt32(this.aracDurumLook.EditValue));
        if (this.anaGrupLook.Text != "")
          entity1.ARACGRUBUID = new int?(Convert.ToInt32(this.anaGrupLook.EditValue));
        if (this.altGrupLook.Text != "")
          entity1.ARACGRUBU2ID = new int?(Convert.ToInt32(this.altGrupLook.EditValue));
        if (this.aracIhaleGrupSluEdit.Text != "")
          entity1.ARACIHALEGRUPID = new int?(Convert.ToInt32(this.aracIhaleGrupSluEdit.EditValue));
        if (this.aracAciklamaTxt.Text != "")
          entity1.ARACACIKLAMA = this.aracAciklamaTxt.Text;
        if (this.tahsisPlakaTxt.Text != "")
          entity1.TAHSPLAKA = this.tahsisPlakaTxt.Text;
        DateTime dateTime;
        if (this.tahsisTarihDate.Text != "")
        {
          TBLARACLAR tblaraclar = entity1;
        ...
        if (this.tescilSiraNoTxt.Text != "")
          entity1.TESCILSIRANO = this.tescilSiraNoTxt.Text;
        ...
        if (this.markaLook.Text != "")
          entity1.MARKAID = new int?(Convert.ToInt32(this.markaLook.EditValue));
        if (this.modelYiliLook.Text != "")
          entity1.MODEL = this.modelYiliLook.Text.ToString();
        if (this.cinsTxt.Text != "")
          entity1.CINSI = this.cinsTxt.Text;
        if (this.ticariAdiTxt.Text != "")
          entity1.TICARIADI = this.ticariAdiTxt.Text;
        if (this.tipTxt.Text != "")
          entity1.TIPI = this.tipTxt.Text;
        if (this.silindirHacmiTxt.Text != "")
          entity1.SILINDIRHACMI = this.silindirHacmiTxt.Text;
        if (this.renkTxt.Text != "")
          entity1.RENGI = this.renkTxt.Text;
        if (this.motorNoTxt.Text != "")
          entity1.MOTORNO = this.motorNoTxt.Text;
        if (this.saseNoTxt.Text != "")
          entity1.SASENO = this.saseNoTxt.Text;
        if (this.motorGucuTxt.Text != "")
          entity1.MOTORGUCU = this.motorGucuTxt.Text;
        this.beygirTxt.Text = this.motorGucuTxt.Text;
        entity1.BEYGIRGUCU = this.beygirTxt.Text;
        if (this.belgeSeriNoTxt.Text != "")
          entity1.BELGESERINO = this.belgeSeriNoTxt.Text;
        if (this.verildigiIlIlceTxt.Text != "")
          entity1.VERILDIGIILILCE = this.verildigiIlIlceTxt.Text;
        if (this.muayeneDate.Text != "")
          entity1.MUAYENEGECSUR = new DateTime?(this.muayeneDate.DateTime);
        if (this.trafikSigortaDate.Text != "")
          entity1.TRAFIKSGORTA2 = new DateTime?(this.trafikSigortaDate.DateTime);
        ...
        if (this.yedekAnahtarLook.Text != "")
          entity1.YEDEKANAHTAR = this.yedekAnahtarLook.Text;
        if (this.anahtarAciklamaTxt.Text != "")
          entity1.YEDEKANHTRACKLM = this.anahtarAciklamaTxt.Text;
        if (this.EgzozDate.Text != "")
          entity1.EGZOZKONTROL = new DateTime?(this.EgzozDate.DateTime);
        if (this.AracSahibiLook.Text != "")
          entity1.ARACFIRMAID = new int?(Convert.ToInt32(this.AracSahibiLook.EditValue));
        if (this.guncelDegerTxt.Text != "")
          entity1.GUNCELDEGERI = this.guncelDegerTxt.Text;
        if (this.yeniDegerTxt.Text != "")
          entity1.YENIDEGERI = this.yeniDegerTxt.Text;
        if (this.paraCinsiCombo.Text != "")
          entity1.PARABIRIMI = this.paraCinsiCombo.Text;
        if (this.aracTakipCheck.Text != "")
          entity1.TAKIPVARYOKID = !this.aracTakipCheck.Checked ? new int?(0) : new int?(1);
        if (this.ilgiliNotTxt.Text != "")
          entity1.ILGILINOT = this.ilgiliNotTxt.Text;
        if (this.yeniDegerDate.Text != "")
          entity1.YENIDEGERTARIH = new DateTime?(Convert.ToDateTime(this.yeniDegerDate.DateTime));
        if (this.resimDoluMuOn)
          entity2.ARACRESIMON = this.res.resimyukle(this.onGorunumPicture.Image);
        if (this.resimDoluMuarka)
          entity2.ARACRESIMARKA = this.res.resimyukle(this.arkaGorunumPicture.Image);
        if (this.db.TBLARACLAR.Where<TBLARACLAR>((Expression<System.Func<TBLARACLAR, bool>>) (hd => hd.PLAKA == this.plakaTxt.Text)).Count<TBLARACLAR>() > 0)
        {
          int num1 = (int) MessageBox.Show("Aynı plakalı araç tekrardan kayıt edilemez");
        }
        else
        {
          this.db.TBLARACLAR.Add(entity1);
          this.db.SaveChanges();
          entity2.ARACID = new int?(entity1.ID);
          this.db.TBLARACRESIM.Add(entity2);
          this.db.SaveChanges();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracEkle));
      ...
      this.hgslook = new LayoutControlItem();
      ...
      this.simpleButton12.Appearance.BackColor = Color.Transparent;
      ...
      this.simpleButton12.Location = new Point(300, 147);
      this.simpleButton12.Name = "simpleButton12";
      this.simpleButton12.PaintStyle = PaintStyles.Light;
      this.simpleButton12.Size = new Size(31, 22);
      ...
      this.aracIhaleGrupSluEdit.Size = new Size(167, 24);
      ...
      this.gridColumn2.Caption = "İhale Grubu";
      this.gridColumn2.FieldName = "IHALEADI";
      ...
      this.simpleButton10.Location = new Point(300, 68);
      this.simpleButton10.Name = "simpleButton10";
      this.simpleButton10.PaintStyle = PaintStyles.Light;
      this.simpleButton10.Size = new Size(31, 22);
      ...
      this.simpleButton9.Location = new Point(300, 40);
      this.simpleButton9.Name = "simpleButton9";
      this.simpleButton9.PaintStyle = PaintStyles.Light;
      this.simpleButton9.Size = new Size(31, 22);
      ...
      this.onGorunumPicture.Location = new Point(335, 12);
      ...
      this.onGorunumPicture.Size = new Size(162, 143);
      ...
      this.plakaTxt.Size = new Size(202, 24);
      ...
      this.anaGrupLook.Size = new Size(167, 24);
      ...
      this.altGrupLook.Size = new Size(167, 24);
      ...
      this.aracTipiLook.Size = new Size(167, 24);
      ...
      this.aracDurumLook.Size = new Size(167, 24);
      ...
      this.yedekAnahtarLook.Properties.Columns.AddRange(new LookUpColumnInfo[1]
      {
        new LookUpColumnInfo("ADI", "Yedek Anahtar", 17, FormatType.None, "", true, HorzAlignment.Default, ColumnSortOrder.None, DefaultBoolean.Default)
      });
      ...
      this.EgzozDate.EditValue = (object) "";
      ...
      this.layoutControlItem10.Size = new Size(323, 28);
      ...
      this.layoutControlItem2.Size = new Size(288, 25);
      ...
      this.layoutControlItem25.Size = new Size(288, 28);
      ...
      this.layoutControlItem9.Size = new Size(288, 28);
      ...
      this.difransiyel.Size = new Size(288, 26);
      ...
      this.layoutControlItem21.Location = new Point(288, 84);
      this.layoutControlItem21.MinSize = new Size(22, 25);
      this.layoutControlItem21.Name = "layoutControlItem21";
      this.layoutControlItem21.Size = new Size(35, 25);
      ...
      this.layoutControlItem30.Location = new Point(288, 109);
      this.layoutControlItem30.Name = "layoutControlItem30";
      this.layoutControlItem30.Size = new Size(35, 26);
      ...
      this.layoutControlItem4.Location = new Point(323, 0);
      this.layoutControlItem4.MinSize = new Size(24, 24);
      this.layoutControlItem4.Name = "layoutControlItem4";
      this.layoutControlItem4.Size = new Size(166, 163);
      ...
      this.layoutControlItem55.Location = new Point(288, 28);
      this.layoutControlItem55.Name = "layoutControlItem55";
      this.layoutControlItem55.Size = new Size(35, 28);
      ...
      this.layoutControlItem56.ImageOptions.Alignment = ContentAlignment.MiddleCenter;
      this.layoutControlItem56.Location = new Point(288, 56);
      this.layoutControlItem56.Name = "layoutControlItem56";
      this.layoutControlItem56.Size = new Size(35, 28);
      ...
      this.hgslook.AppearanceItemCaption.Font = new Font("Microsoft Sans Serif", 10.8f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.hgslook.AppearanceItemCaption.Options.UseFont = true;
      this.hgslook.Control = (Control) this.EgzozDate;
      this.hgslook.Location = new Point(406, 163);
      this.hgslook.Name = "hgslook";
      this.hgslook.Size = new Size(309, 28);
      this.hgslook.Text = "Egzoz Kontrol";
      this.hgslook.TextSize = new Size(114, 17);
      this.layoutControlItem58.AppearanceItemCaption.Font = new Font("Microsoft Sans Serif", 10.2f);
      this.layoutControlItem58.AppearanceItemCaption.Options.UseFont = true;
      this.layoutControlItem58.Control = (Control) this.aracIhaleGrupSluEdit;
      this.layoutControlItem58.Location = new Point(0, 135);
      this.layoutControlItem58.Name = "layoutControlItem58";
      this.layoutControlItem58.Size = new Size(288, 28);
      this.layoutControlItem58.Text = "Araç İhale Grubu";
      this.layoutControlItem58.TextSize = new Size(114, 17);
      this.layoutControlItem36.Control = (Control) this.simpleButton12;
      this.layoutControlItem36.Location = new Point(288, 135);
      this.layoutControlItem36.Name = "layoutControlItem36";
      this.layoutControlItem36.Size = new Size(35, 28);
