...
// Type: Makina_Ikmal.AracBolumu.AracHgsGuncelle
...
{
  public class AracHgsGuncelle : XtraForm
  {
    ...
    public AracHgsGuncelle() => this.InitializeComponent();
    ...
    private void barButtonItem2_ItemClick(object sender, ItemClickEventArgs e) => this.guncelle();
    ...
    {
      TAHARACHGS taharachgs = this.db.TAHARACHGS.FirstOrDefault<TAHARACHGS>((Expression<System.Func<TAHARACHGS, bool>>) (x => x.ID == YetkiClass.secim_id));
      this.PlakaLook.EditValue = (object) taharachgs.ARACID;
      this.HgsDate.EditValue = (object) taharachgs.HGSTARIH;
      this.HgsEtiketText.EditValue = (object) taharachgs.HGSETIKETNO;
      this.GuncelAracText.EditValue = (object) taharachgs.GUNCELARAC;
      this.GuncelDate.EditValue = (object) taharachgs.GUNCELTARIH;
      this.IptalDate.EditValue = (object) taharachgs.HGSTARIH;
      this.IlgılıNotText.EditValue = (object) taharachgs.ILGILINOT;
    }
    ...
    private void guncelle()
    {
      ...
      {
        if (this.PlakaLook.Text != "")
          taharachgs.ARACID = new int?(Convert.ToInt32(this.PlakaLook.EditValue));
        if (this.HgsDate.Text != "")
          taharachgs.HGSTARIH = new DateTime?(Convert.ToDateTime(this.HgsDate.EditValue));
        if (this.HgsEtiketText.Text != "")
          taharachgs.HGSETIKETNO = this.HgsEtiketText.Text;
        if (this.GuncelAracText.Text != "")
          taharachgs.GUNCELARAC = this.GuncelAracText.Text;
        if (this.GuncelDate.Text != "")
          taharachgs.GUNCELTARIH = new DateTime?(Convert.ToDateTime(this.GuncelDate.EditValue));
        if (this.IptalDate.Text != "")
          taharachgs.IPTALTARIH = new DateTime?(Convert.ToDateTime(this.IptalDate.EditValue));
        if (this.IlgılıNotText.Text != "")
          taharachgs.ILGILINOT = this.IlgılıNotText.Text;
        this.db.SaveChanges();
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AracHgsGuncelle));
      ...
      this.Name = nameof (AracHgsGuncelle);
      this.Text = nameof (AracHgsGuncelle);
