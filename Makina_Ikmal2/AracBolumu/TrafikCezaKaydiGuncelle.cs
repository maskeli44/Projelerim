...
// Type: Makina_Ikmal.AracBolumu.TrafikCezaKaydiGuncelle
...
{
  public class TrafikCezaKaydiGuncelle : XtraForm
  {
    ...
    public TrafikCezaKaydiGuncelle() => this.InitializeComponent();
    ...
    {
      TBLARACTRFCEZA tblaractrfceza = this.db.TBLARACTRFCEZA.FirstOrDefault<TBLARACTRFCEZA>((Expression<System.Func<TBLARACTRFCEZA, bool>>) (x => x.ID == YetkiClass.secim_id));
      try
      {
        if (this.kayitTarihiDate.Text != "")
          tblaractrfceza.KAYITTARIHI = new DateTime?(Convert.ToDateTime(this.kayitTarihiDate.EditValue));
        if (this.plakaLook.Text != "")
          tblaractrfceza.ARACID = new int?(Convert.ToInt32(this.plakaLook.EditValue));
        if (this.fisNoTxt.Text != "")
          tblaractrfceza.FISNO = this.fisNoTxt.Text;
        if (this.cezaDate.Text != "")
          tblaractrfceza.CEZATARIHI = new DateTime?(Convert.ToDateTime(this.cezaDate.EditValue));
        if (this.cezaTime.Text != "")
          tblaractrfceza.CEZASAATI = new DateTime?(Convert.ToDateTime(this.cezaTime.EditValue));
        if (this.cezaAciklamaTxt.Text != "")
          tblaractrfceza.CEZAACIKLAMA = this.cezaAciklamaTxt.Text;
        if (this.cezaTutariTxt.Text != "")
          tblaractrfceza.CEZATUTARI = new Decimal?(Convert.ToDecimal(this.cezaTutariTxt.EditValue));
        if (this.odemeDurumuCombo.Text != "")
          tblaractrfceza.ODEMEDURUM = this.odemeDurumuCombo.Text;
        if (this.ilgiliNotTxt.Text != "")
          tblaractrfceza.ILGILINOT = this.ilgiliNotTxt.Text;
        this.db.SaveChanges();
      }
      catch (Exception ex)
      {
    ...
    {
      TBLARACTRFCEZA tblaractrfceza = this.db.TBLARACTRFCEZA.FirstOrDefault<TBLARACTRFCEZA>((Expression<System.Func<TBLARACTRFCEZA, bool>>) (x => x.ID == YetkiClass.secim_id));
      this.plakaLook.EditValue = (object) tblaractrfceza.ARACID;
      this.kayitTarihiDate.EditValue = (object) tblaractrfceza.KAYITTARIHI;
      this.fisNoTxt.EditValue = (object) tblaractrfceza.FISNO;
      this.cezaDate.EditValue = (object) tblaractrfceza.CEZATARIHI;
      this.cezaTime.EditValue = (object) tblaractrfceza.CEZASAATI;
      this.cezaAciklamaTxt.EditValue = (object) tblaractrfceza.CEZAACIKLAMA;
      this.cezaTutariTxt.EditValue = (object) tblaractrfceza.CEZATUTARI;
      this.odemeDurumuCombo.EditValue = (object) tblaractrfceza.ODEMEDURUM;
      this.ilgiliNotTxt.EditValue = (object) tblaractrfceza.ILGILINOT;
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (TrafikCezaKaydiGuncelle));
      ...
      this.Name = nameof (TrafikCezaKaydiGuncelle);
      this.Text = "AracTrafikCezaGüncelleme";
