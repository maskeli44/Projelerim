...
// Type: Makina_Ikmal.Depo.GirisFisEkle
...
namespace Makina_Ikmal.Depo
{
  public class GirisFisEkle : XtraForm
  {
    ...
    private void GirisFisEkle_Load(object sender, EventArgs e)
    {
      ...
      this.depoYetkilisiLook.EditValue = (object) sorumlu.depoyetkilisi;
    ...
    public void talepFistenGelenVeri()
    {
      try
      {
        ...
        try
        {
          ...
          this.aracAciklamaLabel.Text = this.db.TBLATOLYEBOLUM.FirstOrDefault<TBLATOLYEBOLUM>((Expression<System.Func<TBLATOLYEBOLUM, bool>>) (x => (int?) x.ID == acik.ATOLYEID)).BOLUMADI;
        }
        catch (Exception ex)
        {
        }
        try
        {
          ...
          LabelControl aracAciklamaLabel = this.aracAciklamaLabel;
          aracAciklamaLabel.Text = aracAciklamaLabel.Text + " " + tblaraclar.PLAKA + " - " + tblaraclar.ARACACIKLAMA;
        }
        catch (Exception ex)
        {
        }
    ...
    private void barButtonItem5_ItemClick(object sender, ItemClickEventArgs e) => new GirisFisTalepFisiListe().Show();
    ...
    private void barButtonItem1_ItemClick(object sender, ItemClickEventArgs e)
    {
      switch (YetkiClass.secim)
      {
        case "fis":
          ...
          ((GirisFisListesi) Application.OpenForms["GirisFisListesi"])?.listele();
          this.Close();
          break;
        case "guncelle":
          this.guncelle();
    ...
    private void kayit()
    {
      ...
      entity1.FIRMAID = new int?(Convert.ToInt32(this.firmaAdiLook.EditValue));
      entity1.ISLEMTIPIID = "2";
      entity1.GCKOD = "G";
      tbltalepfis.SAVEUSER = "2";
      entity1.SAVEUSER = "1";
      try
      {
      ...
      entity1.IMZADEPOYETKILIID = new int?(Convert.ToInt32(this.depoYetkilisiLook.EditValue));
      ...
      for (int rowHandle = 0; rowHandle < this.gridView1.DataRowCount; ++rowHandle)
      {
        ...
        entity2.GIRISMIKTAR = new Decimal?(Convert.ToDecimal(this.gridView1.GetRowCellValue(rowHandle, "MIKTAR")));
        entity2.MIKTAR = new Decimal?(Convert.ToDecimal(this.gridView1.GetRowCellValue(rowHandle, "MIKTAR")));
        entity2.CIKISMIKTAR = new Decimal?(0M);
        entity2.GIRISTUTAR = new Decimal?(Convert.ToDecimal(this.gridView1.GetRowCellValue(rowHandle, "TUTAR")));
        entity2.CIKISTUTAR = new Decimal?(0M);
        ...
        Decimal num2 = Convert.ToDecimal((object) tblmalzemeler.GIRIS);
        tblmalzemeler.GIRIS = new Decimal?(num2 + Convert.ToDecimal(this.gridView1.GetRowCellValue(rowHandle, "MIKTAR")));
        Decimal num3 = Convert.ToDecimal((object) tblmalzemeler.KALAN);
        tblmalzemeler.KALAN = new Decimal?(num3 + (Decimal) Convert.ToInt32(this.gridView1.GetRowCellValue(rowHandle, "MIKTAR")));
    ...
    private void barButtonItem17_ItemClick(object sender, ItemClickEventArgs e)
    {
      ...
      girisFisiYazdir.Parameters["id"].Value = (object) YetkiClass.secim_id;
      girisFisiYazdir.Parameters["id"].Visible = false;
      new ReportPrintTool((IReport) girisFisiYazdir).Print();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.gridControl1.Location = new Point(12, 191);
      ...
      this.gridControl1.Size = new Size(1445, 340);
      ...
      this.colID.Width = 94;
      this.colTALEPFISID.Caption = "Talep Fis";
      this.colTALEPFISID.FieldName = "TALEPFISID";
      this.colTALEPFISID.MinWidth = 24;
      ...
      this.colISTENENMIKTAR.Caption = "İstenen Miktar";
      this.colISTENENMIKTAR.FieldName = "ISTENENMIKTAR";
      this.colISTENENMIKTAR.MinWidth = 24;
      ...
      this.marka.MinWidth = 24;
      this.marka.Name = "marka";
      this.marka.Visible = true;
      this.marka.VisibleIndex = 8;
      this.marka.Width = 94;
      ...
      this.saat.Size = new Size(114, 30);
      ...
      this.depoYetkilisiLook.Size = new Size(368, 30);
      ...
      this.layoutControl3.Location = new Point(972, 12);
      this.layoutControl3.Margin = new Padding(3, 4, 3, 4);
      this.layoutControl3.Name = "layoutControl3";
      this.layoutControl3.Root = this.layoutControlGroup3;
      this.layoutControl3.Size = new Size(461, 151);
      ...
      this.layoutControlGroup3.Size = new Size(461, 151);
      ...
      this.layoutControl2.Size = new Size(483, 48);
      ...
      this.aracAciklamaLabel.Size = new Size(459, 24);
      ...
      this.layoutControlGroup2.Size = new Size(483, 48);
      this.layoutControlGroup2.TextVisible = false;
      this.layoutControlItem11.Control = (Control) this.aracAciklamaLabel;
      this.layoutControlItem11.Location = new Point(0, 0);
      this.layoutControlItem11.MinSize = new Size(3, 28);
      this.layoutControlItem11.Name = "layoutControlItem11";
      this.layoutControlItem11.Size = new Size(463, 28);
      ...
      this.firmaAdiLook.Size = new Size(368, 30);
      ...
      this.tarih.Size = new Size(236, 30);
      ...
      this.layoutControlGroup1.Size = new Size(1445, 175);
      ...
      this.emptySpaceItem1.Size = new Size(960, 35);
      ...
      this.layoutControlItem5.Size = new Size(355, 34);
      ...
      this.layoutControlItem7.Size = new Size(487, 34);
      ...
      this.layoutControlItem8.Size = new Size(487, 52);
      this.layoutControlItem8.TextSize = new Size(0, 0);
      this.layoutControlItem8.TextVisible = false;
      this.layoutControlItem9.Control = (Control) this.layoutControl3;
      this.layoutControlItem9.Location = new Point(960, 0);
      this.layoutControlItem9.Name = "layoutControlItem9";
      this.layoutControlItem9.Size = new Size(465, 155);
      ...
      this.layoutControlItem10.Size = new Size(487, 34);
      ...
      this.layoutControlItem6.Location = new Point(355, 86);
      this.layoutControlItem6.Name = "layoutControlItem6";
      this.layoutControlItem6.Size = new Size(118, 34);
      ...
      this.layoutControlItem1.Location = new Point(0, 179);
      this.layoutControlItem1.Name = "layoutControlItem1";
      this.layoutControlItem1.Size = new Size(1449, 344);
      ...
      this.layoutControlItem2.Size = new Size(1449, 179);
